...
var Gt = (n, s, e) => s in n ? jt(n, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[s] = e;
var k = (n, s, e) => (Gt(n, typeof s != "symbol" ? s + "" : s, e), e);
import xe, { createContext as gt, useContext as J, useState as yt, useCallback as Yt, useEffect as ze, useRef as Oe, useImperativeHandle as Xt } from "react";
import * as Ut from "screenfull";
import _e from "screenfull";
import * as Zt from "html2canvas";
...
function vt() {
  ...
  return Ve = o() ? Object.assign : function(i, a) {
    for (var c, r = t(i), l, h = 1; h < arguments.length; h++) {
...
function qt() {
  ...
  if (ve.Fragment = 60107, typeof Symbol == "function" && Symbol.for) {
    var e = Symbol.for;
    s = e("react.element"), ve.Fragment = e("react.fragment");
  }
  ...
  function a(c, r, l) {
    ...
    l !== void 0 && (f = "" + l), r.key !== void 0 && (f = "" + r.key), r.ref !== void 0 && (g = r.ref);
    for (h in r)
      o.call(r, h) && !i.hasOwnProperty(h) && (d[h] = r[h]);
    if (c && c.defaultProps)
      for (h in r = c.defaultProps, r)
        d[h] === void 0 && (d[h] = r[h]);
    return { $$typeof: s, type: c, key: f, ref: g, props: d, _owner: t.current };
  }
  return ve.jsx = a, ve.jsxs = a, ve;
}
var Fe = {};
/** @license React v17.0.2
...
function Kt() {
  return dt || (dt = 1, function(n) {
    process.env.NODE_ENV !== "production" && function() {
      var s = xe, e = vt(), t = 60103, o = 60106;
      n.Fragment = 60107;
      var i = 60108, a = 60114, c = 60109, r = 60110, l = 60112, h = 60113, d = 60120, f = 60115, g = 60116, m = 60121, _ = 60122, L = 60117, T = 60129, D = 60131;
      if (typeof Symbol == "function" && Symbol.for) {
        var S = Symbol.for;
        t = S("react.element"), o = S("react.portal"), n.Fragment = S("react.fragment"), i = S("react.strict_mode"), a = S("react.profiler"), c = S("react.provider"), r = S("react.context"), l = S("react.forward_ref"), h = S("react.suspense"), d = S("react.suspense_list"), f = S("react.memo"), g = S("react.lazy"), m = S("react.block"), _ = S("react.server.block"), L = S("react.fundamental"), S("react.scope"), S("react.opaque.id"), T = S("react.debug_trace_mode"), S("react.offscreen"), D = S("react.legacy_hidden");
      }
      ...
      function w(u) {
        {
          for (var v = arguments.length, x = new Array(v > 1 ? v - 1 : 0), O = 1; O < v; O++)
            x[O - 1] = arguments[O];
          z("error", u, x);
        }
      }
      function z(u, v, x) {
        {
          var O = P.ReactDebugCurrentFrame, R = O.getStackAddendum();
          R !== "" && (v += "%s", x = x.concat([R]));
      ...
      var V = !1;
      function F(u) {
        return !!(typeof u == "string" || typeof u == "function" || u === n.Fragment || u === a || u === T || u === i || u === h || u === d || u === D || V || typeof u == "object" && u !== null && (u.$$typeof === g || u.$$typeof === f || u.$$typeof === c || u.$$typeof === r || u.$$typeof === l || u.$$typeof === L || u.$$typeof === m || u[0] === _));
      }
      function U(u, v, x) {
        var O = v.displayName || v.name || "";
        return u.displayName || (O !== "" ? x + "(" + O + ")" : x);
      }
      function oe(u) {
      ...
      function E(u) {
        if (u == null)
          return null;
        if (typeof u.tag == "number" && w("Received an unexpected object in getComponentName(). This is likely a bug in React. Please file an issue."), typeof u == "function")
        ...
        if (typeof u == "object")
          switch (u.$$typeof) {
            ...
            case m:
              return E(u._render);
            case g: {
              var O = u, R = O._payload, W = O._init;
              try {
                return E(W(R));
              } catch {
                return null;
      ...
      function Be() {
        {
          if (N === 0) {
            ae = console.log, se = console.info, M = console.warn, K = console.error, H = console.group, Y = console.groupCollapsed, Q = console.groupEnd;
            var u = {
              configurable: !0,
              enumerable: !0,
              value: we,
      ...
      var Ce = P.ReactCurrentDispatcher, Le;
      function me(u, v, x) {
        {
          if (Le === void 0)
            try {
...
` + Le + u;
      ...
      function qe(u, v) {
        ...
        var W;
        W = Ce.current, Ce.current = null, Be();
        try {
          if (v) {
            var B = function() {
              throw Error();
...
` + A[G].replace(" at new ", " at ");
          ...
          Pe = !1, Ce.current = W, De(), Error.prepareStackTrace = R;
        }
        var ye = u ? u.displayName || u.name : "", ct = ye ? me(ye) : "";
      ...
      var Qe = {}, et = P.ReactDebugCurrentFrame;
      function Me(u) {
        if (u) {
          var v = u._owner, x = Ee(u.type, u._source, v ? v.type : null);
          et.setExtraStackFrame(x);
        } else
          et.setExtraStackFrame(null);
      }
      function Et(u, v, x, O, R) {
        {
            ...
            if (W(u, B)) {
              ...
              try {
                if (typeof u[B] != "function") {
                  var ee = Error((O || "React class") + ": " + x + " type `" + B + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof u[B] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                  throw ee.name = "Invariant Violation", ee;
                }
                A = u[B](v, B, O, x, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
              } catch (G) {
                A = G;
              }
              A && !(A instanceof Error) && (Me(R), w("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", O || "React class", x, B, typeof A), Me(null)), A instanceof Error && !(A.message in Qe) && (Qe[A.message] = !0, Me(R), w("Failed %s type: %s", x, A.message), Me(null));
            }
        }
      }
      var be = P.ReactCurrentOwner, $e = Object.prototype.hasOwnProperty, Mt = {
        key: !0,
        ref: !0,
        __self: !0,
        __source: !0
      ...
      function zt(u, v) {
        if (typeof u.ref == "string" && be.current && v && be.current.stateNode !== v) {
          var x = E(be.current.type);
          Ie[x] || (w('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', E(be.current.type), u.ref), Ie[x] = !0);
        }
      }
      function Tt(u, v) {
        {
      ...
      function At(u, v) {
        {
          var x = function() {
            ot || (ot = !0, w("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", v));
          };
      ...
      function Dt(u, v, x, O, R) {
        {
          var W, B = {}, A = null, ee = null;
          x !== void 0 && (A = "" + x), Nt(v) && (A = "" + v.key), Ot(v) && (ee = v.ref, zt(v, R));
          for (W in v)
            $e.call(v, W) && !Mt.hasOwnProperty(W) && (B[W] = v[W]);
          if (u && u.defaultProps) {
          ...
          return Bt(u, A, ee, R, O, be.current, B);
        }
      }
      var Re = P.ReactCurrentOwner, nt = P.ReactDebugCurrentFrame;
      function ge(u) {
        if (u) {
          var v = u._owner, x = Ee(u.type, u._source, v ? v.type : null);
...
Check the render method of \`` + u + "`.";
      ...
      function Pt(u) {
        {
          if (u !== void 0) {
            var v = u.fileName.replace(/^.*[\\\/]/, ""), x = u.lineNumber;
            return `
...
Check the top-level render call using <` + x + ">.");
      ...
      function at(u, v) {
        {
          ...
          st[x] = !0;
          var O = "";
          u && u._owner && u._owner !== Re.current && (O = " It was passed a child from " + E(u._owner.type) + "."), ge(u), w('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', x, O), ge(null);
        }
      }
      function rt(u, v) {
        {
          ...
          if (Array.isArray(u))
            ...
            if (typeof R == "function" && R !== u.entries)
              for (var W = R.call(u), B; !(B = W.next()).done; )
      ...
      function Rt(u) {
        {
          for (var v = Object.keys(u.props), x = 0; x < v.length; x++) {
            var O = v[x];
            if (O !== "children" && O !== "key") {
              ge(u), w("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", O), ge(null);
              break;
            }
          }
          u.ref !== null && (ge(u), w("Invalid attribute `ref` supplied to `React.Fragment`."), ge(null));
        }
      }
      function lt(u, v, x, O, R, W) {
        {
          var B = F(u);
          if (!B) {
            var A = "";
            ...
            ee ? A += ee : A += it();
            var G;
            u === null ? G = "null" : Array.isArray(u) ? G = "array" : u !== void 0 && u.$$typeof === t ? (G = "<" + (E(u.type) || "Unknown") + " />", A = " Did you accidentally export a JSX literal instead of a component?") : G = typeof u, w("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", G, A);
          }
          var X = Dt(u, v, x, R, W);
          if (X == null)
            return X;
          ...
          return u === n.Fragment ? Rt(X) : It(X), X;
        }
      }
      function Wt(u, v, x) {
        return lt(u, v, x, !0);
...
(function(n) {
  process.env.NODE_ENV === "production" ? n.exports = qt() : n.exports = Kt();
})(Te);
const Ne = Te.exports.Fragment, y = Te.exports.jsx, Z = Te.exports.jsxs, ne = gt(null), pe = gt(null), Qt = ne.Provider, eo = pe.Provider, to = "2.1.20", oo = (n) => (n = n.replace("#", ""), n = n.replace("(", ""), n = n.replace(")", ""), n = n.replace(/,/, "-"), n), he = (n) => {
  try {
...
}, Xe = (n, s, e) => n ? n.classList.contains(s) ? n : n.classList.contains(e) ? null : Xe(n.parentElement, s, e) : null, no = async (n) => new Promise((s, e) => {
  setTimeout(() => {
    s();
  }, n);
}), q = (n) => typeof n == "string" ? Number.parseInt(n) : n, io = (n) => {
  console.log(
    `%c relation-graph${n ? "" : "/" + n} %c Version v${to} %c More info: https://github.com/seeksdream/relation-graph %c`,
  ...
  analysisNodes(n, s, e, t) {
    ...
    s.forEach((a) => {
      n.push(a), a.targetNodes && a.targetNodes.forEach((c) => {
        n.includes(c) || (n.push(c), c.lot.parent = a, i.push(c));
      });
    ...
    s.forEach((r) => {
      ...
      if (o === 0) {
        ...
        r.targetNodes.forEach((d) => {
          d.lot || (d.lot = { eached: !1, childs: [] }), d.lot.eached || (C.isAllowShowNode(d) ? (d.lot.eached = !0, d.lot.parent = r, d.lot.index_of_parent = h++, r.lot.childs.push(d), a.push(d), l++) : r.lot.childs.push(d));
        });
      } else if (o === -1) {
        let h = 0;
      ...
      r.lot.strength = l > 0 ? l : 1, i.all_strength += r.lot.strength, r.lot.strength_plus = i.all_strength, r.lot.index_of_level = c, r.lot.childs_size = l, c++;
  ...
  isRectangleOverlap(n, s) {
    const e = n.x + j, t = s.x + j, o = n.el.offsetWidth - j * 2, i = s.el.offsetWidth - j * 2, a = n.y + j, c = s.y + j, r = n.el.offsetHeight - j * 2, l = s.el.offsetHeight - j * 2;
    return !(t >= e + o || t + i <= e || c >= a + r || c + l <= a);
  },
  isXOverlap(n, s, e, t) {
    return !(s >= n + e || s + t <= n);
  },
  ...
  getNoOverlapLimitedPosition(n, s, e, t) {
    const o = n.x + j, i = n.y + j, a = s + j, c = t.x + j, r = n.el.offsetWidth - j * 2, l = t.el.offsetWidth - j * 2, h = e + j, d = t.y + j, f = n.el.offsetHeight - j * 2, g = t.el.offsetHeight - j * 2;
    let m = n.x, _ = n.y;
    const L = this.isXOverlap(o, c, r, l), T = this.isYOverlap(i, d, f, g);
    return L ? h < d ? (m = s, _ = d - f - j) : h > d && (m = s, _ = d + g - j) : T && (a < c ? (m = c - r - j, _ = e) : a > c && (m = c + l - j, _ = e)), { x: m, y: _ };
  }
}, j = 8;
class Ae {
  constructor(s, e) {
  ...
  playAnimation(s) {
    ...
    this.allNodes.forEach((e) => {
      ...
      if (t !== void 0 && o !== void 0 && i !== void 0 && a !== void 0) {
        const c = (i - t) / this.allAnimationStep, r = (a - o) / this.allAnimationStep, l = Math.floor(t + this.currentAnimationStep * c), h = Math.floor(o + this.currentAnimationStep * r);
...
class co extends Ae {
  ...
  analysisNodes4Didirectional(e, t, o, i, a) {
    ...
    t.forEach((h) => {
      ...
      }), h.lot.strength = d > 0 ? d : 1, c.all_strength += h.lot.strength, h.lot.strength_plus = c.all_strength, h.lot.index_of_level = l, h.lot.childs_size = d, l++;
    }), c.all_strength > i.max_strength && (i.max_strength = c.all_strength), r.length > 0 ? this.analysisNodes4Didirectional(e, r, o + a, i, a) : (e.forEach((h) => {
  ...
  placeRelativePosition(e, t, o) {
    ...
    if (this.layoutOptions.from === "left" || this.layoutOptions.from === "right") {
      const a = q(this.layoutOptions.min_per_height) || 80, c = q(this.layoutOptions.max_per_height) || 400, r = q(this.layoutOptions.min_per_width) || 430, l = q(this.layoutOptions.max_per_width) || 650;
      ...
      d < a && (d = a), d > c && (d = c), t.forEach((f) => {
        ...
        f.fixed !== !0 && f.lot.level !== 0 && (f.lot.y = e.lot.y + d * (o.max_strength / -2 + f.lot.strengthWithChilds_from + f.lot.strengthWithChilds / 2));
      }), this.gatherNodes(t, "h", d);
    } else {
      const a = q(this.layoutOptions.min_per_height) || 350, c = q(this.layoutOptions.max_per_height) || 400, r = q(this.layoutOptions.min_per_width) || 250, l = q(this.layoutOptions.max_per_width) || 500;
  ...
  getBloomingNearByParent(e, t, o, i) {
    ...
    for (const r of o)
      if (r.lot.childs_size > 1 && r.lot.parent === t) {
        const l = i === "h" ? r.lot.y - t.lot.y : r.lot.x - t.lot.x;
...
const ut = 0;
function ho(n, s, e, t, o, i, a, c, r) {
  const l = o - n, h = i - s, d = Math.sqrt(l * l + h * h), f = r * h / d, g = -(r * l) / d, m = n + f, _ = s + g, L = n - e / 2, T = n + e / 2, D = s - t / 2, S = s + t / 2;
  let b = [];
  if (l !== 0) {
    let P = (L - m) / l, w = _ + P * h;
    w >= D && w <= S && b.push({ x: L, y: w });
    let z = (T - m) / l, V = _ + z * h;
    V >= D && V <= S && b.push({ x: T, y: V });
  }
  if (h !== 0) {
    let P = (D - _) / h, w = m + P * l;
    w >= L && w <= T && b.push({ x: w, y: D });
    let z = (S - _) / h, V = m + z * l;
    V >= L && V <= T && b.push({ x: V, y: S });
  }
  let I = null, $ = 1 / 0;
  return b.forEach((P) => {
    const w = Math.sqrt((P.x - o) ** 2 + (P.y - i) ** 2);
    w < $ && ($ = w, I = P);
  }), I;
}
const te = {
  getRectPoint(n, s, e, t, o, i, a, c, r = !1, l = 1, h = 1) {
    r && (h = l - h - 1);
    const d = h - (l - 1) / 2, f = n + o / 2, g = s + i / 2, m = e + a / 2, _ = t + c / 2;
    if (l > 1) {
      const w = 14 * d, z = ho(
        f,
        g,
    ...
    const L = f < m ? 1 : -1, T = g < _ ? 1 : -1;
    if (_ === g)
      return { x: f + L * o / 2, y: g };
    const D = Math.abs((m - f) / (_ - g)), S = o / i;
    let b = 0, I = 0;
    D < S ? (b = L * i / 2 * D + T * S, I = T * i / 2) : (b = L * o / 2, I = T * o / 2 / D + L * S);
    const $ = f + b, P = g + I;
    return { x: $, y: P };
  },
  getRectPointBasic(n, s, e, t, o, i, a, c) {
    const r = n + o / 2, l = s + i / 2, h = e + a / 2, d = t + c / 2;
    let f = d === l ? 0 : (h - r) / (d - l);
    f === 0 && (f = (h - r) / (d - l + 1));
    const g = o / c;
    let m = 0, _ = 0, L = "1";
    return -1 * g < f && f < g ? (L = "2", l < d ? (m = i / 2 * f, _ = i / 2) : (m = -1 * i / 2 * f, _ = -1 * i / 2)) : (r < h ? (m = 1 * o / 2, _ = 1 * o / 2 / f) : (m = -1 * o / 2, _ = -1 * o / 2 / f), L = "3"), { x: r + m, y: l + _, _case: L };
  },
  getRectJoinPoint(n, s, e, t, o, i, a, c) {
    const r = n + o / 2, l = s + i / 2, h = e + a / 2, d = t + c / 2, f = Math.round(Math.atan2(d - l, h - r) * 180 / 3.14) + 135;
  ...
  getRectHJoinPoint(n, s, e, t, o, i, a) {
    const c = i / 2;
    return n + o < e ? { x: n + o + 5, y: s + c } : n + o < e + a ? { x: n - 5, y: s + c } : { x: n - 5, y: s + c };
  },
  ...
  getRectVJoinPoint(n, s, e, t, o, i, a, c) {
    const r = o / 2;
    return s + i < t ? { y: s + i + 5, x: n + r } : s + i < t + c ? { y: s - 5, x: n + r } : { y: s - 5, x: n + r };
  },
  getBorderPoint(n, s, e, t, o, i, a, c, r) {
    return r === 0 ? this.getCirclePoint(n, s, e, t, o, i, a, c) : this.getRectPoint(n, s, e, t, o, i, a, c);
  },
  getBorderPoint4MultiLine(n, s, e, t, o, i, a, c, r, l, h, d) {
    return r === 0 ? this.getCirclePoint4MultiLine(n, s, e, t, o, i, a, c, l, h, d) : this.getRectPoint(n, s, e, t, o, i, a, c, l, h, d);
  },
  getCirclePoint(n, s, e, t, o, i, a, c) {
    const r = e + a / 2, l = t + c / 2, h = n + o / 2, d = s + i / 2, f = r - h;
    if (f === 0)
      return { x: h, y: d - i / 2 * (l < d ? 1 : -1) };
    const m = (l - d) / f, _ = Math.sqrt(1 / (1 / (o / 2) ** 2 + m ** 2 / (i / 2) ** 2)) * (r < h ? 1 : -1), L = m * _;
    return { x: h - _, y: d - L };
  },
  getCirclePoint4MultiLine(n, s, e, t, o, i, a, c, r, l, h) {
    r && (h = l - h - 1);
    const d = e + a / 2, f = t + c / 2, g = n + o / 2, m = s + i / 2, _ = d - g;
    if (_ === 0)
      return { x: g, y: m - i / 2 * (f < m ? 1 : -1) };
    const T = (h - (l - 1) / 2) * 14, D = f - m, S = Math.sqrt(_ ** 2 + D ** 2) * T / _, b = D / _, I = o / 2, $ = i / 2, P = d < g ? 1 : -1, w = (-1 * I ** 2 * b * S + I * $ * Math.sqrt($ ** 2 + b ** 2 * I ** 2 - S ** 2) / P) / ($ ** 2 + I ** 2 * b ** 2), z = b * w + S;
    return { x: g - w, y: m - z };
  },
  getCirclePointBasic(n, s, e, t, o, i, a, c, r) {
    const l = n + o / 2, h = s + i / 2, d = e + a / 2, f = t + c / 2, g = d - l, m = f - h, _ = Math.sqrt(g * g + m * m), L = _ - r, T = L * g / _ * -1, D = L * m / _ * -1;
    return { x: d + T, y: f + D };
  },
  getCirclePointPlus(n, s, e, t, o, i, a, c) {
    const r = n + o / 2, l = s + i / 2, h = e + a / 2, d = t + c / 2, f = h - r, g = d - l, m = Math.sqrt(f * f + g * g), _ = (m - o / 2) * f / m * -1, L = (m - i / 2) * g / m * -1;
    return { x: h + _, y: d + L };
  },
  getOvalPoint(n, s, e, t, o) {
    return {
      x: n + e * Math.sin((ut + t * (360 / o) + 0) * Math.PI / 180),
      y: s + e * Math.cos((ut + t * (360 / o) + 0) * Math.PI / 180) * -1
    };
  },
  getAngleType(n, s) {
    if (n >= 0 && s >= 0)
...
class Se extends Ae {
  ...
  placeNodes(e, t) {
    ...
    if (this.allNodes = e, this.rootNode = t, this.layoutOptions.fixedRootNode) {
      ...
      this.easyPlaceRelativePosition(t, o), o.forEach((i) => {
        ...
        i.x = i.lot.x + a - C.getNodeWidth(i, this.graphOptions) / 2, i.y = i.lot.y + c - C.getNodeHeight(i, this.graphOptions) / 2, i.lot.placed = !0;
      });
    } else
  ...
  easyPlaceRelativePosition(e, t) {
    t.forEach((i) => {
      if (i.lot.subling.level === 1) {
        ...
        if (a) {
          const c = te.getOvalPoint(e.lot.x, e.lot.y, a.level * 50, i.lot.strength_plus - i.lot.strength / 2, a.all_strength);
      ...
      const a = i.lot.subling;
      if (a && a.level > 1) {
        const c = i.lot.parent.lot.strength_plus - i.lot.parent.lot.strength, l = (i.lot.parent.lot.strength_plus - c) / (i.lot.parent.lot.childs.length + 1) * (i.lot.index_of_parent + 1), h = te.getOvalPoint(e.lot.x, e.lot.y, (a.level - 1) * 40 + 50, c + l, i.lot.parent.lot.subling.all_strength);
  ...
  doForceLayout(e) {
    ...
    if (this.isMainLayouer && (this.graphOptions.autoLayouting = !0), this.layoutTimes++, this.visibleNodes.forEach((o) => {
      ...
      for (const o in this.visibleNodes) {
        ...
        if (!(this.justLayoutSingleNode && !i.singleNode) && !i.fixed && i.lot.placed === !0)
          for (const a in this.visibleNodes) {
            const c = this.visibleNodes[a];
            c.lot.placed === !0 && o !== a && this.addGravityByNode(i, c);
          }
      }
    if (this.byLine)
      if (this.allLinks && this.allLinks.length > 0) {
        for (const o of this.allLinks)
          if (!o.forDisplayOnly) {
            const i = o.relations.reduce((a, c) => a + (c.force_elastic || 1), 0);
  ...
  addElasticByLine(e, t, o = 1) {
    ...
    const a = i < this.minVaildLineLength ? 0 : (i - this.minVaildLineLength) * 0.1 * this.force_line_elastic * o, c = a, r = a, l = (this.getX(e) - this.getX(t)) / i, h = (this.getY(e) - this.getY(t)) / i;
  ...
  addGravityByNode(e, t) {
    ...
    this.addFtoNode(e, a * i, c * i), this.addFtoNode(t, a * i * -1, c * i * -1);
  }
  addFtoNode(e, t, o) {
...
class fo extends Se {
  ...
  async placeNodes(e, t) {
    ...
    p("root position:", t.lot.x, t.lot.y), this.placeRelativePosition(this.rootNode, o, i), this.graphOptions.useAnimationWhenExpanded ? (p("Play layout animation....."), await this.animationLayout()) : o.forEach((a) => {
      if (a.fixed === !0 || !C.isAllowShowNode(a))
        return;
      const c = a.offset_x || 0, r = a.offset_y || 0, l = -C.getNodeWidth(a, this.graphOptions) / 2, h = -C.getNodeHeight(a, this.graphOptions) / 2;
  ...
  placeRelativePosition(e, t, o) {
    ...
    let a = Math.round((this.graphOptions.viewSize.height + this.graphOptions.viewSize.width) / o.max_deep * 0.2) * i;
    p("analyticResult:", o, a, this.layoutOptions.distance_coefficient), a < 150 * i && (a = 150 * i);
    let c = 0;
    t.forEach((l) => {
      const h = l.lot.subling;
      if (h && h.level === 1) {
        c = Math.round(h.all_size * 50 / Math.PI / 2), c < a && (c = a);
        const d = te.getOvalPoint(e.lot.x, e.lot.y, h.level * c, l.lot.strength_plus - l.lot.strength / 2, h.all_strength);
    ...
    t.forEach((l) => {
      const h = l.lot.subling;
      if (h && h.level > 1) {
        const d = l.lot.parent.lot.strength_plus - l.lot.parent.lot.strength, g = (l.lot.parent.lot.strength_plus - d) / (l.lot.parent.lot.childs_size + 1) * (l.lot.index_of_parent + 1), m = te.getOvalPoint(e.lot.x, e.lot.y, (h.level - 1) * r + c, d + g, l.lot.parent.lot.subling.all_strength);
        l.lot.x = m.x, l.lot.y = m.y;
      }
    });
  }
}
class uo extends Se {
  ...
  async placeNodes(s, e) {
    ...
    c < 200 && (c = 200), c > 800 && (c = 800), this.allNodes.forEach((r, l) => {
      const h = te.getOvalPoint(i.x, i.y, c, l, a);
      ...
      if (r.fixed === !0 || !C.isAllowShowNode(r))
        return;
      const l = r.offset_x || 0, h = r.offset_y || 0, d = -C.getNodeWidth(r, this.graphOptions) / 2, f = -C.getNodeHeight(r, this.graphOptions) / 2;
      r.x = r.lot.x + l + d, r.y = r.lot.y + h + f, r.lot.placed = !0;
    });
  }
}
class po extends Ae {
...
class mo extends Ae {
  ...
  analysisNodes4Didirectional(e, t, o, i) {
    ...
    e.forEach((l) => {
      ...
      const h = l.lot.level + "", d = a[h], f = d.length;
      l.lot.index_of_level = d.indexOf(l), l.lot.subling.all_size = f, l.lot.subling.all_strength += l.lot.strength || 1, l.lot.strength_plus = l.lot.subling.all_strength;
    }), e.forEach((l) => {
    ...
    const c = Object.keys(a).map((l) => Number.parseInt(l)).sort(), r = (l) => {
      ...
      let f = 0;
      d.forEach((g) => {
        g.lot.parent && f < g.lot.parent.lot.strengthWithChilds_from && (f = g.lot.parent.lot.strengthWithChilds_from), l === 0 ? f += 1 : g.lot.strengthWithChilds_from = f, p("levels:", l, f, g.text, g.lot.strengthWithChilds), f += g.lot.strengthWithChilds;
      });
    };
  ...
  analysisBothWay(e, t, o, i) {
    ...
    t.forEach((r) => {
      ...
      r.targetFrom.forEach((f) => {
        f.lot || (f.lot = { eached: !1, childs: [] }), f.lot.eached || (f.lot.parent = r, C.isAllowShowNode(f) ? (f.lot.eached = !0, f.lot.index_of_parent = h++, r.lot.childs.push(f), d.push(f), l++) : r.lot.childs.push(f));
      }), this.analysisBothWay(e, d, o - 1, i), d = [], r.targetTo.forEach((f) => {
        f.lot || (f.lot = { eached: !1, childs: [] }), f.lot.eached || (f.lot.parent = r, C.isAllowShowNode(f) ? (f.lot.eached = !0, f.lot.index_of_parent = h++, r.lot.childs.push(f), d.push(f), l++) : r.lot.childs.push(f));
      }), this.analysisBothWay(e, d, o + 1, i), r.lot.strength = l > 0 ? l : 1, a.all_strength += r.lot.strength, r.lot.strength_plus = a.all_strength, r.lot.index_of_level = c, r.lot.childs_size = l, c++;
  ...
  async placeNodes(e, t) {
    ...
    const a = o.filter((r) => r.lot.level === 0), c = new Se({
      layoutName: "force",
      maxLayoutTimes: 100,
...
const yo = (n) => {
  ...
  const s = {
    ...
    creatingNodePlot: !1,
    showTemplateNode: !0,
    newNodeTemplate: Je(JSON.parse(JSON.stringify(wt))),
    creatingLinePlot: !1,
    newLineTemplate: {
  ...
  return !n.layouts || !Array.isArray(n.layouts) || n.layouts.length === 0 ? n.layout ? o = [n.layout] : o = [{
    ...
    layoutName: "center",
    layoutDirection: "v"
  }] : o = n.layouts, p("final layouts:", o), s.layouts = o.map((i) => JSON.parse(JSON.stringify(i))), s.disableNodeClickEffect && (s.defaultFocusRootNode = !1), xt(s.layouts[0]), Ct(s.layouts[0], s), s;
}, Ct = (n, s) => {
...
class vo {
  constructor(s, e) {
    ...
    this.listeners = e, this.options = Lt(s), p("new RelationGraph:", this);
  }
  enableDebugLog(s) {
...
class xo extends _o {
  ...
  _initLayoutByLayoutOptions(e) {
    this.options.layoutClassName = e.layoutClassName, this.options.layoutLabel = e.label, this.options.layoutName = e.layoutName, this.options.layoutDirection = e.layoutDirection, this.layouter = _t(e, this.options);
  }
  initLayouter() {
  ...
  loadLines(e) {
    e.forEach((t) => {
      ...
      const c = `${i.seeks_id}-${a.seeks_id}`, r = `${a.seeks_id}-${i.seeks_id}`, l = Ue(t);
      let h = this.graphData.links.find((m) => m.seeks_id === c), d = !1;
      ...
      let f = l.arrow;
      l.isHideArrow || (f = this.getLineArrow(l.color)), i.targetNodes || (i.targetNodes = []), a.targetNodes || (a.targetNodes = []), l.forDisplayOnly ? h.forDisplayOnly = !1 : (i.targetNodes.includes(a) || i.targetNodes.push(a), a.targetNodes.includes(i) || a.targetNodes.push(i), i.targetTo.includes(a) || i.targetTo.push(a), a.targetFrom.includes(i) || a.targetFrom.push(i));
      let g = !1;
      for (let m = 0; m < h.relations.length; m++)
        if ((h.relations[m].id || l.id) && h.relations[m].id === l.id) {
          g = !0;
          break;
        }
      g === !1 && (l.id || (l.id = `${h.seeks_id}-${h.relations.length}`), l.isReverse = d, l.arrow = f, h.relations.push(l)), o && (this.graphData.links.push(h), h.appended = !1);
    });
  }
  flatNodeData(e, t, o, i) {
    e.forEach((a) => {
      ...
      c && c.length > 0 && this.flatNodeData(c, a, o, i);
    });
  }
  loadGraphJsonData(e) {
  ...
  getStuffSize(e) {
    ...
    t.forEach((d) => {
      C.isAllowShowNode(d) && (d.x < o && (o = d.x), d.x > a && (a = d.x + d.el.offsetWidth), d.y < i && (i = d.y), d.y > c && (c = d.y + d.el.offsetHeight));
    });
    const r = 100, l = a - o + r, h = c - i + r;
    return {
      width: l,
      height: h,
      minX: o,
...
class wo extends xo {
  ...
  async createGraphCanvas(s = "png") {
    return new Promise((e, t) => {
      const o = this.options.canvasZoom, i = this.$canvasDom.clientWidth, a = this.$canvasDom.clientHeight, c = this.options.canvasOffset.x, r = this.options.canvasOffset.y;
      ...
      this.loading("Generating..."), this.graphData.nodes.forEach((w) => {
        w.x < h && (h = w.x), w.x > f && (f = w.x + w.el.offsetWidth), w.y < d && (d = w.y), w.y > g && (g = w.y + w.el.offsetHeight);
      });
      const _ = h - m, L = d - m;
      this.graphData.nodes.forEach((w) => {
        ...
        const z = w;
        z.style.left = -L + "px", z.style.top = -L + "px";
      ...
      const S = f - h + 200 + m * 2, b = g - d + 100 + m * 2, I = window.devicePixelRatio;
      this.options.canvasSize.width = S * I, this.options.canvasSize.height = b * I, window.scrollTo(0, 0);
      const $ = document.createElement("canvas");
      $.width = S * I, $.height = b * I, $.style.backgroundColor = getComputedStyle(l.parentElement, null).backgroundColor, p("canvas.style.backgroundColor:", $.style.backgroundColor), $.style.width = `${S * I}px`, $.style.height = `${b * I}px`, $.getContext("2d").scale(1, 1);
      const P = {
      ...
      setTimeout(() => {
        this.createImage(l, P, s, "", (w) => {
          this.options.canvasSize.width = i, this.options.canvasSize.height = a, this.options.canvasOffset.x = c, this.options.canvasOffset.y = r, this.options.canvasZoom = o, this.$canvasDom.querySelectorAll(".rel-canvas-slot").forEach((F) => {
            const U = F;
...
class Co extends wo {
  ...
  createLinePathByTwoNode(s, e, t, o = 0, i = 1) {
    ...
    let r = s.x, l = s.y, h = e.x, d = e.y;
    const f = { x: 0, y: 0, rotate: 0 };
    if (Number.isNaN(r) || Number.isNaN(l))
      return p("error start node:", s.text, s.x, s.y), f.x = 50, f.y = 50, f.rotate = 0, this.createReturnValue("M 0 0 L 100 100", f);
    ...
    let _ = e.el.offsetWidth || e.width || 60, L = e.el.offsetHeight || e.height || 60;
    if (Number.isNaN(_) || Number.isNaN(L))
      return f.x = 50, f.y = 50, f.rotate = 0, this.createReturnValue("M 0 0 L 100 100", f);
    t.isReverse && ([r, l, h, d, g, m, _, L] = [
      h,
      d,
      r,
      l,
    ...
    const T = [
      ...
      i,
      o
    ], S = this.options.defaultJunctionPoint || ce.border, b = t.fromJunctionPoint || s.junctionPoint || S, I = t.toJunctionPoint || e.junctionPoint || S, $ = this._getJunctionPoint(b, T), P = this._getJunctionPoint(I, D);
    if (!$ || !P)
      return this.createReturnValue(
        "Unable to calculate the starting point and ending point of the line.",
        f
      );
    const w = $.x, z = $.y, V = P.x, F = P.y;
    if (s === e) {
      const se = r + g / 2, M = l + m / 2, K = Math.atan2(z - M, w - se), H = Math.sin(K + Math.PI) * 5, Y = Math.cos(K + Math.PI) * 5, Q = { x: w - H, y: z - Y }, we = { x: w + H, y: z + Y }, Be = w - Y * 5, De = z - H * 5, Ce = w - Y * 5, Le = z - H * 5, me = `M${Q.x},${Q.y} C${Be},${De} ${Ce},${Le} ${we.x},${we.y}`;
      return f.x = w - Y / (Y + H) * 20, f.y = z + H / (Y + H) * 20, f.rotate = 0, this.createReturnValue(me, f);
    }
    if (Number.isNaN(w) || Number.isNaN(z))
      return console.error("error start point:", s), f.x = 50, f.y = 50, f.rotate = 0, this.createReturnValue("M 0 0 L 100 100", f);
    if (Number.isNaN(V) || Number.isNaN(F))
      return console.error("error end point:", e), f.x = 50, f.y = 50, f.rotate = 0, this.createReturnValue("M 0 0 L 100 100", f);
    const U = r + g / 2, oe = l + m / 2, E = h + _ / 2, N = d + L / 2, ae = this.createLinePathData(
      t,
      f,
      i,
      o,
  ...
  createLinePathData(s, e, t, o, i, a, c, r, l, h, d, f, g, m, _, L, T, D) {
    let S = g - c, b = m - r, I = g > c ? 1 : -1, $ = m > r ? 1 : -1, P = i === "v" ? $ : I, w = "";
    if (a === 4) {
      const z = c - l, V = r - h, F = g - _, U = m - L;
      let oe = this.options.defaultPloyLineRadius || 0;
      const E = Math.min(oe, Math.abs(S)) * (c < g ? 1 : -1), N = Math.min(oe, Math.abs(b)) * (r < m ? 1 : -1), ae = Math.abs(z) >= d / 2 ? "h" : "v", se = Math.abs(F) >= T / 2 ? "h" : "v", M = [];
      if (ae === "v") {
        const K = Math.min(50, Math.abs(m - r) / 2), H = V > 0 ? K : -K;
        if (e.x = g, e.y = r + H + (V > 0 ? 20 : -5), M.push(`M ${c} ${r}`), M.push(`v${H - N}`), se === "v")
          M.push(`c${0},${N},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`h${g - c - E}`), M.push(`c${E},${0},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`v${m - r - H - N}`);
        else {
          M.push(`c${0},${N},`), M.push(`${E},${N},`), M.push(`${E},${N}`);
          const Y = Math.min(30, Math.abs(g - c) / 2), Q = F > 0 ? -Y : Y;
          M.push(`h${g - c + Q - E}`), M.push(`c${E},${0},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`v${m - r - H - N}`), M.push(`h${Q - E}`);
        }
      } else {
        const K = Math.min(30, Math.abs(g - c) / 2), H = z > 0 ? K : -K;
        if (e.x = c + H + (z > 0 ? 20 : -50), e.y = m - 5, M.push(`M ${c} ${r}`), M.push(`h${H - E}`), se === "v") {
          const Y = Math.min(30, Math.abs(m - r) / 2), Q = U > 0 ? -Y : Y;
          M.push(`c${E},${0},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`v${m - r + Q - N}`), M.push(`h${g - c - H - E}`), M.push(`c${0},${N},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`v${Q - N}`);
        } else
          M.push(`c${E},${0},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`v${m - r - N * 2}`), M.push(`c${0},${N},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`h${g - c - H - E}`);
      }
      w = M.join(" ");
    } else if (a === 2 || a === 3 || a === 5 || a === 6 || a === 7) {
      const z = c - l, V = r - h, F = g - _, U = m - L, oe = 1 / (t + 1) * (o + 1);
      let E, N;
      if (a === 2)
        E = i === "v" ? { x: 0, y: P * 30 } : { x: P * 30, y: 0 }, N = i === "v" ? { x: S * oe, y: P * -10 } : { x: P * -10, y: b * oe };
      else if (a === 3)
        E = i === "v" ? { x: 0, y: b * oe } : { x: P * 30, y: 0 }, N = i === "v" ? { x: 0, y: 0 } : { x: P * -10, y: b * oe };
      else if (a === 5)
        E = i === "v" ? { x: 0, y: 0 } : { x: 0, y: 0 }, N = i === "v" ? { x: 0, y: b * oe } : { x: S * oe, y: 0 };
      else if (a === 6) {
        const se = Math.min(200, Math.max(100, Math.abs(S / 2))), M = Math.min(200, Math.max(100, Math.abs(b / 2))), K = z / (Math.abs(z) + Math.abs(V)) * se, H = V / (Math.abs(z) + Math.abs(V)) * M;
        E = { x: K, y: H };
        const Y = F / (Math.abs(F) + Math.abs(U)) * se + S, Q = U / (Math.abs(F) + Math.abs(U)) * M + b;
        N = { x: Y, y: Q };
      } else if (a === 7) {
        const K = z / (Math.abs(z) + Math.abs(V)) * 30, H = V / (Math.abs(z) + Math.abs(V)) * 30;
        E = { x: K, y: H };
      ...
      e.x = ae.x, e.y = ae.y, w = `M${c},${r} c${E.x},${E.y} ${N.x},${N.y} ${S},${b}`;
    } else
      e.rotate = te.getTextAngle(c, r, g, m), e.x = Math.round(c + (g - c) / 2), e.y = Math.round(r + (m - r) / 2), Number.isNaN(e.rotate) && (e.rotate = 0), w = `M ${c} ${r} L ${g} ${m}`;
    return w;
  }
  calcCurveCenter(s, e, t, o, i = 0.5) {
    const a = { x: (1 - i) * s.x + i * e.x, y: (1 - i) * s.y + i * e.y }, c = { x: (1 - i) * e.x + i * t.x, y: (1 - i) * e.y + i * t.y }, r = { x: (1 - i) * t.x + i * o.x, y: (1 - i) * t.y + i * o.y }, l = { x: (1 - i) * a.x + i * c.x, y: (1 - i) * a.y + i * c.y }, h = { x: (1 - i) * c.x + i * r.x, y: (1 - i) * c.y + i * r.y };
  ...
  createCheckedLinePath() {
    ...
    if (!!s)
      try {
        ...
        const o = t.relations.findIndex((c) => c.id === s);
        if (o === -1) {
...
class Lo extends Co {
  ...
  showZoomCenter(e, t) {
    ...
    const o = this.options.canvasZoom / 100, i = this.analysisByZoom(o, e), a = (this.options.canvasZoom + t) / 100, c = this.analysisByZoom(a, e), r = a / o, l = 0, h = 0, d = a / o, f = 0, g = 0;
    this.zoomCenter_of_newSize.x = r * i.NMViewBuff.x + h * i.NMViewBuff.y + f, this.zoomCenter_of_newSize.y = l * i.NMViewBuff.x + d * i.NMViewBuff.y + g;
    ...
    let L = i.NMCanvasStart.x - i.NMCanvasCenter.x, T = i.NMCanvasStart.y - i.NMCanvasCenter.y, D = r * L + h * T + f, S = l * L + d * T + g;
    return c.NMCanvasStart.x = m + i.NMCanvasCenter.x + D, c.NMCanvasStart.y = m + i.NMCanvasCenter.y + S, L = i.NMCanvasEnd.x - i.NMCanvasCenter.x, T = i.NMCanvasEnd.y - i.NMCanvasCenter.y, D = r * L + h * T + f, S = l * L + d * T + g, c.NMCanvasEnd.x = m + i.NMCanvasCenter.x + D, c.NMCanvasEnd.y = m + i.NMCanvasCenter.y + S, i.NMCanvasOffsetBuff.x = m, i.NMCanvasOffsetBuff.y = _, {
      buff_x: m,
      buff_y: _
    };
  }
...
class bo extends Lo {
  ...
  async doLayout() {
    ...
    this.options.showMaskWhenLayouting && this.loading(), await no(200), this.options.showMaskWhenLayouting && this.clearLoading(), p("node size\uFF1A", this.graphData.nodes.length);
  ...
  async placeOtherGroup(s, e) {
    if (s.length > 0) {
      ...
      const t = JSON.parse(JSON.stringify(this.layouter.layoutOptions)), o = _t(t, this.options);
      o.isMainLayouer = !1;
      ...
      i.x = a.maxX + c, i.y = 0, o.layoutOptions.fixedRootNode = !0;
      const r = [];
  ...
  async animateGoto(s, e, t) {
    return new Promise((o, i) => {
      p("animateGoto:", s, e);
      const a = s - this.options.canvasOffset.x, c = e - this.options.canvasOffset.y, r = t, l = 5, h = Math.round(a / l), d = Math.round(c / l), f = r / l;
  ...
  async animateToZoom(s, e) {
    return new Promise((t, o) => {
      const i = s - this.options.canvasZoom, a = e, c = 5, r = Math.round(i / c), l = a / c;
      p("animateToZoom:", i, r), this.animateStepAction(0, l, c, () => {
...
const pt = (n) => {
  ...
  startDrag(n, s, e, t) {
    t ? Ge = (o, i, a) => {
      const c = o - ue.x, r = i - ue.y;
      t(c, r, de, ue, a);
    } : Ge = (o, i) => {
      fe.x = de.x + (o - ue.x), fe.y = de.y + (i - ue.y);
    }, Ye = e, fe = s, de.x = fe.x, de.y = fe.y, p("[canvas]onDragStart...", he(n), n);
    try {
      const o = pt(n);
      ue.x = o.clientX, ue.y = o.clientY, he(n) ? (document.body.addEventListener("touchmove", ie.onNodeMove), document.body.addEventListener("touchend", ie.onNodeDragend), n.preventDefault()) : (document.body.addEventListener("mousemove", ie.onNodeMove), document.body.addEventListener("mouseup", ie.onNodeDragend));
    } catch (o) {
  ...
  onNodeDragend(n) {
    he(n) ? (document.body.removeEventListener("touchmove", ie.onNodeMove), document.body.removeEventListener("touchend", ie.onNodeDragend)) : (document.body.removeEventListener("mousemove", ie.onNodeMove), document.body.removeEventListener("mouseup", ie.onNodeDragend)), p("[canvas]onDragend...", he(n), n), Ye && Ye(
      fe.x - de.x,
      fe.y - de.y,
      n
    );
...
class So extends bo {
  ...
  startCreatingNodePlot(e, t) {
    this.options.newNodeTemplate = Je(JSON.parse(JSON.stringify(wt))), this.options.creatingNodePlot = !0;
    const o = he(e);
    ...
    const d = (m) => {
      ...
      const L = m.clientX - _.x + 10, T = m.clientY - _.y + 10;
      i(L, T);
    }, f = (m) => {
      ...
      const L = je(m), T = L.clientX - c.x + 10, D = L.clientY - c.y + 10;
      if (t && t.disableClickCreate && Math.abs(l - T) < 5 && Math.abs(h - D) < 5) {
        p("[CreatingNodePlot]create node be abort!");
        return;
      }
      const S = this.getCanvasCoordinateByClientCoordinate({ x: L.clientX, y: L.clientY });
  ...
  fullscreen(e) {
    e === void 0 ? (this.options.fullscreen = !this.options.fullscreen, _e.toggle(this.$dom).then(() => {
      setTimeout(() => {
  ...
  onLineDragStart(e, t) {
    p("onLineDragStart...");
    const o = { x: e.fromNode.x, y: e.fromNode.y }, i = { x: e.toNode.x, y: e.toNode.y }, a = (c, r, l, h, d) => {
      e.fromNode.x = o.x + c / (this.options.canvasZoom / 100), e.fromNode.y = o.y + r / (this.options.canvasZoom / 100), e.toNode.x = i.x + c / (this.options.canvasZoom / 100), e.toNode.y = i.y + r / (this.options.canvasZoom / 100), this._dataUpdated();
    };
    ie.startDrag(t, { x: 0, y: 0 }, (...c) => {
    ...
    if (he(e)) {
      ...
      t = (a, c, r, l, h) => {
        ...
        if (d && d.length > 1) {
          ...
          const m = { x: f.clientX, y: f.clientY }, _ = { x: g.clientX, y: g.clientY }, L = Math.hypot(o.x - l.x, o.y - l.y), D = Math.hypot(_.x - m.x, _.y - m.y) / L, S = i * D;
          this.setZoom(S), this._dataUpdated();
        } else {
          const g = f.clientX, m = f.clientY;
          let _ = r.x + (g - l.x), L = r.y + (m - l.y);
          this.options.useHorizontalView ? (_ = r.x + (m - l.y), L = r.y - (g - l.x), this.setCanvasOffset(_, L)) : this.setCanvasOffset(_, L), this._dataUpdated();
        }
      };
    } else
      t = (o, i, a, c, r) => {
  ...
  onNodeDragStart(e, t) {
    ...
    ie.startDrag(t, e, o, (i, a, c) => {
      let r = i / (this.options.canvasZoom / 100) + c.x, l = a / (this.options.canvasZoom / 100) + c.y;
      if (this.listeners.onNodeDragging) {
        const h = this.listeners.onNodeDragging(e, r, l, t);
        h && (typeof h.x == "number" && (r = h.x), typeof h.y == "number" && (l = h.y));
      }
      this.setNodePosition(e, r, l), this.options.useHorizontalView ? (r = a / (this.options.canvasZoom / 100) + c.x, l = -i / (this.options.canvasZoom / 100) + c.y, this.setNodePosition(e, r, l)) : this.setNodePosition(e, r, l), this.updateElementLines(), this._dataUpdated();
    });
  }
...
class ko extends So {
  ...
  async switchLayout(s, e = !0, t = !1) {
    ...
    p("[change layout]switchLayout"), this.stopAutoLayout(), Ct(s, this.options), this._initLayoutByLayoutOptions(s), this.layouter.allNodes = o, this.layouter.rootNode = i, e ? await this.refresh() : (t || (this.disableNextLayoutAnimation = !0), await this.doLayout());
  }
...
const mt = (n) => ({
  ...
  const n = J(ne), s = J(pe), e = n.options, [t, o] = yt(!1), i = () => {
    o(!t);
  }, a = () => {
    n.printOptions();
  }, c = () => {
  ...
  const n = J(ne), s = J(pe), e = async () => {
    ...
    const l = n;
    await l.setZoom(100), await l.moveToCenter(), await l.zoomToFit(), s();
  }, c = (l) => {
    n.zoom(l), s();
  }, r = n && n.options;
  return /* @__PURE__ */ Z(
...
), bt = ({ nodeProps: n, NodeSlot: s, ExpandHolderSlot: e }) => {
  var S;
  const t = J(ne), o = J(pe), i = Yt((b) => {
    b !== null && a(b);
  }, []), a = (b) => {
    if (b.offsetWidth === 0 && b.offsetHeight === 0)
      return;
    const I = b.offsetWidth, $ = b.offsetHeight;
    (n.el.offsetWidth !== I || n.el.offsetHeight !== $) && (t.updateNodeOffsetSize(n, I, $), o());
  }, c = async (b) => {
    ...
    t.onNodeClick(n, b);
  }, h = t.options, d = n.width || h.defaultNodeWidth, f = n.height || h.defaultNodeHeight, g = `${n.borderColor || h.defaultNodeBorderColor} solid ${n.borderWidth === void 0 ? h.defaultNodeBorderWidth : n.borderWidth}px`, m = !(h.hideNodeContentByZoom === !0 && h.canvasZoom < 40), _ = n.opacity === void 0 ? 1 : n.opacity > 1 ? n.opacity / 100 : n.opacity, L = C.isAllowShowNode(n), T = n.expandHolderPosition && n.expandHolderPosition !== "hide" || h.defaultExpandHolderPosition && h.defaultExpandHolderPosition !== "hide" && n.lot.childs && n.lot.childs.length > 0, D = n.expanded === !1 ? "c-expanded" : "c-collapsed";
  return /* @__PURE__ */ Z(
    "div",
    {
      ref: i,
  ...
  const t = J(ne), o = J(pe), i = t.options, a = s.id === i.checkedLineId, c = s.showStartArrow ? t.getArrow(s, n, !0) : void 0, r = s.showEndArrow ? t.getArrow(s, n, !1) : void 0, l = () => {
...
}, To = ({ link: n, relation: s, relationIndex: e }) => {
  const t = J(ne), o = J(pe), i = t.options, a = `translate(${s.textOffset_x || i.defaultLineTextOffset_x || 0},${s.textOffset_y || i.defaultLineTextOffset_y || -8})`, c = `#${i.instanceId}-${n.seeks_id}-${e}`, r = s.id === i.checkedLineId, l = s.lineShape === 4 || i.defaultLineShape === 4 ? "start" : "middle", h = s.lineShape === 4 || i.defaultLineShape === 4 ? i.layoutDirection === "v" ? Math.abs(n.toNode.x - n.fromNode.x) + 43 : Math.abs(n.toNode.y - n.fromNode.y) + 43 : "50%", d = (f) => {
    t.onLineClick(s, n, f), o();
  };
  return /* @__PURE__ */ Z("g", { children: [
    /* @__PURE__ */ y(
    ...
    /* @__PURE__ */ y("g", { transform: a, children: /* @__PURE__ */ y(
      "text",
      {
        ...
        onTouchStart: (f) => d(f),
        onClick: (f) => d(f),
        children: /* @__PURE__ */ y("textPath", { xlinkHref: c, startOffset: h, textAnchor: l, method: "align", spacing: "auto", children: s.text })
      }
    ) })
  ] });
}, Ao = ({ linkProps: n, LineSlot: s }) => {
  ...
  return /* @__PURE__ */ y(
    "g",
    {
      ...
      children: n.relations.map(
        (i, a) => /* @__PURE__ */ y(xe.Fragment, { children: s ? /* @__PURE__ */ y(s, { relationGraph: e, link: n, relation: i, relationIndex: a }) : i.useTextPath || o.lineUseTextPath ? /* @__PURE__ */ y(To, { link: n, relation: i, relationIndex: a }) : /* @__PURE__ */ y(Ze, { link: n, relation: i, relationIndex: a }) }, i.id)
      )
    }
  );
}, Bo = ({ link: n, relation: s, relationIndex: e }) => {
  const t = J(ne), o = t.options, i = s.id === o.checkedLineId, a = () => {
    ...
    return l;
  }, c = s.showStartArrow ? t.getArrow(s, n, !0) : void 0, r = s.showEndArrow ? t.getArrow(s, n, !1) : void 0;
  return /* @__PURE__ */ y(
    "path",
    {
  ...
  }, o = s.options, i = s.allLineColors, a = s.graphData.nodes, c = s.graphData.links, r = s.graphData.elementLines;
  return /* @__PURE__ */ Z("div", { children: [
      ...
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ Z("defs", { children: [
            ...
            c.map(
              (l) => /* @__PURE__ */ y(xe.Fragment, { children: l.relations.filter((h) => o.lineUseTextPath || h.useTextPath).map(
                (h, d) => /* @__PURE__ */ y(
                  Bo,
                  {
                    link: l,
    ...
    /* @__PURE__ */ y("div", { className: "rel-linediv rel-linediv-el-lines", children: /* @__PURE__ */ y(
      "svg",
      {
        ...
        xmlns: "http://www.w3.org/2000/svg",
        children: r.map(
          (l) => l.relations[0].isHide === !1 && /* @__PURE__ */ y(Ze, { link: l, relation: l.relations[0], relationIndex: 0 }, "ell-" + l.relations[0].id)
        )
      }
    ) })
  ] });
}, $o = (n) => {
  const s = J(ne), e = J(pe), t = Oe(), i = (() => ({
  ...
  ze(() => {
    var l, h;
    return console.log("[debug][RelationGraph-canvas] ready!"), p("[RGCanvas mounted]"), s.setCanvasDom(t.current), (h = (l = t.current) == null ? void 0 : l.parentElement) == null || h.addEventListener("wheel", a, { passive: !1, capture: !0 }), () => {
      var d, f;
      (f = (d = t.current) == null ? void 0 : d.parentElement) == null || f.removeEventListener("wheel", a);
    };
  }, []);
  const a = (l) => {
    s.onMouseWheel(l), e();
      ...
      children: /* @__PURE__ */ Z(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ y(Po, { nodeSlot: n.nodeSlot, lineSlot: n.lineSlot, expandHolderSlot: n.expandHolderSlot }),
  ...
  const [e, t] = yt({ instance: null }), o = Oe(), i = Oe();
  ze(() => {
    console.log("[debug][RelationGraph] ready!"), io("react");
    const l = n.relationGraphCore ? new n.relationGraphCore(n.options, mt(n)) : new Eo(n.options, mt(n));
    return i.current = l, l.setUpdateViewHook(a), p("setDom:", o.current), l.setDom(o.current), l.ready(), a(), _e && _e.on && _e.on("change", c), () => {
      _e.off("change", c);
    };
  }, []), Xt(s, () => ({
    getInstance() {
    ...
    async setOptions(l, h) {
      await i.current.setOptions(l), a(), h && h(i.current);
    },
    async setJsonData(l, h, d) {
      arguments.length === 2 && typeof h == "function" && (d = h, h = !0), await i.current.setJsonData(
        l,
        !0
      ), await i.current.refresh(!1), a(), d && d(i.current);
    },
    async appendJsonData(l, h, d) {
      arguments.length === 2 && typeof h == "function" && (d = h, h = !0), await i.current.appendJsonData(l, !0), a(), d && d(i.current);
    },
    setLayouter(l) {
      i.current.setLayouter(l), a();
    },
    onGraphResize() {
    ...
    focusNodeById(l) {
      i.current.focusNodeById(l), a();
    },
    getNodeById(l) {
      return i.current.getNodeById(l);
    },
    removeNodeById(l) {
      return i.current.removeNodeById(l);
    },
    getNodes() {
  ...
  const a = (l) => {
    t({ instance: l || i.current });
  };
  i.current && i.current.setUpdateViewHook(a);
  const c = () => {
    i.current.fullscreen(_e.isFullscreen);
  }, r = e && e.instance && e.instance.options;
  return /* @__PURE__ */ y(Ne, { children: /* @__PURE__ */ y(Qt, { value: i.current, children: /* @__PURE__ */ y(eo, { value: a, children: /* @__PURE__ */ Z(
    "div",
    {
      ref: o,
      ...
      children: [
        r && r.showDebugPanel && /* @__PURE__ */ y(Mo, {}),
        r && r.allowShowMiniToolBar === !0 && (n.toolBarSlot ? /* @__PURE__ */ y(n.toolBarSlot, { relationGraph: e.instance }) : /* @__PURE__ */ y(Oo, {})),
        r && r.allowShowMiniView === !0 && (n.miniViewSlot ? /* @__PURE__ */ y(n.miniViewSlot, { relationGraph: e.instance }) : /* @__PURE__ */ y(No, {})),
        r && (n.graphPlugSlot ? /* @__PURE__ */ y(n.graphPlugSlot, { relationGraph: e.instance }) : /* @__PURE__ */ y("div", { className: "rel-graph-plug" })),
        r && /* @__PURE__ */ y(
          $o,
          {
            nodeSlot: n.nodeSlot,
        ...
        /* @__PURE__ */ y(Io, { nodeSlot: n.nodeSlot }),
        /* @__PURE__ */ y(Ro, {})
      ]
    }
  ) }) }) });
