...
function _t() {
  if (ht)
    return Ve;
  ht = 1;
  var n = Object.getOwnPropertySymbols, s = Object.prototype.hasOwnProperty, e = Object.prototype.propertyIsEnumerable;
  function t(i) {
    if (i == null)
  ...
  return Ve = o() ? Object.assign : function(i, a) {
    for (var l, r = t(i), c, h = 1; h < arguments.length; h++) {
...
function Kt() {
  ...
  if (_e.Fragment = 60107, typeof Symbol == "function" && Symbol.for) {
    var e = Symbol.for;
    s = e("react.element"), _e.Fragment = e("react.fragment");
  }
  var t = n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, o = Object.prototype.hasOwnProperty, i = { key: !0, ref: !0, __self: !0, __source: !0 };
  function a(l, r, c) {
    var h, d = {}, f = null, g = null;
    c !== void 0 && (f = "" + c), r.key !== void 0 && (f = "" + r.key), r.ref !== void 0 && (g = r.ref);
    for (h in r)
      o.call(r, h) && !i.hasOwnProperty(h) && (d[h] = r[h]);
    if (l && l.defaultProps)
      for (h in r = l.defaultProps, r)
        d[h] === void 0 && (d[h] = r[h]);
    return { $$typeof: s, type: l, key: f, ref: g, props: d, _owner: t.current };
  }
  return _e.jsx = a, _e.jsxs = a, _e;
}
var Fe = {};
/** @license React v17.0.2
...
function Qt() {
  return dt || (dt = 1, function(n) {
    process.env.NODE_ENV !== "production" && function() {
      var s = xe, e = _t(), t = 60103, o = 60106;
      n.Fragment = 60107;
      var i = 60108, a = 60114, l = 60109, r = 60110, c = 60112, h = 60113, d = 60120, f = 60115, g = 60116, m = 60121, _ = 60122, x = 60117, D = 60129, R = 60131;
      if (typeof Symbol == "function" && Symbol.for) {
        var S = Symbol.for;
        t = S("react.element"), o = S("react.portal"), n.Fragment = S("react.fragment"), i = S("react.strict_mode"), a = S("react.profiler"), l = S("react.provider"), r = S("react.context"), c = S("react.forward_ref"), h = S("react.suspense"), d = S("react.suspense_list"), f = S("react.memo"), g = S("react.lazy"), m = S("react.block"), _ = S("react.server.block"), x = S("react.fundamental"), S("react.scope"), S("react.opaque.id"), D = S("react.debug_trace_mode"), S("react.offscreen"), R = S("react.legacy_hidden");
      }
      var b = typeof Symbol == "function" && Symbol.iterator, $ = "@@iterator";
      function P(u) {
      ...
      function z(u, v, w) {
        {
          var O = A.ReactDebugCurrentFrame, I = O.getStackAddendum();
          I !== "" && (v += "%s", w = w.concat([I]));
          var W = w.map(function(B) {
            return "" + B;
          });
          W.unshift("Warning: " + v), Function.prototype.apply.call(console[u], console, W);
        }
      }
      var H = !1;
      function F(u) {
        return !!(typeof u == "string" || typeof u == "function" || u === n.Fragment || u === a || u === D || u === i || u === h || u === d || u === R || H || typeof u == "object" && u !== null && (u.$$typeof === g || u.$$typeof === f || u.$$typeof === l || u.$$typeof === r || u.$$typeof === c || u.$$typeof === x || u.$$typeof === m || u[0] === _));
      }
      function U(u, v, w) {
        var O = v.displayName || v.name || "";
        return u.displayName || (O !== "" ? w + "(" + O + ")" : w);
      }
      function oe(u) {
      ...
      function E(u) {
        if (u == null)
          return null;
        if (typeof u.tag == "number" && L("Received an unexpected object in getComponentName(). This is likely a bug in React. Please file an issue."), typeof u == "function")
        ...
        if (typeof u == "object")
          switch (u.$$typeof) {
            ...
            case m:
              return E(u._render);
            case g: {
              var O = u, I = O._payload, W = O._init;
              try {
                return E(W(I));
              } catch {
                return null;
      ...
      function Ae() {
        {
          if (N === 0) {
            ae = console.log, se = console.info, M = console.warn, K = console.error, V = console.group, Y = console.groupCollapsed, Q = console.groupEnd;
            var u = {
              configurable: !0,
              enumerable: !0,
              value: we,
...
` + Le + u;
      ...
      function qe(u, v) {
        ...
        var W;
        W = Ce.current, Ce.current = null, Ae();
        try {
          if (v) {
            var B = function() {
              throw Error();
...
`), ee = O.stack.split(`
`), G = T.length - 1, X = ee.length - 1; G >= 1 && X >= 0 && T[G] !== ee[X]; )
              X--;
            for (; G >= 1 && X >= 0; G--, X--)
              if (T[G] !== ee[X]) {
                if (G !== 1 || X !== 1)
...
` + T[G].replace(" at new ", " at ");
                      return typeof u == "function" && ke.set(u, re), re;
                    }
                  while (G >= 1 && X >= 0);
                break;
              }
          ...
          Re = !1, Ce.current = W, Be(), Error.prepareStackTrace = I;
        }
        var ve = u ? u.displayName || u.name : "", ct = ve ? ge(ve) : "";
        return typeof u == "function" && ke.set(u, ct), ct;
      }
      function Ke(u, v, w) {
        return qe(u, !1);
      }
      ...
      var Qe = {}, et = A.ReactDebugCurrentFrame;
      function Me(u) {
        if (u) {
          var v = u._owner, w = Ee(u.type, u._source, v ? v.type : null);
          et.setExtraStackFrame(w);
        } else
          et.setExtraStackFrame(null);
      }
      function Mt(u, v, w, O, I) {
        {
            ...
            if (W(u, B)) {
              ...
              try {
                if (typeof u[B] != "function") {
                  var ee = Error((O || "React class") + ": " + w + " type `" + B + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof u[B] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                  throw ee.name = "Invariant Violation", ee;
                }
                T = u[B](v, B, O, w, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
              } catch (G) {
                T = G;
              }
              T && !(T instanceof Error) && (Me(I), L("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", O || "React class", w, B, typeof T), Me(null)), T instanceof Error && !(T.message in Qe) && (Qe[T.message] = !0, Me(I), L("Failed %s type: %s", w, T.message), Me(null));
            }
        }
      }
      var be = A.ReactCurrentOwner, Pe = Object.prototype.hasOwnProperty, Ot = {
        key: !0,
        ref: !0,
        __self: !0,
        __source: !0
      ...
      function Dt(u, v) {
        if (typeof u.ref == "string" && be.current && v && be.current.stateNode !== v) {
          var w = E(be.current.type);
          $e[w] || (L('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', E(be.current.type), u.ref), $e[w] = !0);
        }
      }
      function Tt(u, v) {
        {
          var w = function() {
            tt || (tt = !0, L("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", v));
          };
      ...
      function At(u, v) {
        {
          var w = function() {
            ot || (ot = !0, L("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", v));
          };
      ...
      function Rt(u, v, w, O, I) {
        {
          var W, B = {}, T = null, ee = null;
          w !== void 0 && (T = "" + w), zt(v) && (T = "" + v.key), Nt(v) && (ee = v.ref, Dt(v, I));
          for (W in v)
            Pe.call(v, W) && !Ot.hasOwnProperty(W) && (B[W] = v[W]);
          if (u && u.defaultProps) {
          ...
          return Bt(u, T, ee, I, O, be.current, B);
        }
      }
...
Check the render method of \`` + u + "`.";
      ...
      function Pt(u) {
        {
          if (u !== void 0) {
            var v = u.fileName.replace(/^.*[\\\/]/, ""), w = u.lineNumber;
            return `
...
Check the top-level render call using <` + w + ">.");
      ...
      function at(u, v) {
        {
          ...
          st[w] = !0;
          var O = "";
          u && u._owner && u._owner !== Ie.current && (O = " It was passed a child from " + E(u._owner.type) + "."), ye(u), L('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', w, O), ye(null);
        }
      }
      function rt(u, v) {
        {
          ...
          if (Array.isArray(u))
            ...
            if (typeof I == "function" && I !== u.entries)
              for (var W = I.call(u), B; !(B = W.next()).done; )
                He(B.value) && at(B.value, v);
          }
        }
      }
      function It(u) {
      ...
      function Wt(u) {
        {
          for (var v = Object.keys(u.props), w = 0; w < v.length; w++) {
            var O = v[w];
            if (O !== "children" && O !== "key") {
              ye(u), L("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", O), ye(null);
              break;
            }
          }
          u.ref !== null && (ye(u), L("Invalid attribute `ref` supplied to `React.Fragment`."), ye(null));
        }
      }
      function lt(u, v, w, O, I, W) {
        {
          var B = F(u);
          if (!B) {
            var T = "";
            ...
            ee ? T += ee : T += it();
            var G;
            u === null ? G = "null" : Array.isArray(u) ? G = "array" : u !== void 0 && u.$$typeof === t ? (G = "<" + (E(u.type) || "Unknown") + " />", T = " Did you accidentally export a JSX literal instead of a component?") : G = typeof u, L("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", G, T);
          }
          var X = Rt(u, v, w, I, W);
          if (X == null)
            return X;
          ...
          return u === n.Fragment ? Wt(X) : It(X), X;
        }
      }
      function Ht(u, v, w) {
        return lt(u, v, w, !0);
...
(function(n) {
  process.env.NODE_ENV === "production" ? n.exports = Kt() : n.exports = Qt();
})(De);
const Ne = De.exports.Fragment, y = De.exports.jsx, Z = De.exports.jsxs, ne = yt(null), me = yt(null), eo = ne.Provider, to = me.Provider, oo = "2.1.23", no = (n) => (n = n.replace("#", ""), n = n.replace("(", ""), n = n.replace(")", ""), n = n.replace(/,/, "-"), n), fe = (n) => {
  try {
...
}, Xe = (n, s, e) => n ? n.classList.contains(s) ? n : n.classList.contains(e) ? null : Xe(n.parentElement, s, e) : null, ut = async (n) => new Promise((s, e) => {
  setTimeout(() => {
    s();
  }, n);
}), q = (n) => typeof n == "string" ? Number.parseInt(n) : n, io = (n) => {
  console.log(
    `%c relation-graph${n ? "" : "/" + n} %c Version v${oo} %c More info: https://github.com/seeksdream/relation-graph %c`,
  ...
  return s.lot = {
    ...
    eached: !1,
    strength: 0
  }, s.el === void 0 && (s.el = { offsetWidth: 50, offsetHeight: 50 }), s.width !== void 0 && (s.el.offsetWidth = s.width), s.height !== void 0 && (s.el.offsetHeight = s.height), s;
}, so = [
  "Fx",
  "Fy",
  "appended",
  ...
  return Object.keys(n).forEach((e) => {
    so.includes(e) || n[e] !== void 0 && (s[e] = n[e]);
  }), s;
}, Ue = (n) => {
  if (n.from === void 0)
...
}, ro = ["arrow", "id", "reverseText", "isReverse"], lo = (n, s) => {
  !n || n.relations.forEach((e) => {
    const t = {};
    Object.keys(e).forEach((o) => {
      ro.includes(o) || e[o] !== void 0 && (t[o] = e[o]);
    }), s.push(t);
  });
}, ce = {
  border: "border",
  ...
  analysisNodes(n, s, e, t) {
    ...
    const i = [];
    s.forEach((a) => {
      n.push(a), a.targetNodes && a.targetNodes.forEach((l) => {
        n.includes(l) || (n.push(l), l.lot.parent = a, i.push(l));
      });
    }), o.all_strength > t.max_strength && (t.max_strength = o.all_strength), i.length > 0 && C.analysisNodes(n, i, e + 1, t);
  },
  analysisNodes4Didirectional(n, s, e, t, o) {
    ...
    s.forEach((r) => {
      r.lot || (r.lot = { childs: [] }), r.lot.eached = !0, r.lot.subling = i, r.lot.level = e, n.push(r);
    });
    let l = 0;
    s.forEach((r) => {
      let c = 0;
      if (o === 0) {
        ...
        r.targetNodes.forEach((d) => {
          d.lot || (d.lot = { eached: !1, childs: [] }), d.lot.eached || (C.isAllowShowNode(d) ? (d.lot.eached = !0, d.lot.parent = r, d.lot.index_of_parent = h++, r.lot.childs.push(d), a.push(d), c++) : r.lot.childs.push(d));
        });
      } else if (o === -1) {
        let h = 0;
    ...
    }), i.all_strength > t.max_strength && (t.max_strength = i.all_strength), a.length > 0 ? C.analysisNodes4Didirectional(n, a, e + (o === -1 ? -1 : 1), t, o) : (n.forEach((r) => {
      r.lot.childs_size > 0 && (r.lot.strengthWithChilds = 0);
    }), n.forEach((r) => {
      r.lot.childs_size === 0 && (r.lot.strengthWithChilds = 1, C.conductStrengthToParents(r));
    }), C.analysisDataTree([n[0]], 0, o));
  },
  conductStrengthToParents(n) {
    n.lot.parent && Math.abs(n.lot.level) - 1 === Math.abs(n.lot.parent.lot.level) && (n.lot.parent.lot.strengthWithChilds += 1, C.conductStrengthToParents(n.lot.parent));
  },
  analysisDataTree(n, s, e) {
    e === void 0 && (e = 1);
    const t = [];
    let o = 0;
    n.forEach((i) => {
    ...
    }), t.length > 0 && C.analysisDataTree(t, s + e, e);
  },
  isAllowShowNode(n, s = 0) {
    return s > 15 ? !0 : (!n.lot || !n.lot.parent || C.isAllowShowNode(n.lot.parent, s + 1) && n.lot.parent.expanded !== !1) && n.isShow && n.isHide !== !0;
  },
  getNodeWidth(n, s) {
  ...
  getNodeXByCenterX(n, s, e) {
    return s.alignItems === "right" ? e - C.getNodeWidth(s, n) : s.alignItems === "left" ? e : e - C.getNodeWidth(s, n) / 2;
  },
  getNodeYByCenterY(n, s, e) {
    return s.alignItems === "top" ? e : s.alignItems === "bottom" ? e - C.getNodeHeight(s, n) : e - C.getNodeHeight(s, n) / 2;
  },
  getCenterXByNodeX(n, s, e) {
    return e + C.getNodeHeight(s, n) / 2;
  },
  ...
  isRectangleOverlap(n, s) {
    const e = n.x + j, t = s.x + j, o = n.el.offsetWidth - j * 2, i = s.el.offsetWidth - j * 2, a = n.y + j, l = s.y + j, r = n.el.offsetHeight - j * 2, c = s.el.offsetHeight - j * 2;
    return !(t >= e + o || t + i <= e || l >= a + r || l + c <= a);
  },
  isXOverlap(n, s, e, t) {
    return !(s >= n + e || s + t <= n);
  },
  ...
  getNoOverlapLimitedPosition(n, s, e, t) {
    const o = n.x + j, i = n.y + j, a = s + j, l = t.x + j, r = n.el.offsetWidth - j * 2, c = t.el.offsetWidth - j * 2, h = e + j, d = t.y + j, f = n.el.offsetHeight - j * 2, g = t.el.offsetHeight - j * 2;
    let m = n.x, _ = n.y;
    const x = this.isXOverlap(o, l, r, c), D = this.isYOverlap(i, d, f, g);
    return x ? h < d ? (m = s, _ = d - f - j) : h > d && (m = s, _ = d + g - j) : D && (a < l ? (m = l - r - j, _ = e) : a > l && (m = l + c - j, _ = e)), { x: m, y: _ };
  },
...
class Te {
  constructor(s, e) {
    k(this, "graphOptions");
    k(this, "layoutOptions");
    k(this, "allNodes", []);
    k(this, "isMainLayouer", !0);
    k(this, "requireLinks", !1);
    k(this, "allLinks", []);
    k(this, "rootNode");
    k(this, "currentAnimationStep", 1);
    k(this, "allAnimationStep", 30);
    this.layoutOptions = s, this.graphOptions = e;
  }
  setLinks(s) {
    p("setLinks:", s.length), this.allLinks = s;
  }
  refresh() {
  ...
  snapshotBeforeAnimation() {
    this.allNodes.forEach((s) => {
      !C.isAllowShowNode(s) || (s.lot.to_x = C.getNodeXByLotX(this.graphOptions, s), s.lot.to_y = C.getNodeYByLotY(this.graphOptions, s), s.lot.from_x = s.x || 0, s.lot.from_y = s.y || 0, s.lot.placed = !0);
    });
  }
    ...
    return new Promise((o, i) => {
      this.playAnimation(() => {
        t || (t = !0, p("[LayoutAnimationEffect]played!"), this.allNodes.forEach((a) => {
          !C.isAllowShowNode(a) || (a.lot.from_x = a.x, a.lot.from_y = a.y, a.x = a.lot.to_x, a.y = a.lot.to_y);
        }), o());
      });
    });
  }
  playAnimation(s) {
    ...
    this.allNodes.forEach((e) => {
      ...
      if (t !== void 0 && o !== void 0 && i !== void 0 && a !== void 0) {
        const l = (i - t) / this.allAnimationStep, r = (a - o) / this.allAnimationStep, c = Math.floor(t + this.currentAnimationStep * l), h = Math.floor(o + this.currentAnimationStep * r);
        (e.x !== c || e.y !== h) && (e.x = c, e.y = h);
      }
...
class co extends Te {
  ...
  analysisNodes4Didirectional(e, t, o, i, a) {
    p(`${a} level ${o} size: ${t.length}`), t.length > i.max_length && (i.max_length = t.length), o > i.max_deep && (i.max_deep = o);
    const l = {
      level: o,
      all_size: t.length,
      all_strength: 0
    ...
    t.forEach((h) => {
      h.lot || (h.lot = { childs: [] }), h.lot.eached = !0, h.lot.subling = l, h.lot.level = o, e.push(h);
    });
    let c = 0;
    t.forEach((h) => {
      ...
      let g = 0;
      f.forEach((m) => {
        m.lot || (m.lot = { eached: !1, childs: [] }), m.lot.eached || (m.lot.parent = h, C.isAllowShowNode(m) ? (m.lot.eached = !0, m.lot.index_of_parent = g++, h.lot.childs.push(m), r.push(m), d++) : h.lot.childs.push(m));
      }), h.lot.strength = d > 0 ? d : 1, l.all_strength += h.lot.strength, h.lot.strength_plus = l.all_strength, h.lot.index_of_level = c, h.lot.childs_size = d, c++;
    }), l.all_strength > i.max_strength && (i.max_strength = l.all_strength), r.length > 0 ? this.analysisNodes4Didirectional(e, r, o + a, i, a) : (e.forEach((h) => {
  ...
  async placeNodes(e, t) {
    ...
    C.analysisNodes(o, [this.rootNode], 0, i), o = [], i = {
      ...
      max_length: 1,
      max_strength: 1
    }, this.analysisNodes4Didirectional(o, [this.rootNode], 0, i, 1), this.placeNodesPosition(this.rootNode, o, i), p("allNodes:", o.length), this.graphOptions.useAnimationWhenExpanded ? (p("Play layout animation....."), await this.animationLayout(), p("create rootNode coordinates:3", t.x, t.y)) : (this.allNodes.forEach((a) => {
      if (a.fixed === !0) {
        a.lot.placed = !0;
        return;
      }
      !C.isAllowShowNode(a) || (Number.isNaN(a.lot.x) && (p("bad lot x:", a.text, a.lot.x), a.lot.x = 0), Number.isNaN(a.lot.y) && (p("bad lot y:", a.text, a.lot.y), a.lot.y = 0), a.x = C.getNodeXByLotX(this.graphOptions, a), a.y = C.getNodeYByLotY(this.graphOptions, a), a.lot.placed = !0);
  ...
  placeRelativePosition(e, t, o) {
    ...
    if (this.layoutOptions.from === "left" || this.layoutOptions.from === "right") {
      const a = q(this.layoutOptions.min_per_height) || 80, l = q(this.layoutOptions.max_per_height) || 400, r = q(this.layoutOptions.min_per_width) || 430, c = q(this.layoutOptions.max_per_width) || 650;
      let h = Math.round((i.width - 10) / (o.max_deep + 2));
      h < r && (h = r), h > c && (h = c);
      let d = Math.round(i.height / (o.max_strength + 1));
      d < a && (d = a), d > l && (d = l), t.forEach((f) => {
      ...
      const a = q(this.layoutOptions.min_per_height) || 350, l = q(this.layoutOptions.max_per_height) || 400, r = q(this.layoutOptions.min_per_width) || 250, c = q(this.layoutOptions.max_per_width) || 500;
    ...
    e.forEach((a) => {
      ...
      if (a.fixed !== !0 && a.lot.level !== 0) {
        ...
        if (a.lot.strengthWithChilds === 1 && a.lot.childs_size <= 1) {
          const c = this.getBloomingNearByParent(a, a.lot.parent, r, t);
          c && (t === "h" ? a.lot.y - c.lot.y > 0 ? (a.lot.y = c.lot.y + o * c.lot.movedNodeSizeAfter, c.lot.movedNodeSizeAfter++) : (a.lot.y = c.lot.y - o * c.lot.movedNodeSizeBefore, c.lot.movedNodeSizeBefore++) : a.lot.x - c.lot.x > 0 ? (a.lot.x = c.lot.x + o * c.lot.movedNodeSizeAfter, c.lot.movedNodeSizeAfter++) : (a.lot.x = c.lot.x - o * c.lot.movedNodeSizeBefore, c.lot.movedNodeSizeBefore++));
        }
      }
    });
  }
  getBloomingNearByParent(e, t, o, i) {
    ...
    for (const r of o)
      if (r.lot.childs_size > 1 && r.lot.parent === t) {
        const c = i === "h" ? r.lot.y - t.lot.y : r.lot.x - t.lot.x;
...
const pt = 0;
function ho(n, s, e, t, o, i, a, l, r) {
  const c = o - n, h = i - s, d = Math.sqrt(c * c + h * h), f = r * h / d, g = -(r * c) / d, m = n + f, _ = s + g, x = n - e / 2, D = n + e / 2, R = s - t / 2, S = s + t / 2;
  let b = [];
  if (c !== 0) {
    let A = (x - m) / c, L = _ + A * h;
    L >= R && L <= S && b.push({ x, y: L });
    let z = (D - m) / c, H = _ + z * h;
    H >= R && H <= S && b.push({ x: D, y: H });
  }
  if (h !== 0) {
    let A = (R - _) / h, L = m + A * c;
    L >= x && L <= D && b.push({ x: L, y: R });
    let z = (S - _) / h, H = m + z * c;
    H >= x && H <= D && b.push({ x: H, y: S });
  }
  let $ = null, P = 1 / 0;
  return b.forEach((A) => {
    const L = Math.sqrt((A.x - o) ** 2 + (A.y - i) ** 2);
    L < P && (P = L, $ = A);
  }), $;
}
const te = {
  getRectPoint(n, s, e, t, o, i, a, l, r = !1, c = 1, h = 1) {
    r && (h = c - h - 1);
    const d = h - (c - 1) / 2, f = n + o / 2, g = s + i / 2, m = e + a / 2, _ = t + l / 2;
    if (c > 1) {
      const L = 14 * d, z = ho(
        f,
        g,
    ...
    const x = f < m ? 1 : -1, D = g < _ ? 1 : -1;
    if (_ === g)
      return { x: f + x * o / 2, y: g };
    const R = Math.abs((m - f) / (_ - g)), S = o / i;
    let b = 0, $ = 0;
    R < S ? (b = x * i / 2 * R + D * S, $ = D * i / 2) : (b = x * o / 2, $ = D * o / 2 / R + x * S);
    const P = f + b, A = g + $;
    return { x: P, y: A };
  },
  getRectPointBasic(n, s, e, t, o, i, a, l) {
    const r = n + o / 2, c = s + i / 2, h = e + a / 2, d = t + l / 2;
    let f = d === c ? 0 : (h - r) / (d - c);
    f === 0 && (f = (h - r) / (d - c + 1));
    const g = o / l;
    let m = 0, _ = 0, x = "1";
    return -1 * g < f && f < g ? (x = "2", c < d ? (m = i / 2 * f, _ = i / 2) : (m = -1 * i / 2 * f, _ = -1 * i / 2)) : (r < h ? (m = 1 * o / 2, _ = 1 * o / 2 / f) : (m = -1 * o / 2, _ = -1 * o / 2 / f), x = "3"), { x: r + m, y: c + _, _case: x };
  },
  getRectJoinPoint(n, s, e, t, o, i, a, l) {
    const r = n + o / 2, c = s + i / 2, h = e + a / 2, d = t + l / 2, f = Math.round(Math.atan2(d - c, h - r) * 180 / 3.14) + 135;
    return f >= 0 && f < 90 ? { x: n + o / 2, y: s - 5 } : f >= 90 && f < 180 ? { x: n + o + 5, y: s + i / 2 } : f >= 180 && f < 270 ? { x: n + o / 2, y: s + i + 5 } : { x: n - 5, y: s + i / 2 };
  },
  getRectHJoinPoint(n, s, e, t, o, i, a) {
    const l = i / 2;
    return n + o < e ? { x: n + o + 5, y: s + l } : n + o < e + a ? { x: n - 5, y: s + l } : { x: n - 5, y: s + l };
  },
  ...
  getRectRightJoinPoint(n, s, e, t, o, i, a) {
    const l = i / 2;
    return { x: n + o + 5, y: s + l };
  },
  getRectTopJoinPoint(n, s, e, t, o, i, a) {
    return { x: n + o / 2, y: s - 5 };
  },
  getRectBottomJoinPoint(n, s, e, t, o, i, a) {
    return { x: n + o / 2, y: s + i + 5 };
  },
  getRectVJoinPoint(n, s, e, t, o, i, a, l) {
    const r = o / 2;
    return s + i < t ? { y: s + i + 5, x: n + r } : s + i < t + l ? { y: s - 5, x: n + r } : { y: s - 5, x: n + r };
  },
  getBorderPoint(n, s, e, t, o, i, a, l, r) {
    return r === 0 ? this.getCirclePoint(n, s, e, t, o, i, a, l) : this.getRectPoint(n, s, e, t, o, i, a, l);
  },
  getBorderPoint4MultiLine(n, s, e, t, o, i, a, l, r, c, h, d) {
    return r === 0 ? this.getCirclePoint4MultiLine(n, s, e, t, o, i, a, l, c, h, d) : this.getRectPoint(n, s, e, t, o, i, a, l, c, h, d);
  },
  getCirclePoint(n, s, e, t, o, i, a, l) {
    const r = e + a / 2, c = t + l / 2, h = n + o / 2, d = s + i / 2, f = r - h;
    if (f === 0)
      return { x: h, y: d - i / 2 * (c < d ? 1 : -1) };
    const m = (c - d) / f, _ = Math.sqrt(1 / (1 / (o / 2) ** 2 + m ** 2 / (i / 2) ** 2)) * (r < h ? 1 : -1), x = m * _;
    return { x: h - _, y: d - x };
  },
  getCirclePoint4MultiLine(n, s, e, t, o, i, a, l, r, c, h, d = 0) {
    r && (h = c - h - 1);
    const f = e + a / 2, g = t + l / 2, m = n + o / 2, _ = s + i / 2, x = f - m;
    if (x === 0)
      return { x: m, y: _ - i / 2 * (g < _ ? 1 : -1) };
    const R = (h - (c - 1) / 2) * 14, S = g - _, b = Math.sqrt(x ** 2 + S ** 2) * R / x, $ = S / x, P = o / 2, A = i / 2, L = f < m ? 1 : -1, z = (-1 * P ** 2 * $ * b + P * A * Math.sqrt(A ** 2 + $ ** 2 * P ** 2 - b ** 2) / L) / (A ** 2 + P ** 2 * $ ** 2), H = $ * z + b;
    return d === 0 && (Number.isNaN(z) || Number.isNaN(H)) ? this.getCirclePoint4MultiLine(n, s, e, t, o, i, a, l, r, 1, 0, d + 1) : { x: m - z, y: _ - H };
  },
  getCirclePointBasic(n, s, e, t, o, i, a, l, r) {
    const c = n + o / 2, h = s + i / 2, d = e + a / 2, f = t + l / 2, g = d - c, m = f - h, _ = Math.sqrt(g * g + m * m), x = _ - r, D = x * g / _ * -1, R = x * m / _ * -1;
    return { x: d + D, y: f + R };
  },
  getCirclePointPlus(n, s, e, t, o, i, a, l) {
    const r = n + o / 2, c = s + i / 2, h = e + a / 2, d = t + l / 2, f = h - r, g = d - c, m = Math.sqrt(f * f + g * g), _ = (m - o / 2) * f / m * -1, x = (m - i / 2) * g / m * -1;
    return { x: h + _, y: d + x };
  },
  getOvalPoint(n, s, e, t, o) {
    return {
      x: n + e * Math.sin((pt + t * (360 / o) + 0) * Math.PI / 180),
      y: s + e * Math.cos((pt + t * (360 / o) + 0) * Math.PI / 180) * -1
    };
  },
  getAngleType(n, s) {
    if (n >= 0 && s >= 0)
...
class Se extends Te {
  constructor(e, t) {
    ...
    k(this, "layoutOptions");
    k(this, "fastStart", !1);
    k(this, "maxLayoutTimes", 300);
    k(this, "byNode", !0);
    k(this, "byLine", !0);
    k(this, "lockX", !1);
    k(this, "lockY", !1);
    k(this, "force_node_repulsion", 1);
    k(this, "force_line_elastic", 1);
    k(this, "justLayoutSingleNode", !1);
    k(this, "layoutTimes", 0);
    k(this, "prev10", []);
    k(this, "visibleNodes", []);
    k(this, "viewUpdate");
    k(this, "maxVaildLineLength", 400);
    k(this, "minVaildLineLength", 30);
    k(this, "zeroEffectNodeDistance", 400);
    k(this, "minNodeDistance", 30);
    k(this, "maxMoveSpeed", 50);
  ...
  placeNodes(e, t) {
    ...
    if (this.allNodes = e, this.rootNode = t, this.layoutOptions.fixedRootNode) {
      if (!Number.isNaN(t.x) || t.x === void 0)
        t.lot.x = C.getLotXByNodeX(this.graphOptions, t), t.lot.y = C.getLotYByNodeY(this.graphOptions, t);
      else {
        const i = this.layoutOptions.centerOffset_x || 0, a = this.layoutOptions.centerOffset_y || 0;
      ...
      this.easyPlaceRelativePosition(t, o), o.forEach((i) => {
        ...
        i.x = i.lot.x + a - C.getNodeWidth(i, this.graphOptions) / 2, i.y = i.lot.y + l - C.getNodeHeight(i, this.graphOptions) / 2, i.lot.placed = !0;
      });
    } else
      ...
      })) : (p("!!!initNodesPosition....."), this.easyPlaceGroupNodes(this.rootNode).forEach((i) => {
        if (i.fixed === !0 || !C.isAllowShowNode(i))
          return;
        const a = i.offset_x || 0, l = i.offset_y || 0;
        i.x = i.lot.x + a - C.getNodeWidth(i, this.graphOptions) / 2, i.y = i.lot.y + l - C.getNodeHeight(i, this.graphOptions) / 2, i.lot.placed = !0;
  ...
  easyAnalysisNodes(e) {
    ...
    return C.analysisNodes4Didirectional(t, [e], 0, o, 0), t;
  }
  easyPlaceRelativePosition(e, t) {
    t.forEach((i) => {
      if (i.lot.subling.level === 1) {
        ...
        if (a) {
          const l = te.getOvalPoint(e.lot.x, e.lot.y, a.level * 50, i.lot.strength_plus - i.lot.strength / 2, a.all_strength);
      ...
      const a = i.lot.subling;
      if (a && a.level > 1) {
        const l = i.lot.parent.lot.strength_plus - i.lot.parent.lot.strength, c = (i.lot.parent.lot.strength_plus - l) / (i.lot.parent.lot.childs.length + 1) * (i.lot.index_of_parent + 1), h = te.getOvalPoint(e.lot.x, e.lot.y, (a.level - 1) * 40 + 50, l + c, i.lot.parent.lot.subling.all_strength);
  ...
  updateVisibleNodes(e) {
    this.visibleNodes = [], e && (this.allNodes = e), this.allNodes.forEach((t) => {
      C.isAllowShowNode(t) && (t.Fx = 0, t.Fy = 0, t.lot ? t.lot.placed = !0 : (p("node miss lot:", t.text), t.lot = {
        placed: !0,
        childs: []
  ...
  doForceLayout(e) {
    ...
    if (this.isMainLayouer && (this.graphOptions.autoLayouting = !0), this.layoutTimes++, this.visibleNodes.forEach((o) => {
      ...
      for (const o in this.visibleNodes) {
        const i = this.visibleNodes[o];
        if (!(this.justLayoutSingleNode && !i.singleNode) && !i.fixed && i.lot && i.lot.placed === !0)
          for (const a in this.visibleNodes) {
            const l = this.visibleNodes[a];
            l.lot && l.lot.placed === !0 && o !== a && this.addGravityByNode(i, l);
          }
      }
    if (this.byLine)
      if (this.allLinks && this.allLinks.length > 0) {
        for (const o of this.allLinks)
          if (!o.forDisplayOnly) {
            const i = o.relations.reduce((a, l) => a + (l.force_elastic || 1), 0);
  ...
  addElasticByLine(e, t, o = 1) {
    let i = Math.sqrt((this.getY(e) - this.getY(t)) ** 2 + (this.getX(e) - this.getX(t)) ** 2);
    i > this.maxVaildLineLength && (i = this.maxVaildLineLength);
    const a = i < this.minVaildLineLength ? 0 : (i - this.minVaildLineLength) * 0.1 * this.force_line_elastic * o, l = a, r = a, c = (this.getX(e) - this.getX(t)) / i, h = (this.getY(e) - this.getY(t)) / i;
    this.addFtoNode(e, c * l * -1, h * l * -1), this.addFtoNode(t, c * r, h * r);
  }
  addGravityByNode(e, t) {
    const o = Math.sqrt(
      (this.getY(e) - this.getY(t)) ** 2 + (this.getX(e) - this.getX(t)) ** 2
    );
    let i = o > this.zeroEffectNodeDistance ? 0 : (this.zeroEffectNodeDistance - o) * 0.05 * this.force_node_repulsion;
    o < this.minNodeDistance && (i = i * 2);
    const a = (this.getX(e) - this.getX(t)) / o, l = (this.getY(e) - this.getY(t)) / o;
...
class fo extends Se {
  ...
  async placeNodes(e, t) {
    ...
    if (C.analysisNodes(o, [this.rootNode], 0, i), o = [], i = {
      ...
      max_length: 1,
      max_strength: 1
    }, C.analysisNodes4Didirectional(o, [this.rootNode], 0, i, 0), t.fixed)
      ...
      t.lot.x = 0 + a, t.lot.y = 0 + l;
    }
    p("root position:", t.lot.x, t.lot.y), this.placeRelativePosition(this.rootNode, o, i), this.graphOptions.useAnimationWhenExpanded ? (p("Play layout animation....."), await this.animationLayout()) : o.forEach((a) => {
      if (a.fixed === !0 || !C.isAllowShowNode(a))
        return;
      const l = a.offset_x || 0, r = a.offset_y || 0, c = -C.getNodeWidth(a, this.graphOptions) / 2, h = -C.getNodeHeight(a, this.graphOptions) / 2;
      a.x = a.lot.x + l + c, a.y = a.lot.y + r + h, a.lot.placed = !0;
    });
  }
  getLevelDistanceArr() {
    let e = [];
  ...
  placeRelativePosition(e, t, o) {
    const i = this.layoutOptions.distance_coefficient === void 0 ? 1 : this.layoutOptions.distance_coefficient, a = this.getLevelDistanceArr(), l = Math.min(this.graphOptions.viewSize.height, this.graphOptions.viewSize.width) * 0.4;
    let r = Math.min(Math.max(l, 150), 400) * i;
    p("analyticResult:", o, l, r, i, a);
    let c = 0;
    t.forEach((d) => {
      const f = d.lot.subling;
      if (f && f.level === 1) {
        c = Math.round(f.all_size * 60 / Math.PI / 2), c < r && (c = r);
        const g = this.getLevelR(a, f.level) || f.level * c, m = te.getOvalPoint(e.lot.x, e.lot.y, g, d.lot.strength_plus - d.lot.strength / 2, f.all_strength);
        d.lot.x = m.x, d.lot.y = m.y;
      }
    });
    ...
    t.forEach((d) => {
      const f = d.lot.subling;
      if (f && f.level > 1) {
        const g = d.lot.parent.lot.strength_plus - d.lot.parent.lot.strength, _ = (d.lot.parent.lot.strength_plus - g) / (d.lot.parent.lot.childs_size + 1) * (d.lot.index_of_parent + 1), x = this.getLevelR(a, f.level) || (f.level - 1) * h + c, D = te.getOvalPoint(e.lot.x, e.lot.y, x, g + _, d.lot.parent.lot.subling.all_strength);
        d.lot.x = D.x, d.lot.y = D.y;
      }
    });
  }
}
class uo extends Se {
  ...
  async placeNodes(s, e) {
    ...
    this.allNodes = s, this.rootNode = e, s.forEach((r) => {
    ...
    l < 200 && (l = 200), l > 800 && (l = 800), this.allNodes.forEach((r, c) => {
      const h = te.getOvalPoint(i.x, i.y, l, c, a);
      ...
      if (r.fixed === !0 || !C.isAllowShowNode(r))
        return;
      const c = r.offset_x || 0, h = r.offset_y || 0, d = -C.getNodeWidth(r, this.graphOptions) / 2, f = -C.getNodeHeight(r, this.graphOptions) / 2;
      r.x = r.lot.x + c + d, r.y = r.lot.y + h + f, r.lot.placed = !0;
    });
  }
}
class po extends Te {
  ...
  placeNodes(e, t) {
    ...
    p("allNodes:", e.length), this.__origin_nodes = e, this.rootNode = t, e.forEach((i) => {
    ...
    C.analysisNodes4Didirectional(this.allNodes, [this.rootNode], 0, o, 0), p("[layout canvasOffset]", this.graphOptions.viewSize, this.graphOptions.canvasSize);
  }
}
class mo extends Te {
  constructor(e, t) {
  ...
  analysisNodes4Didirectional(e, t, o, i) {
    ...
    e.forEach((c) => {
      const h = c.lot.level + "";
      a[h] || (a[h] = []), a[h].push(c), c.lot.subling = {
        level: c.lot.level,
        all_size: 0,
        all_strength: 0
      };
    }), e.forEach((c) => {
      const h = c.lot.level + "", d = a[h], f = d.length;
      c.lot.index_of_level = d.indexOf(c), c.lot.subling.all_size = f, c.lot.subling.all_strength += c.lot.strength || 1, c.lot.strength_plus = c.lot.subling.all_strength;
    }), e.forEach((c) => {
    ...
    const l = Object.keys(a).map((c) => Number.parseInt(c)).sort(), r = (c) => {
      ...
      let f = 0;
      d.forEach((g) => {
        g.lot.parent && f < g.lot.parent.lot.strengthWithChilds_from && (f = g.lot.parent.lot.strengthWithChilds_from), c === 0 ? f += 1 : g.lot.strengthWithChilds_from = f, p("levels:", c, f, g.text, g.lot.strengthWithChilds), f += g.lot.strengthWithChilds;
      });
    };
    [0].forEach(r), l.filter((c) => c > 0).forEach(r), l.filter((c) => c < 0).forEach(r);
  }
  analysisBothWay(e, t, o, i) {
    p(`level ${o} size: ${t.length}`), t.length > i.max_length && (i.max_length = t.length), o > i.max_deep && (i.max_deep = o);
    const a = {
      level: o,
      all_size: t.length,
      all_strength: 0
    ...
    t.forEach((r) => {
      ...
      r.targetFrom.forEach((f) => {
        f.lot || (f.lot = { eached: !1, childs: [] }), f.lot.eached || (f.lot.parent = r, C.isAllowShowNode(f) ? (f.lot.eached = !0, f.lot.index_of_parent = h++, r.lot.childs.push(f), d.push(f), c++) : r.lot.childs.push(f));
      }), this.analysisBothWay(e, d, o - 1, i), d = [], r.targetTo.forEach((f) => {
        f.lot || (f.lot = { eached: !1, childs: [] }), f.lot.eached || (f.lot.parent = r, C.isAllowShowNode(f) ? (f.lot.eached = !0, f.lot.index_of_parent = h++, r.lot.childs.push(f), d.push(f), c++) : r.lot.childs.push(f));
      }), this.analysisBothWay(e, d, o + 1, i), r.lot.strength = c > 0 ? c : 1, a.all_strength += r.lot.strength, r.lot.strength_plus = a.all_strength, r.lot.index_of_level = l, r.lot.childs_size = c, l++;
  ...
  async placeNodes(e, t) {
    ...
    C.analysisNodes(o, [this.rootNode], 0, i), o = [], i = {
      ...
      max_length: 1,
      max_strength: 1
    }, this.analysisNodes4Didirectional(o, [this.rootNode], 0, i), this.placeNodesPosition(this.rootNode, o, i), p("allNodes:", o.length), this.graphOptions.useAnimationWhenExpanded ? (p("Play layout animation....."), await this.animationLayout(), p("create rootNode coordinates:3", t.x, t.y)) : (this.allNodes.forEach((r) => {
      if (r.fixed === !0) {
        r.lot.placed = !0;
        return;
      }
      !C.isAllowShowNode(r) || (Number.isNaN(r.lot.x) && (p("bad lot x:", r.text, r.lot.x), r.lot.x = 0), Number.isNaN(r.lot.y) && (p("bad lot y:", r.text, r.lot.y), r.lot.y = 0), r.x = C.getNodeXByLotX(this.graphOptions, r), r.y = C.getNodeYByLotY(this.graphOptions, r), r.lot.placed = !0);
    }), p("create rootNode coordinates:1", t.x, t.y));
    const a = o.filter((r) => r.lot.level === 0), l = new Se({
      layoutName: "force",
      maxLayoutTimes: 100,
...
const xt = (n, s) => {
  wt(n);
  let e = null;
  if (n.layoutName === "tree" ? e = new co(n, s) : n.layoutName === "center" ? e = new fo(n, s) : n.layoutName === "circle" ? e = new uo(n, s) : n.layoutName === "force" ? e = new Se(n, s) : n.layoutName === "fixed" ? e = new po(n, s) : n.layoutName === "smart-tree" && (e = new mo(n, s)), !e)
    throw new Error("unknown layout: " + n.layoutName);
  return s.isNeedShowAutoLayoutButton = n.allowAutoLayoutIfSupport !== !1 && e.autoLayout !== void 0, e;
}, wt = (n) => {
...
const yo = (n) => {
  ...
  const s = {
    ...
    creatingNodePlot: !1,
    showTemplateNode: !0,
    newNodeTemplate: Je(JSON.parse(JSON.stringify(Ct))),
    creatingLinePlot: !1,
    newLineTemplate: {
  ...
  if (s.newLineTemplate = Ue(s.newLineTemplate), n.layout && n.layouts)
  ...
  n && Object.keys(n).forEach((i) => {
    ...
    const a = n[i];
    if (!t.includes(i)) {
      p("RGOptions: unknow option key:", i);
      return;
    }
    if (typeof a == "object") {
      p("RGOptions:user setting object:", i, a);
      const l = s[i];
  ...
  return !n.layouts || !Array.isArray(n.layouts) || n.layouts.length === 0 ? n.layout ? o = [n.layout] : o = [{
    ...
    layoutName: "center",
    layoutDirection: "v"
  }] : o = n.layouts, p("final layouts:", o), s.layouts = o.map((i) => JSON.parse(JSON.stringify(i))), s.disableNodeClickEffect && (s.defaultFocusRootNode = !1), wt(s.layouts[0]), Lt(s.layouts[0], s), s;
}, Lt = (n, s) => {
  ...
  const s = yo(n);
  return p("RGOptions:new RGOptions:by:", n), p("RGOptions:new RGOptions:", s), s.instanceId || (s.instanceId = `RGIns-${go++}`), s;
};
class vo {
  constructor(s, e) {
    k(this, "options");
    k(this, "listeners");
    k(this, "isReact", !1);
    k(this, "updateViewHook", () => {
    });
    this.listeners = e, this.options = bt(s), p("new RelationGraph:", this);
  }
  enableDebugLog(s) {
...
class xo extends _o {
  constructor(e, t) {
    ...
    k(this, "seeksNodeIdIndex", 0);
    k(this, "allLineColors", []);
    k(this, "userLayouerClass");
    k(this, "layouter");
    k(this, "reactiveData");
    k(this, "disableNextLayoutAnimation", !1);
    k(this, "elLineUpdating", !1);
  }
  setReactiveData(e, t) {
  ...
  _initLayoutByLayoutOptions(e) {
    this.options.layoutClassName = e.layoutClassName, this.options.layoutLabel = e.label, this.options.layoutName = e.layoutName, this.options.layoutDirection = e.layoutDirection, this.layouter = xt(e, this.options);
  }
  initLayouter() {
  ...
  loadNodes(e) {
    e.forEach((t) => {
      let o = this.graphData.nodes.find((i) => i.id === t.id);
      o || (o = Je(t), o && (o.seeks_id = this.seeksNodeIdIndex++, this.graphData.nodes.push(o)));
    });
  }
  loadLines(e) {
    e.forEach((t) => {
      let o = !1, i, a;
      if (typeof t.from == "object" ? i = t.from : i = this.graphData.nodes.find((m) => m.id === t.from), typeof t.to == "object" ? a = t.to : a = this.graphData.nodes.find((m) => m.id === t.to), !i) {
      ...
      const l = `${i.seeks_id}-${a.seeks_id}`, r = `${a.seeks_id}-${i.seeks_id}`, c = Ue(t);
      let h = this.graphData.links.find((m) => m.seeks_id === l), d = !1;
      h || (h = this.graphData.links.find((m) => m.seeks_id === r), h ? d = !0 : (o = !0, h = {
        seeks_id: l,
        fromNode: i,
        toNode: a,
        appended: !1,
  ...
  loadGraphJsonData(e) {
    ...
    this.flatNodeData(t, null, o, i), e.lines.forEach((a) => {
      i.push(a);
    }), this.loadNodes(o), p("Nodes is initialized"), this.loadLines(i), this._dataUpdated(), setTimeout(() => {
  ...
  getLineArrow(e, t = !1, o = !1) {
    ...
    if (e) {
      const a = no(e);
      return this.allLineColors.map((l) => l.id).includes(a) || this.allLineColors.push({ id: a, color: e }), `${this.options.instanceId}-${i}arrow-${a}`;
    } else
  ...
  getElementPosition(e) {
    const o = document.getElementById(e).getBoundingClientRect(), i = this.$canvasDom.getBoundingClientRect(), a = (o.x - i.x) / (this.options.canvasZoom / 100), l = (o.y - i.y) / (this.options.canvasZoom / 100);
    return { x: a, y: l };
  }
  removeNodeById(e) {
    let t = 0;
  ...
  setCanvasCenter(e, t) {
    ...
    this.setCanvasOffset(o - e + a.offset_x, i - t + a.offset_y);
  }
  setCanvasOffset(e, t) {
  ...
  getStuffSize(e) {
    ...
    let o = 9999999, i = 9999999, a = 0, l = 0;
    t.forEach((d) => {
      C.isAllowShowNode(d) && (d.x < o && (o = d.x), d.x > a && (a = d.x + d.el.offsetWidth), d.y < i && (i = d.y), d.y > l && (l = d.y + d.el.offsetHeight));
    });
    const r = 100, c = a - o + r, h = l - i + r;
    return {
      width: c,
      height: h,
      minX: o,
...
class wo extends xo {
  ...
  async createGraphCanvas(s = "png") {
    return new Promise((e, t) => {
      const o = this.options.canvasZoom, i = this.$canvasDom.clientWidth, a = this.$canvasDom.clientHeight, l = this.options.canvasOffset.x, r = this.options.canvasOffset.y;
      this.options.checkedNodeId = "", this.options.canvasZoom = 100;
      const c = this.$canvasDom;
      let h = 999999, d = 999999, f = 0, g = 0;
      const m = 200;
      this.loading("Generating..."), this.graphData.nodes.forEach((L) => {
        L.x < h && (h = L.x), L.x > f && (f = L.x + L.el.offsetWidth), L.y < d && (d = L.y), L.y > g && (g = L.y + L.el.offsetHeight);
      });
      const _ = h - m, x = d - m;
      this.graphData.nodes.forEach((L) => {
        L.x = L.x - _, L.y = L.y - x;
      }), this.$canvasDom.querySelectorAll(".rel-canvas-slot").forEach((L) => {
        const z = L;
        z.style.left = -x + "px", z.style.top = -x + "px";
      }), this.updateElementLines(), this.$canvasDom.querySelectorAll(".rel-lines-svg-el-lines").forEach((L) => {
        const z = L;
        z.style.width = "4000px", z.style.height = "4000px";
      }), this.options.canvasOffset.x = m * -1, this.options.canvasOffset.y = m * -1;
      const S = f - h + 200 + m * 2, b = g - d + 100 + m * 2, $ = window.devicePixelRatio;
      this.options.canvasSize.width = S * $, this.options.canvasSize.height = b * $, window.scrollTo(0, 0);
      const P = document.createElement("canvas");
      P.width = S * $, P.height = b * $, P.style.backgroundColor = getComputedStyle(c.parentElement, null).backgroundColor, p("canvas.style.backgroundColor:", P.style.backgroundColor), P.style.width = `${S * $}px`, P.style.height = `${b * $}px`, P.getContext("2d").scale(1, 1);
      const A = {
      ...
      setTimeout(() => {
        this.createImage(c, A, s, "", (L) => {
          this.options.canvasSize.width = i, this.options.canvasSize.height = a, this.options.canvasOffset.x = l, this.options.canvasOffset.y = r, this.options.canvasZoom = o, this.$canvasDom.querySelectorAll(".rel-canvas-slot").forEach((F) => {
            const U = F;
          ...
          }), this.updateElementLines(), this.clearLoading(), e(L);
        });
      }, 1e3);
    });
  }
  createImage(s, e, t, o, i) {
    p("createImage:", e), qt(s, e).then((a) => {
      i && i(a);
    });
  }
  ...
  async downloadImageAsFile(s, e, t) {
    ...
    try {
      window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveOrOpenBlob(i, `${t}.${e}`) : (a.setAttribute("href", URL.createObjectURL(i)), a.setAttribute("download", `${t}.${e}`), document.body.appendChild(a), a.click(), p("click ok!"), URL.revokeObjectURL(await i.text()), p("revokeObjectURL ok!"), document.body.removeChild(a), p("removeChild ok!"));
    } catch (l) {
      p("[SEEKS Graph]Create and download image error:", l);
    }
  }
}
class Co extends wo {
  ...
  _getJunctionPoint(s, e) {
    return s === ce.border ? te.getBorderPoint4MultiLine(...e) : s === ce.ltrb ? te.getRectJoinPoint(...e) : s === ce.tb ? te.getRectVJoinPoint(...e) : s === ce.lr ? te.getRectHJoinPoint(...e) : s === ce.left ? te.getRectLeftJoinPoint(...e) : s === ce.right ? te.getRectRightJoinPoint(...e) : s === ce.top ? te.getRectTopJoinPoint(...e) : s === ce.bottom ? te.getRectBottomJoinPoint(...e) : te.getBorderPoint4MultiLine(...e);
  }
  createLinePathByTwoNode(s, e, t, o = 0, i = 1) {
    ...
    let r = s.x, c = s.y, h = e.x, d = e.y;
    const f = { x: 0, y: 0, rotate: 0 };
    if (Number.isNaN(r) || Number.isNaN(c))
      return p("error start node:", s.text, s.x, s.y), f.x = 50, f.y = 50, f.rotate = 0, this.createReturnValue("M 0 0 L -10 -10", f);
    if (Number.isNaN(h) || Number.isNaN(d))
      return p("error end point:", e.text, e.x, e.y), f.x = 50, f.y = 50, f.rotate = 0, this.createReturnValue("M 0 0 L 10 -10", f);
    let g = s.el.offsetWidth || s.width || 60, m = s.el.offsetHeight || s.height || 60;
    if (Number.isNaN(g) || Number.isNaN(m))
      return f.x = 50, f.y = 50, f.rotate = 0, this.createReturnValue("M 0 0 L -10 10", f);
    let _ = e.el.offsetWidth || e.width || 60, x = e.el.offsetHeight || e.height || 60;
    if (Number.isNaN(_) || Number.isNaN(x))
      return f.x = 50, f.y = 50, f.rotate = 0, this.createReturnValue("M 0 0 L 10 10", f);
    t.isReverse && ([r, c, h, d, g, m, _, x] = [
      h,
      d,
      r,
      c,
    ...
    const D = [
      ...
      _,
      x,
      s.nodeShape || this.options.defaultNodeShape,
      t.isReverse,
      i,
      o
    ], R = [
      ...
      i,
      o
    ], S = this.options.defaultJunctionPoint || ce.border, b = t.fromJunctionPoint || s.junctionPoint || S, $ = t.toJunctionPoint || e.junctionPoint || S, P = this._getJunctionPoint(b, D), A = this._getJunctionPoint($, R);
    if (!P || !A)
      return this.createReturnValue(
        "Unable to calculate the starting point and ending point of the line.",
        f
      );
    const L = P.x, z = P.y, H = A.x, F = A.y;
    if (s === e) {
      const se = r + g / 2, M = c + m / 2, K = Math.atan2(z - M, L - se), V = Math.sin(K + Math.PI) * 5, Y = Math.cos(K + Math.PI) * 5, Q = { x: L - V, y: z - Y }, we = { x: L + V, y: z + Y }, Ae = L - Y * 5, Be = z - V * 5, Ce = L - Y * 5, Le = z - V * 5, ge = `M${Q.x},${Q.y} C${Ae},${Be} ${Ce},${Le} ${we.x},${we.y}`;
      return f.x = L - Y / (Y + V) * 20, f.y = z + V / (Y + V) * 20, f.rotate = 0, this.createReturnValue(ge, f);
    }
    if (Number.isNaN(L) || Number.isNaN(z))
      return p("error start point:", s.text), f.x = 50, f.y = 50, f.rotate = 0, this.createReturnValue("M 0 0 L -10 0", f);
    if (Number.isNaN(H) || Number.isNaN(F))
      return p("error end point:", e.text), f.x = 50, f.y = 50, f.rotate = 0, this.createReturnValue("M 0 0 L 10 0", f);
    const U = r + g / 2, oe = c + m / 2, E = h + _ / 2, N = d + x / 2, ae = this.createLinePathData(
      t,
      f,
      i,
      o,
    ...
    return this.createReturnValue(ae, f);
  }
  createLinePathData(s, e, t, o, i, a, l, r, c, h, d, f, g, m, _, x, D, R) {
    let S = g - l, b = m - r, $ = g > l ? 1 : -1, P = m > r ? 1 : -1, A = i === "v" ? P : $, L = "";
    if (a === 4) {
      const z = l - c, H = r - h, F = g - _, U = m - x;
      let oe = this.options.defaultPloyLineRadius || 0;
      const E = Math.min(oe, Math.abs(S)) * (l < g ? 1 : -1), N = Math.min(oe, Math.abs(b)) * (r < m ? 1 : -1), ae = Math.abs(z) >= d / 2 ? "h" : "v", se = Math.abs(F) >= D / 2 ? "h" : "v", M = [];
      if (ae === "v") {
        const K = s.polyLineStartDistance || Math.max(Math.min(30, Math.abs(m - r) / 2), 15), V = H > 0 ? K : -K;
        if (e.x = g, e.y = r + V + (H > 0 ? 20 : -5), M.push(`M ${l} ${r}`), M.push(`v${V - N}`), se === "v")
          M.push(`c${0},${N},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`h${g - l - E * 2}`), M.push(`c${E},${0},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`v${m - r - V - N}`);
        else {
          M.push(`c${0},${N},`), M.push(`${E},${N},`), M.push(`${E},${N}`);
          const Y = Math.min(30, Math.abs(g - l) / 2), Q = F > 0 ? -Y : Y;
          M.push(`h${g - l + Q - E}`), M.push(`c${E},${0},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`v${m - r - V - N}`), M.push(`h${Q - E}`);
        }
      } else {
        const K = s.polyLineStartDistance || Math.max(Math.min(30, Math.abs(g - l) / 2), 15), V = z > 0 ? K : -K;
        if (e.x = l + V + (z > 0 ? 20 : -50), e.y = m - 5, M.push(`M ${l} ${r}`), M.push(`h${V - E}`), se === "v") {
          const Y = Math.min(30, Math.abs(m - r) / 2), Q = U > 0 ? -Y : Y;
          M.push(`c${E},${0},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`v${m - r + Q - N}`), M.push(`h${g - l - V - E}`), M.push(`c${0},${N},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`v${Q - N}`);
        } else
          M.push(`c${E},${0},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`v${m - r - N * 2}`), M.push(`c${0},${N},`), M.push(`${E},${N},`), M.push(`${E},${N}`), M.push(`h${g - l - V - E}`);
      }
      L = M.join(" ");
    } else if (a === 2 || a === 3 || a === 5 || a === 6 || a === 7) {
      const z = l - c, H = r - h, F = g - _, U = m - x, oe = 1 / (t + 1) * (o + 1);
      let E, N;
      if (a === 2)
        E = i === "v" ? { x: 0, y: A * 30 } : { x: A * 30, y: 0 }, N = i === "v" ? { x: S * oe, y: A * -10 } : { x: A * -10, y: b * oe };
      else if (a === 3)
        E = i === "v" ? { x: 0, y: b * oe } : { x: A * 30, y: 0 }, N = i === "v" ? { x: 0, y: 0 } : { x: A * -10, y: b * oe };
      else if (a === 5)
        E = i === "v" ? { x: 0, y: 0 } : { x: 0, y: 0 }, N = i === "v" ? { x: 0, y: b * oe } : { x: S * oe, y: 0 };
      else if (a === 6) {
        const se = Math.min(200, Math.max(100, Math.abs(S / 2))), M = Math.min(200, Math.max(100, Math.abs(b / 2))), K = z / (Math.abs(z) + Math.abs(H)) * se, V = H / (Math.abs(z) + Math.abs(H)) * M;
        E = { x: K, y: V };
        const Y = F / (Math.abs(F) + Math.abs(U)) * se + S, Q = U / (Math.abs(F) + Math.abs(U)) * M + b;
        N = { x: Y, y: Q };
      } else if (a === 7) {
        const K = z / (Math.abs(z) + Math.abs(H)) * 30, V = H / (Math.abs(z) + Math.abs(H)) * 30;
        E = { x: K, y: V };
        const Y = F / (Math.abs(F) + Math.abs(U)) * 30 + S, Q = U / (Math.abs(F) + Math.abs(U)) * 30 + b;
        N = { x: Y, y: Q };
      }
      ...
      e.x = ae.x, e.y = ae.y, L = `M${l},${r} c${E.x},${E.y} ${N.x},${N.y} ${S},${b}`;
    } else
      e.rotate = te.getTextAngle(l, r, g, m), e.x = Math.round(l + (g - l) / 2), e.y = Math.round(r + (m - r) / 2), Number.isNaN(e.rotate) && (e.rotate = 0), L = `M ${l} ${r} L ${g} ${m}`;
    return L;
  }
  calcCurveCenter(s, e, t, o, i = 0.5) {
    const a = { x: (1 - i) * s.x + i * e.x, y: (1 - i) * s.y + i * e.y }, l = { x: (1 - i) * e.x + i * t.x, y: (1 - i) * e.y + i * t.y }, r = { x: (1 - i) * t.x + i * o.x, y: (1 - i) * t.y + i * o.y }, c = { x: (1 - i) * a.x + i * l.x, y: (1 - i) * a.y + i * l.y }, h = { x: (1 - i) * l.x + i * r.x, y: (1 - i) * l.y + i * r.y };
    return { x: (1 - i) * c.x + i * h.x, y: (1 - i) * c.y + i * h.y };
  }
  createCheckedLinePath() {
    ...
    if (!!s)
      try {
        ...
        if (!t) {
          p("Can not find link by checkedLineId:", s);
          return;
        }
        if (!C.isAllowShowNode(t.fromNode)) {
          p("from hide:", s);
          return;
        }
        if (!C.isAllowShowNode(t.toNode)) {
          p("to hide:", s);
          return;
        }
        const o = t.relations.findIndex((l) => l.id === s);
        if (o === -1) {
          p("Can not find checkedLineId:", s);
          return;
        }
...
class Lo extends Co {
  constructor(e, t) {
    super(e, t);
    k(this, "zoomCenter_of_newSize", { x: 0, y: 0 });
  }
  zoom(e, t) {
    this.options.canvasZoom + e < 10 && (p("zoom:reset zoom=10"), e = 10 - this.options.canvasZoom);
    const o = this.options.canvasZoom + e, i = this.showZoomCenter(t, e);
    this.options.canvasOffset.x += i.buff_x, this.options.canvasOffset.y += i.buff_y, this.options.canvasZoom = o, this.refreshNVAnalysisInfo(), this.listeners.onZoomEnd && this.listeners.onZoomEnd();
  }
  setZoom(e, t) {
  ...
  analysisByZoom(e, t) {
    ...
    o.NMCanvasCenter.x = this.options.canvasOffset.x + this.options.canvasSize.width / 2, o.NMCanvasCenter.y = this.options.canvasOffset.y + this.options.canvasSize.height / 2, o.NMCanvasStart.x = o.NMCanvasCenter.x - a / 2, o.NMCanvasStart.y = o.NMCanvasCenter.y - l / 2, o.NMCanvasEnd.x = o.NMCanvasCenter.x + a / 2, o.NMCanvasEnd.y = o.NMCanvasCenter.y + l / 2, o.NMZoomCenter.x = o.NMViewCenter.x, o.NMZoomCenter.y = o.NMViewCenter.y, t && (o.NMZoomCenter.x = t.x - o.NMViewPosition.x, o.NMZoomCenter.y = t.y - o.NMViewPosition.y);
    let r = o.NMViewCenter.x - o.NMCanvasCenter.x, c = o.NMViewCenter.y - o.NMCanvasCenter.y;
    return t && (r = o.NMZoomCenter.x - o.NMCanvasCenter.x, c = o.NMZoomCenter.y - o.NMCanvasCenter.y), o.NMViewBuff.x = r, o.NMViewBuff.y = c, o.NMCanvasSize.width = a, o.NMCanvasSize.height = l, o;
  }
  showZoomCenter(e, t) {
    if (!this.$dom)
      return { buff_x: 0, buff_y: 0 };
    const o = this.options.canvasZoom / 100, i = this.analysisByZoom(o, e), a = (this.options.canvasZoom + t) / 100, l = this.analysisByZoom(a, e), r = a / o, c = 0, h = 0, d = a / o, f = 0, g = 0;
    this.zoomCenter_of_newSize.x = r * i.NMViewBuff.x + h * i.NMViewBuff.y + f, this.zoomCenter_of_newSize.y = c * i.NMViewBuff.x + d * i.NMViewBuff.y + g;
    const m = i.NMViewBuff.x - this.zoomCenter_of_newSize.x, _ = i.NMViewBuff.y - this.zoomCenter_of_newSize.y;
    this.zoomCenter_of_newSize.x += i.NMCanvasCenter.x, this.zoomCenter_of_newSize.y += i.NMCanvasCenter.y;
    let x = i.NMCanvasStart.x - i.NMCanvasCenter.x, D = i.NMCanvasStart.y - i.NMCanvasCenter.y, R = r * x + h * D + f, S = c * x + d * D + g;
    return l.NMCanvasStart.x = m + i.NMCanvasCenter.x + R, l.NMCanvasStart.y = m + i.NMCanvasCenter.y + S, x = i.NMCanvasEnd.x - i.NMCanvasCenter.x, D = i.NMCanvasEnd.y - i.NMCanvasCenter.y, R = r * x + h * D + f, S = c * x + d * D + g, l.NMCanvasEnd.x = m + i.NMCanvasCenter.x + R, l.NMCanvasEnd.y = m + i.NMCanvasCenter.y + S, i.NMCanvasOffsetBuff.x = m, i.NMCanvasOffsetBuff.y = _, {
      buff_x: m,
      buff_y: _
    };
  }
...
class bo extends Lo {
  ...
  async doLayout() {
    ...
    this.options.showMaskWhenLayouting && this.loading(), await ut(200), this.options.showMaskWhenLayouting && this.clearLoading(), p("node size\uFF1A", this.graphData.nodes.length);
    const s = this.options.useAnimationWhenExpanded;
    this.disableNextLayoutAnimation && (this.options.useAnimationWhenExpanded = !1), this.layouter.requireLinks && this.layouter.setLinks(this.getLinks()), await this.layouter.placeNodes(this.graphData.nodes, this.graphData.rootNode), this.options.useAnimationWhenExpanded = s, this.disableNextLayoutAnimation = !1, this.updateElementLines(), this._dataUpdated();
  }
  async refresh(s = !0) {
    this.resetViewSize(), this.disableNextLayoutAnimation = !0, this._dataUpdated(), s && await this.doLayout(), p("placeOtherNodes"), await this.placeOtherNodes(), p("placeOtherNodes ok!"), await this.playShowEffect(), this.updateElementLines(), this._dataUpdated();
  }
  ...
  async moveToCenter() {
    if (this.options.useAnimationWhenRefresh) {
      ...
      const s = this.getNodesCenter();
      this.setCanvasCenter(s.x, s.y), this._dataUpdated();
    }
  }
  ...
  async placeOtherNodes() {
    ...
    }), this.options.placeSingleNode && this.options.layoutName !== "fixed" && this.placeSingleNodes(t), this.options.placeOtherGroup && this.options.layoutName !== "fixed" && (await this.placeOtherGroup(e, s), this._dataUpdated());
  }
  placeSingleNodes(s) {
    if (s.length > 0) {
      p("sigle nodes:", s.length);
      const e = new Se({ layoutName: "force" }, this.options);
  ...
  async placeOtherGroup(s, e) {
    if (s.length > 0) {
      p("[placeOtherGroup]notPlacedNodes nodes:", s.length);
      const t = JSON.parse(JSON.stringify(this.layouter.layoutOptions)), o = xt(t, this.options);
      o.isMainLayouer = !1;
      const i = s[0], a = this.getStuffSize(e);
      p("[placeOtherGroup]placeOtherGroup:", o.layoutOptions.layoutName, "root:", i.text);
      let l = o.layoutOptions.layoutName.includes("tree") ? 300 : 600;
      if (o.layoutOptions.layoutName === "force") {
        const h = o;
        h.force_node_repulsion = 0.2, h.force_line_elastic = 1.5, l = 100;
      }
      i.x = a.maxX + l, i.y = 0, o.layoutOptions.fixedRootNode = !0;
      const r = [];
      this.findGroupNodes(i, r), p("[placeOtherGroup]thisGroupNodes:", s.length), this.layouter.requireLinks && this.layouter.setLinks(this.getLinks()), await o.placeNodes(r, i), e.push(...r);
      const c = [];
      s.forEach((h) => {
        e.includes(h) || c.push(h);
      }), await this.placeOtherGroup(c, e), this._dataUpdated();
    }
  }
  async zoomToFit(s) {
    const e = this.getStuffSize(), t = this.options.viewSize.width / e.width, o = this.options.viewSize.height / e.height, i = Math.min(t, o, 1);
    p("zoomToFit:", { stuffSize: e, zoomPercent: i, zoomPercentX: t, zoomPercentY: o, viewSize: this.options.viewSize }), this.options.useAnimationWhenRefresh ? (await this.animateToZoom(i * 100, 300), this._dataUpdated(), s && s()) : (this.setZoom(i * 100), this._dataUpdated(), s && s());
  }
  async animateGoto(s, e, t) {
    return new Promise((o, i) => {
      p("animateGoto:", s, e);
      const a = s - this.options.canvasOffset.x, l = e - this.options.canvasOffset.y, r = t, c = 5, h = Math.round(a / c), d = Math.round(l / c), f = r / c;
      this.animateStepAction(0, f, c, () => {
  ...
  async animateToZoom(s, e) {
    return new Promise((t, o) => {
      const i = s - this.options.canvasZoom, a = e, l = 5, r = Math.round(i / l), c = a / l;
      p("animateToZoom:", i, r), this.animateStepAction(0, c, l, () => {
...
const mt = (n) => {
  ...
  startDrag(n, s, e, t) {
    t ? Ge = (o, i, a) => {
      const l = o - pe.x, r = i - pe.y;
      t(l, r, ue, pe, a);
    } : Ge = (o, i) => {
      de.x = ue.x + (o - pe.x), de.y = ue.y + (i - pe.y);
    }, Ye = e, de = s, ue.x = de.x, ue.y = de.y, p("[canvas]onDragStart...", fe(n), n);
    try {
      const o = mt(n);
      pe.x = o.clientX, pe.y = o.clientY, fe(n) ? (document.body.addEventListener("touchmove", ie.onNodeMove), document.body.addEventListener("touchend", ie.onNodeDragend), n.preventDefault()) : (document.body.addEventListener("mousemove", ie.onNodeMove), document.body.addEventListener("mouseup", ie.onNodeDragend));
    } catch (o) {
  ...
  onNodeMove(n) {
    const s = mt(n);
    Ge(s.clientX, s.clientY, n);
  },
  onNodeDragend(n) {
    fe(n) ? (document.body.removeEventListener("touchmove", ie.onNodeMove), document.body.removeEventListener("touchend", ie.onNodeDragend)) : (document.body.removeEventListener("mousemove", ie.onNodeMove), document.body.removeEventListener("mouseup", ie.onNodeDragend)), p("[canvas]onDragend...", fe(n), n), Ye && Ye(
      de.x - ue.x,
      de.y - ue.y,
      n
    );
...
class So extends bo {
  constructor(e, t) {
    super(e, t);
    k(this, "prevClickTime", 0);
    k(this, "movingListener");
    k(this, "step1EventTime", 0);
    k(this, "onCreateLineCallback");
  }
  ...
  onNodeClick(e, t) {
    ...
    p("[node]node click", e.text, this.options.creatingLinePlot), !t.shiftKey && this.options.disableNodeClickEffect !== !0 && e.disableDefaultClickEffect !== !0 && (this.options.checkedLinkId = "", this.options.checkedLineId = "", this.setCheckedNode(e.id)), this.listeners.onNodeClick && this.listeners.onNodeClick(e, t), this.prevClickTime = Date.now();
  }
  onLineClick(e, t, o) {
  ...
  startCreatingNodePlot(e, t) {
    this.options.newNodeTemplate = Je(JSON.parse(JSON.stringify(Ct))), this.options.creatingNodePlot = !0;
    const o = fe(e);
    this.options.showTemplateNode = !o;
    let i = (m, _) => {
      this.options.newNodeTemplate.x = m, this.options.newNodeTemplate.y = _, this._dataUpdated();
    }, a = (m, _) => {
      const x = "s-" + Date.now();
      this.addNodes([{
        id: x,
    ...
    t && t.templateText && (this.options.newNodeTemplate.text = t.templateText), t && t.templateStyleClass && (this.options.newNodeTemplate.styleClass = t.templateStyleClass), t && t.templateNode && Object.keys(t.templateNode).forEach((m) => {
      this.options.newNodeTemplate[m] = t.templateNode[m];
    ...
    const r = je(e), c = r.clientX - l.x + 10, h = r.clientY - l.y + 10;
    o || i(c, h);
    const d = (m) => {
      const _ = this.$dom.getBoundingClientRect();
      p("[CreatingNodePlot]objectTemplateMove");
      const x = m.clientX - _.x + 10, D = m.clientY - _.y + 10;
      i(x, D);
    }, f = (m) => {
      p("[CreatingNodePlot]user abort!"), this.$dom.removeEventListener("mousemove", d), this.$dom.removeEventListener("click", g), this.$dom.removeEventListener("contextmenu", f), this.options.creatingNodePlot = !1;
    }, g = (m) => {
      let _ = !1;
      if (this.options.creatingNodePlot || (_ = !0), this.$dom.removeEventListener("mousemove", d), this.$dom.removeEventListener("click", g), this.$dom.removeEventListener("contextmenu", f), this.options.creatingNodePlot = !1, _) {
        p("[CreatingNodePlot]action be abort!");
        return;
      }
      const x = je(m), D = x.clientX - l.x + 10, R = x.clientY - l.y + 10;
      if (t && t.disableClickCreate && Math.abs(c - D) < 5 && Math.abs(h - R) < 5) {
        p("[CreatingNodePlot]create node be abort!");
        return;
      }
      const S = this.getCanvasCoordinateByClientCoordinate({ x: x.clientX, y: x.clientY });
  ...
  isNode(e) {
    const t = Xe(e, "rel-node-peel", "rel-map");
    return t ? this.getNodeById(t.dataset.id) : void 0;
  }
  isLink(e) {
    const t = Xe(e, "rel-link-peel", "rel-map");
  ...
  fullscreen(e) {
    e === void 0 ? (this.options.fullscreen = !this.options.fullscreen, he.toggle(this.$dom).then(() => {
      setTimeout(() => {
  ...
  onLineDragStart(e, t) {
    p("onLineDragStart...");
    const o = { x: e.fromNode.x, y: e.fromNode.y }, i = { x: e.toNode.x, y: e.toNode.y }, a = (l, r, c, h, d) => {
      e.fromNode.x = o.x + l / (this.options.canvasZoom / 100), e.fromNode.y = o.y + r / (this.options.canvasZoom / 100), e.toNode.x = i.x + l / (this.options.canvasZoom / 100), e.toNode.y = i.y + r / (this.options.canvasZoom / 100), this._dataUpdated();
    };
    ie.startDrag(t, { x: 0, y: 0 }, (...l) => {
    ...
    if (fe(e)) {
      ...
      t = (a, l, r, c, h) => {
        ...
        if (d && d.length > 1) {
          ...
          const m = { x: f.clientX, y: f.clientY }, _ = { x: g.clientX, y: g.clientY }, x = Math.hypot(o.x - c.x, o.y - c.y), R = Math.hypot(_.x - m.x, _.y - m.y) / x, S = i * R;
          this.setZoom(S), this._dataUpdated();
        } else {
          const g = f.clientX, m = f.clientY;
          let _ = r.x + (g - c.x), x = r.y + (m - c.y);
          this.options.useHorizontalView ? (_ = r.x + (m - c.y), x = r.y - (g - c.x), this.setCanvasOffset(_, x)) : this.setCanvasOffset(_, x), this._dataUpdated();
        }
      };
    } else
      t = (o, i, a, l, r) => {
        const c = a.x + o, h = a.y + i;
  ...
  startCreateSelection(e) {
    let t = !1;
    const o = (i, a, l, r, c) => {
      if (!t && Math.abs(i) + Math.abs(a) > 6 && (t = !0, this.options.creatingSelection = !0, this.options.selectionView.x = r.x, this.options.selectionView.y = r.y), t) {
        const h = this.getBoundingClientRect();
        i < 0 ? (this.options.selectionView.x = r.x + i - h.x, this.options.selectionView.width = Math.abs(i)) : (this.options.selectionView.x = r.x - h.x, this.options.selectionView.width = i), a < 0 ? (this.options.selectionView.y = r.y + a - h.y, this.options.selectionView.height = Math.abs(a)) : (this.options.selectionView.y = r.y - h.y, this.options.selectionView.height = a);
      }
      this._dataUpdated();
    };
  ...
  onNodeDragStart(e, t) {
    ...
    const o = (i, a, l) => {
      e.dragging = !1, this.onNodeDraged(e, i, a, l), this._dataUpdated();
    };
    ie.startDrag(t, e, o, (i, a, l) => {
      let r = i / (this.options.canvasZoom / 100) + l.x, c = a / (this.options.canvasZoom / 100) + l.y;
      if (this.listeners.onNodeDragging) {
        const h = this.listeners.onNodeDragging(e, r, c, t);
        h && (typeof h.x == "number" && (r = h.x), typeof h.y == "number" && (c = h.y));
      }
      this.setNodePosition(e, r, c), this.options.useHorizontalView ? (r = a / (this.options.canvasZoom / 100) + l.x, c = -i / (this.options.canvasZoom / 100) + l.y, this.setNodePosition(e, r, c)) : this.setNodePosition(e, r, c), this.updateElementLines(), this._dataUpdated();
    });
  }
  onNodeDraged(e, t, o, i) {
    if (t === 0 && o === 0) {
      p("[node]node click by drag"), this.onNodeClick(e, i);
      return;
    }
    this.options.isMoveByParentNode && e.lot.childs.forEach((a) => {
      a.x += t, a.y += o;
    }), Math.abs(t) + Math.abs(o) > 6 ? (this.prevClickTime = Date.now(), setTimeout(() => {
      p("[node]onDragEnd2"), this.onNodeDragEnd(e, i);
    }, 100)) : (p("[node]onDragEnd1"), this.onNodeDragEnd(e, i));
  }
}
class ko extends So {
  constructor(s, e) {
  ...
  setLayouter(s) {
    p("setLayouterClass::", s), this.userLayouerClass = s, this.layouter = this.userLayouerClass;
  }
  async switchLayout(s, e = !0, t = !1) {
    ...
    p("[change layout]switchLayout"), this.stopAutoLayout(), Lt(s, this.options), this._initLayoutByLayoutOptions(s), this.layouter.allNodes = o, this.layouter.rootNode = i, e ? await this.refresh() : (t || (this.disableNextLayoutAnimation = !0), await this.doLayout());
  }
  async setJsonData(s, e = !1) {
    await this._setJsonData(s);
    const t = s.rootId;
  ...
  async appendJsonData(s, e = !0) {
    p("appendData:", s), this.loadGraphJsonData(s), e && (this.disableNextLayoutAnimation = !0, await this.doLayout());
  }
}
class Eo extends ko {
  constructor(s, e) {
...
(function(n) {
  ...
  s = function() {
    var h, d, f, g;
    (g = document.createElement("div")).innerHTML = l, l = null, (f = g.getElementsByTagName("svg")[0]) && (f.setAttribute("aria-hidden", "true"), f.style.position = "absolute", f.style.width = 0, f.style.height = 0, f.style.overflow = "hidden", h = f, (d = document.body).firstChild ? (g = h, (f = d.firstChild).parentNode.insertBefore(g, f)) : d.appendChild(h));
...
const gt = (n) => ({
  ...
  const n = J(ne), s = J(me), e = n.options, [t, o] = vt(!1), i = () => {
    o(!t);
  }, a = () => {
    n.printOptions();
  }, l = () => {
    ...
    n.enableDebugLog(!e.debug), p("debugLog:", e.debug), s();
  };
  return /* @__PURE__ */ Z("div", { children: [
    /* @__PURE__ */ y("div", { className: "c-setting-panel-button", onClick: () => {
      i();
    }, children: "Debug" }),
    t && /* @__PURE__ */ Z("div", { className: "c-setting-panel", children: [
      /* @__PURE__ */ y("div", { className: "c-debug-tools-row", children: /* @__PURE__ */ y("button", { onClick: () => {
        a();
  ...
  const n = J(ne), s = J(me), e = async () => {
    ...
    const c = n;
    await c.setZoom(100), await c.moveToCenter(), await c.zoomToFit(), s();
  }, l = (c) => {
    n.zoom(c), s();
  }, r = n && n.options;
  return /* @__PURE__ */ Z(
    "div",
    {
      ...
      children: [
        r.allowShowFullscreenMenu && /* @__PURE__ */ y("div", { title: "\u5168\u5C4F/\u9000\u51FA\u5168\u5C4F", className: "c-mb-button", onClick: () => {
          o();
        }, children: /* @__PURE__ */ y("svg", { className: "rg-icon", "aria-hidden": "true", children: /* @__PURE__ */ y("use", { xlinkHref: "#icon-resize-" }) }) }),
        r.allowShowZoomMenu && /* @__PURE__ */ Z(xe.Fragment, { children: [
          /* @__PURE__ */ y("div", { title: "\u653E\u5927", className: "c-mb-button", onClick: () => {
            l(20);
          }, children: /* @__PURE__ */ y("svg", { className: "rg-icon", "aria-hidden": "true", children: /* @__PURE__ */ y("use", { xlinkHref: "#icon-fangda" }) }) }),
          ...
          /* @__PURE__ */ y("div", { title: "\u7F29\u5C0F", className: "c-mb-button", onClick: () => {
            l(-20);
          }, children: /* @__PURE__ */ y("svg", { className: "rg-icon", "aria-hidden": "true", children: /* @__PURE__ */ y("use", { xlinkHref: "#icon-suoxiao" }) }) })
        ] }),
        r.allowAutoLayoutIfSupport && r.isNeedShowAutoLayoutButton && /* @__PURE__ */ y(
          "div",
          {
            ...
            children: r.autoLayouting ? /* @__PURE__ */ y("svg", { className: "c-loading-icon rg-icon", "aria-hidden": "true", children: /* @__PURE__ */ y("use", { xlinkHref: "#icon-lianjiezhong" }) }) : /* @__PURE__ */ y("svg", { className: "rg-icon", "aria-hidden": "true", children: /* @__PURE__ */ y("use", { xlinkHref: "#icon-zidong" }) })
          }
        ),
        r.allowShowRefreshButton && /* @__PURE__ */ y("div", { title: "\u5237\u65B0", className: "c-mb-button", onClick: () => {
          e();
        }, children: /* @__PURE__ */ y("svg", { className: "rg-icon", "aria-hidden": "true", children: /* @__PURE__ */ y("use", { xlinkHref: "#icon-ico_reset" }) }) }),
        r.allowShowDownloadButton && /* @__PURE__ */ y("div", { title: "\u4E0B\u8F7D\u56FE\u7247", className: "c-mb-button", onClick: () => {
          i();
        }, children: /* @__PURE__ */ y("svg", { className: "rg-icon", "aria-hidden": "true", children: /* @__PURE__ */ y("use", { xlinkHref: "#icon-tupian" }) }) }),
        /* @__PURE__ */ y("div", { style: { clear: "both" } })
      ]
    }
  );
}, No = () => /* @__PURE__ */ y("div", { className: "h-full bg-white", children: "not support" }), zo = ({ expandButtonClass: n, expandOrCollapseNode: s, expandHolderPosition: e, color: t }) => /* @__PURE__ */ y(
  "div",
  {
...
), St = ({ nodeProps: n, NodeSlot: s, ExpandHolderSlot: e }) => {
  var S;
  const t = J(ne), o = J(me), i = Xt((b) => {
    b !== null && a(b);
  }, []), a = (b) => {
    if (b.offsetWidth === 0 && b.offsetHeight === 0)
      return;
    const $ = b.offsetWidth, P = b.offsetHeight;
    (n.el.offsetWidth !== $ || n.el.offsetHeight !== P) && (t.updateNodeOffsetSize(n, $, P), o());
  }, l = async (b) => {
    await t.expandOrCollapseNode(n, b);
  }, r = (b) => {
    t.onNodeDragStart(n, b);
  }, c = (b) => {
    t.onNodeClick(n, b);
  }, h = t.options, d = n.width || h.defaultNodeWidth, f = n.height || h.defaultNodeHeight, g = `${n.borderColor || h.defaultNodeBorderColor} solid ${n.borderWidth === void 0 ? h.defaultNodeBorderWidth : n.borderWidth}px`, m = !(h.hideNodeContentByZoom === !0 && h.canvasZoom < 40), _ = n.opacity === void 0 ? 1 : n.opacity > 1 ? n.opacity / 100 : n.opacity, x = C.isAllowShowNode(n), D = n.expandHolderPosition && n.expandHolderPosition !== "hide" || h.defaultExpandHolderPosition && h.defaultExpandHolderPosition !== "hide" && n.lot.childs && n.lot.childs.length > 0, R = n.expanded === !1 ? "c-expanded" : "c-collapsed";
  return /* @__PURE__ */ Z(
    "div",
    {
      ref: i,
      ...
      className: `rel-node-peel ${n.selected ? "rel-node-selected" : ""} ${n.dragging ? "rel-node-dragging" : ""} ${n.id === h.checkedNodeId ? "rel-node-peel-checked" : ""} ${(S = n.className) != null ? S : n.className}`,
      "data-id": n.id,
      children: [
        D && (e ? /* @__PURE__ */ y(
          e,
        ...
        n.html ? /* @__PURE__ */ y(
          ...
          "div",
          {
            ...
            children: m && /* @__PURE__ */ y(Ne, { children: s ? /* @__PURE__ */ y(s, { node: n, relationGraph: t }) : /* @__PURE__ */ y(Ne, { children: n.innerHTML ? /* @__PURE__ */ y("div", { dangerouslySetInnerHTML: { __html: n.innerHTML } }) : /* @__PURE__ */ y(
              "div",
              {
                style: { color: n.fontColor || h.defaultNodeFontColor },
                className: "c-node-text",
                children: /* @__PURE__ */ y("span", { children: n.text })
              }
            ) }) })
          }
        )
...
}, Ze = ({ link: n, relation: s, relationIndex: e }) => {
  const t = J(ne), o = J(me), i = t.options, a = s.id === i.checkedLineId, l = s.showStartArrow ? t.getArrow(s, n, !0) : void 0, r = s.showEndArrow ? t.getArrow(s, n, !1) : void 0, c = () => {
    const { path: f, textPosition: g } = t.createLinePath(n, s, e);
    let m;
    try {
      m = t.getTextTransform(s, g.x, g.y, g.rotate);
    } catch (_) {
      p(_);
    }
    return {
  ...
  return /* @__PURE__ */ Z("g", { children: [
    /* @__PURE__ */ y(
      "path",
      {
        ...
        className: [
          "c-rg-line",
          s.styleClass,
          s.dashType ? "rg-line-dashtype-" + s.dashType : void 0,
          s.animation ? "rg-line-anm-" + s.animation : void 0,
          a ? "c-rg-line-checked" : void 0
        ].join(" "),
        stroke: s.color ? s.color : i.defaultLineColor,
        style: {
          opacity: s.opacity,
          strokeWidth: (s.lineWidth ? s.lineWidth : i.defaultLineWidth) + "px"
        },
        markerStart: l,
        markerEnd: r,
        fill: "none",
    ...
    i.defaultShowLineLabel && i.canvasZoom > 40 && /* @__PURE__ */ y("g", { transform: d.textTransform, children: /* @__PURE__ */ y(
      "text",
      {
        x: s.textOffset_x || i.defaultLineTextOffset_x || 0,
        y: s.textOffset_y || i.defaultLineTextOffset_y || 10,
        style: {
          opacity: s.opacity,
          fill: s.fontColor ? s.fontColor : i.defaultLineFontColor ? i.defaultLineFontColor : s.color ? s.color : i.defaultLineColor
        },
        textAnchor: "middle",
...
}, Do = ({ link: n, relation: s, relationIndex: e }) => {
  const t = J(ne), o = J(me), i = t.options, a = `translate(${s.textOffset_x || i.defaultLineTextOffset_x || 0},${s.textOffset_y || i.defaultLineTextOffset_y || -8})`, l = `#${i.instanceId}-${n.seeks_id}-${e}`, r = s.id === i.checkedLineId, c = s.lineShape === 4 || i.defaultLineShape === 4 ? "start" : "middle", h = s.lineShape === 4 || i.defaultLineShape === 4 ? i.layoutDirection === "v" ? Math.abs(n.toNode.x - n.fromNode.x) + 43 : Math.abs(n.toNode.y - n.fromNode.y) + 43 : "50%", d = (f) => {
    t.onLineClick(s, n, f), o();
  };
  return /* @__PURE__ */ Z("g", { children: [
    /* @__PURE__ */ y(
    ...
    /* @__PURE__ */ y("g", { transform: a, children: /* @__PURE__ */ y(
      "text",
      {
        className: `c-rg-line-text ${r && "c-rg-line-text-checked"}`,
        style: {
          opacity: s.opacity,
          fill: s.fontColor || i.defaultLineFontColor || s.color || i.defaultLineColor
        },
        onTouchStart: (f) => d(f),
        onClick: (f) => d(f),
        children: /* @__PURE__ */ y("textPath", { xlinkHref: l, startOffset: h, textAnchor: c, method: "align", spacing: "auto", children: s.text })
      }
    ) })
  ] });
}, To = ({ linkProps: n, LineSlot: s }) => {
  const e = J(ne), t = (i) => C.isAllowShowNode(i);
  ze(() => {
  }, []);
  const o = e.options;
  return /* @__PURE__ */ y(
    "g",
    {
      ...
      children: n.relations.map(
        (i, a) => /* @__PURE__ */ y(xe.Fragment, { children: s ? /* @__PURE__ */ y(s, { relationGraph: e, link: n, relation: i, relationIndex: a }) : i.useTextPath || o.lineUseTextPath ? /* @__PURE__ */ y(Do, { link: n, relation: i, relationIndex: a }) : /* @__PURE__ */ y(Ze, { link: n, relation: i, relationIndex: a }) }, i.id)
      )
    }
  );
}, Ao = ({ link: n, relation: s, relationIndex: e }) => {
  const t = J(ne), o = t.options, i = s.id === o.checkedLineId, a = () => {
    const { path: c } = t.createLinePath(
      n,
      s,
      e
    );
    return c;
  }, l = s.showStartArrow ? t.getArrow(s, n, !0) : void 0, r = s.showEndArrow ? t.getArrow(s, n, !1) : void 0;
  return /* @__PURE__ */ y(
    "path",
    {
      id: `${o.instanceId}-${n.seeks_id}-${e}`,
      d: a(),
      stroke: s.color ? s.color : o.defaultLineColor,
      style: {
        opacity: s.opacity,
        strokeWidth: `${s.lineWidth ? s.lineWidth : o.defaultLineWidth}px`
      },
      markerStart: l,
      markerEnd: r,
      className: `c-rg-line-path ${s.styleClass} ${i ? "c-rg-line-checked" : ""}`,
      fill: "none"
    }
  );
}, Bo = () => {
  const n = J(ne), s = n.createCheckedLinePath(), e = n.createCheckedLineStrokeWidth();
  return /* @__PURE__ */ y("g", { children: s && /* @__PURE__ */ y(
    "path",
    {
      d: s,
      fill: "none",
  ...
  }, o = s.options, i = s.allLineColors, a = s.graphData.nodes, l = s.graphData.links, r = s.graphData.elementLines;
  return /* @__PURE__ */ Z("div", { children: [
    /* @__PURE__ */ y("div", { ref: e, className: "rel-linediv", children: /* @__PURE__ */ Z(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ Z("defs", { children: [
            /* @__PURE__ */ Z(
              "linearGradient",
              {
                ...
                y2: "0",
                children: [
                  /* @__PURE__ */ y("stop", { offset: "0%", stopColor: "#e52c5c" }),
                  /* @__PURE__ */ y("stop", { offset: "100%", stopColor: "#FD8B37" })
                ]
              }
            ),
            /* @__PURE__ */ y(
            ...
            i.map((c) => /* @__PURE__ */ y(
              "marker",
              {
                ...
                children: /* @__PURE__ */ y(
                  "path",
                  {
                    fill: o.defaultLineMarker.color || c.color,
                    d: o.defaultLineMarker.data
                  }
                )
              },
            ...
            i.map(
              (c) => /* @__PURE__ */ y(
                "marker",
                {
                  id: `${o.instanceId}-start-arrow-${c.id}`,
                  markerWidth: o.defaultLineMarker.markerWidth,
                  markerHeight: o.defaultLineMarker.markerHeight,
                  refX: o.defaultLineMarker.refX,
                  refY: o.defaultLineMarker.refY,
            ...
            l.map(
              (c) => /* @__PURE__ */ y(xe.Fragment, { children: c.relations.filter((h) => o.lineUseTextPath || h.useTextPath).map(
                (h, d) => /* @__PURE__ */ y(
                  Ao,
                  {
                    link: c,
          ...
          o.creatingLinePlot && o.newLinkTemplate.fromNode && /* @__PURE__ */ y(Ze, { link: o.newLinkTemplate, relation: o.newLineTemplate, relationIndex: 0 })
        ]
      }
    ) }),
    /* @__PURE__ */ y("div", { className: "rel-nodediv rel-nodediv-for-webkit", children: a.map(
      (c) => /* @__PURE__ */ y(
        St,
        {
          nodeProps: c,
    ...
    /* @__PURE__ */ y("div", { className: "rel-linediv rel-linediv-el-lines", children: /* @__PURE__ */ y(
      "svg",
      {
        className: "rrel-lines-svg rel-lines-svg-el-lines",
        xmlns: "http://www.w3.org/2000/svg",
        children: r.map(
          (c) => c.relations[0].isHide === !1 && /* @__PURE__ */ y(Ze, { link: c, relation: c.relations[0], relationIndex: 0 }, "ell-" + c.relations[0].id)
        )
      }
    ) })
  ] });
  ...
  J(me);
  const e = Oe(), o = (() => ({
    width: `${s.options.canvasSize.width}px`,
    height: `${s.options.canvasSize.height}px`,
    marginLeft: `${s.options.canvasOffset.x}px`,
    marginTop: `${s.options.canvasOffset.y}px`,
    backgroundColor: "transparent",
    transform: `scale(${s.options.canvasZoom / 100},${s.options.canvasZoom / 100})`
  }))();
  ze(() => {
    console.log("[debug][RelationGraph-canvas] ready!"), p("[RGCanvas mounted]"), s.setCanvasDom(e.current);
  }, []);
  const i = (l) => {
    s.onCanvasDragStart(l);
  }, a = (l) => {
    l.preventDefault(), s.onContextmenu(l);
  };
  return /* @__PURE__ */ y(
    "div",
    {
      style: {
        width: "100%",
        height: "100%",
        backgroundImage: `url(${s.options.backgroundImage})`,
        backgroundColor: s.options.backgroundColor
      },
      className: [
        "rel-map",
        s.options.layoutClassName,
        s.options.backgroundImageNoRepeat ? "rel-map-background-norepeat" : ""
      ].join(" "),
      ...
      children: /* @__PURE__ */ Z(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ y("div", { className: "rel-canvas-slot rel-canvas-slot-behind", children: n.canvasPlugSlot && /* @__PURE__ */ y(n.canvasPlugSlot, { relationGraph: s }) }),
            /* @__PURE__ */ y(Ro, { nodeSlot: n.nodeSlot, lineSlot: n.lineSlot, expandHolderSlot: n.expandHolderSlot }),
            /* @__PURE__ */ y("div", { className: "rel-canvas-slot rel-canvas-slot-above", children: n.canvasPlugAboveSlot })
          ]
        }
      )
    }
  ...
  const s = J(ne), e = s && s.options;
  return e && (e.creatingNodePlot || e.creatingSelection) ? /* @__PURE__ */ y("div", { className: "rel-operate", children: /* @__PURE__ */ Z("div", { style: { position: "relative" }, children: [
    e.creatingNodePlot && e.showTemplateNode && /* @__PURE__ */ y(
      St,
      {
    ...
    e.creatingSelection && /* @__PURE__ */ y(
      "div",
      {
  ...
  const n = J(ne), s = n && n.options, e = (t) => {
    n.clickGraphMask(t);
  };
  return /* @__PURE__ */ y(Ne, { children: s && /* @__PURE__ */ y(
    "div",
    {
      className: `rel-graph-loading ${s.graphLoading ? "" : "rel-graph-loading-hide"}`,
      onClick: (t) => {
        e(t);
      },
      children: /* @__PURE__ */ Z("div", { className: "rel-graph-loading-message", children: [
        /* @__PURE__ */ y("svg", { className: "c-graph-loading-icon", "aria-hidden": "true", children: /* @__PURE__ */ y("use", { xlinkHref: "#icon-lianjiezhong" }) }),
        "Loading..."
      ] })
    }
  ) });
}, Wo = (n, s) => {
  const [e, t] = vt({ instance: null }), o = Oe(), i = Oe();
  ze(() => {
    console.log("[debug][RelationGraph] ready!"), io("react");
    const h = n.relationGraphCore ? new n.relationGraphCore(n.options, gt(n)) : new Eo(n.options, gt(n));
    return i.current = h, h.setUpdateViewHook(a), p("setDom:", o.current), h.setDom(o.current), h.ready(), a(), he && he.on && he.on("change", l), o.current && o.current.addEventListener("wheel", r, { passive: !1, capture: !0 }), () => {
      o.current && o.current.removeEventListener("wheel", r), he && he.off && he.off("change", l);
    };
  }, []), Ut(s, () => ({
    getInstance() {
      return i.current;
  ...
  const l = () => {
    i.current.fullscreen(he.isFullscreen);
  }, r = (h) => {
    i.current.onMouseWheel(h), a();
  }, c = e && e.instance && e.instance.options;
  return /* @__PURE__ */ y(Ne, { children: /* @__PURE__ */ y(eo, { value: i.current, children: /* @__PURE__ */ y(to, { value: a, children: /* @__PURE__ */ Z(
    "div",
    {
      ref: o,
      ...
      children: [
        c && c.showDebugPanel && /* @__PURE__ */ y(Mo, {}),
        c && c.allowShowMiniToolBar === !0 && (n.toolBarSlot ? /* @__PURE__ */ y(n.toolBarSlot, { relationGraph: e.instance }) : /* @__PURE__ */ y(Oo, {})),
        c && c.allowShowMiniView === !0 && (n.miniViewSlot ? /* @__PURE__ */ y(n.miniViewSlot, { relationGraph: e.instance }) : /* @__PURE__ */ y(No, {})),
        c && (n.graphPlugSlot ? /* @__PURE__ */ y(n.graphPlugSlot, { relationGraph: e.instance }) : /* @__PURE__ */ y("div", { className: "rel-graph-plug" })),
        c && /* @__PURE__ */ y(
          Po,
          {
            nodeSlot: n.nodeSlot,
        ...
        /* @__PURE__ */ y($o, { nodeSlot: n.nodeSlot }),
        /* @__PURE__ */ y(Io, {})
      ]
    }
  ) }) }) });
