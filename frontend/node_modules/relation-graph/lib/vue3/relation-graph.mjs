...
const jt = "2.1.23", mn = Symbol("INSTALLED_KEY"), st = "graphInstance", Zt = "graphData", Q = "graph", me = !function(i) {
  ...
  n = function() {
    var d, f, h, m;
    (m = document.createElement("div")).innerHTML = c, c = null, (h = m.getElementsByTagName("svg")[0]) && (h.setAttribute("aria-hidden", "true"), h.style.position = "absolute", h.style.width = 0, h.style.height = 0, h.style.overflow = "hidden", d = h, (f = document.body).firstChild ? (m = d, (h = f.firstChild).parentNode.insertBefore(m, h)) : f.appendChild(d));
  }, document.addEventListener ? ~["complete", "loaded", "interactive"].indexOf(document.readyState) ? setTimeout(n, 0) : (t = function() {
    document.removeEventListener("DOMContentLoaded", t, !1), n();
  }, document.addEventListener("DOMContentLoaded", t, !1)) : document.attachEvent && (e = n, o = i.document, s = !1, (a = function() {
    try {
...
}(window), ge = me, ve = (i) => (i = i.replace("#", ""), i = i.replace("(", ""), i = i.replace(")", ""), i = i.replace(/,/, "-"), i), ut = (i) => {
  try {
...
}, Dt = (i, n, t) => i ? i.classList.contains(n) ? i : i.classList.contains(t) ? null : Dt(i.parentElement, n, t) : null, Ft = async (i) => new Promise((n, t) => {
  setTimeout(() => {
    n();
  }, i);
}), X = (i) => typeof i == "string" ? Number.parseInt(i) : i, _e = (i) => {
  console.log(
    `%c relation-graph${i ? "" : "/" + i} %c Version v${jt} %c More info: https://github.com/seeksdream/relation-graph %c`,
  ...
  return Object.keys(i).forEach((t) => {
    xe.includes(t) || i[t] !== void 0 && (n[t] = i[t]);
  }), n;
}, Le = {
  json2Node: Ct,
  transNodeToJson: Tt
  ...
  const n = {
    ...
    force_elastic: i.force_elastic,
    polyLineStartDistance: i.polyLineStartDistance,
...
}, Ce = ["arrow", "id", "reverseText", "isReverse"], $t = (i, n) => {
  !i || i.relations.forEach((t) => {
    const e = {};
    Object.keys(t).forEach((o) => {
      Ce.includes(o) || t[o] !== void 0 && (e[o] = t[o]);
    }), n.push(e);
  });
}, at = {
  border: "border",
  ...
  json2Line: Lt,
  transLinkToJson: $t,
  JUNCTION_POINT_STYLE: at,
  default: ke
}, Symbol.toStringTag, { value: "Module" })), _ = {
  analysisNodes(i, n, t, e) {
    n.length > e.max_length && (e.max_length = n.length), t > e.max_deep && (e.max_deep = t);
    const o = {
      level: t,
      all_size: n.length,
      all_strength: 0
    ...
    }), o.all_strength > e.max_strength && (e.max_strength = o.all_strength), s.length > 0 && _.analysisNodes(i, s, t + 1, e);
  },
  analysisNodes4Didirectional(i, n, t, e, o) {
    n.length > e.max_length && (e.max_length = n.length), t > e.max_deep && (e.max_deep = t);
    const s = {
      level: t,
      all_size: n.length,
    ...
    n.forEach((l) => {
      l.lot || (l.lot = { childs: [] }), l.lot.eached = !0, l.lot.subling = s, l.lot.level = t, i.push(l);
    });
    let c = 0;
    n.forEach((l) => {
      let r = 0;
      if (o === 0) {
        ...
        l.targetNodes.forEach((f) => {
          f.lot || (f.lot = { eached: !1, childs: [] }), f.lot.eached || (_.isAllowShowNode(f) ? (f.lot.eached = !0, f.lot.parent = l, f.lot.index_of_parent = d++, l.lot.childs.push(f), a.push(f), r++) : l.lot.childs.push(f));
        });
      } else if (o === -1) {
        let d = 0;
    ...
    }), s.all_strength > e.max_strength && (e.max_strength = s.all_strength), a.length > 0 ? _.analysisNodes4Didirectional(i, a, t + (o === -1 ? -1 : 1), e, o) : (i.forEach((l) => {
  ...
  analysisDataTree(i, n, t) {
    ...
    }), e.length > 0 && _.analysisDataTree(e, n + t, t);
  },
  ...
  getNodeXByCenterX(i, n, t) {
    return n.alignItems === "right" ? t - _.getNodeWidth(n, i) : n.alignItems === "left" ? t : t - _.getNodeWidth(n, i) / 2;
  },
  getNodeYByCenterY(i, n, t) {
    return n.alignItems === "top" ? t : n.alignItems === "bottom" ? t - _.getNodeHeight(n, i) : t - _.getNodeHeight(n, i) / 2;
  },
  getCenterXByNodeX(i, n, t) {
    return t + _.getNodeHeight(n, i) / 2;
  },
  getCenterYByNodeY(i, n, t) {
    return t + _.getNodeHeight(n, i) / 2;
  },
  getLotXByNodeX(i, n) {
    const t = n.offset_x || 0;
    return this.getCenterXByNodeX(i, n, n.x || 0) - t;
  },
  getLotYByNodeY(i, n) {
    const t = n.offset_y || 0;
    return this.getCenterYByNodeY(i, n, n.y || 0) - t;
  },
  isRectangleOverlap(i, n) {
    const t = i.x + I, e = n.x + I, o = i.el.offsetWidth - I * 2, s = n.el.offsetWidth - I * 2, a = i.y + I, c = n.y + I, l = i.el.offsetHeight - I * 2, r = n.el.offsetHeight - I * 2;
    return !(e >= t + o || e + s <= t || c >= a + l || c + r <= a);
  },
  isXOverlap(i, n, t, e) {
    return !(n >= i + t || n + e <= i);
  },
  ...
  shapesOverlap(i, n, t = 1, e = 1) {
    return this.isRectangleOverlap(i, n);
  },
  getNoOverlapLimitedPosition(i, n, t, e) {
    const o = i.x + I, s = i.y + I, a = n + I, c = e.x + I, l = i.el.offsetWidth - I * 2, r = e.el.offsetWidth - I * 2, d = t + I, f = e.y + I, h = i.el.offsetHeight - I * 2, m = e.el.offsetHeight - I * 2;
    let y = i.x, v = i.y;
    const g = this.isXOverlap(o, c, l, r), b = this.isYOverlap(s, f, h, m);
    return g ? d < f ? (y = n, v = f - h - I) : d > f && (y = n, v = f + m - I) : b && (a < c ? (y = c - l - I, v = t) : a > c && (y = c + r - I, v = t)), { x: y, y: v };
  },
  flatNodeData(i, n, t, e) {
    i.forEach((o) => {
      t.push(o), n && e.push({
        from: n.id,
        to: o.id
      });
      const s = o.childs || o.children;
      s && s.length > 0 && this.flatNodeData(s, o, t, e);
    });
  }
}, I = 8, it = _, Me = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  RGNodesAnalytic: _,
  default: it
...
class Se {
  constructor(n, t) {
    ...
    this.layoutOptions = n, this.graphOptions = t;
  }
  setLinks(n) {
  ...
  placeNodes(n, t) {
    this.allNodes = n, this.rootNode = t;
  }
  snapshotBeforeAnimation() {
    this.allNodes.forEach((n) => {
      !it.isAllowShowNode(n) || (n.lot.to_x = it.getNodeXByLotX(this.graphOptions, n), n.lot.to_y = it.getNodeYByLotY(this.graphOptions, n), n.lot.from_x = n.x || 0, n.lot.from_y = n.y || 0, n.lot.placed = !0);
    });
  }
  async animationLayout(n = !0) {
    ...
    return new Promise((o, s) => {
      this.playAnimation(() => {
        e || (e = !0, u("[LayoutAnimationEffect]played!"), this.allNodes.forEach((a) => {
          !it.isAllowShowNode(a) || (a.lot.from_x = a.x, a.lot.from_y = a.y, a.x = a.lot.to_x, a.y = a.lot.to_y);
        }), o());
      });
    });
  }
  playAnimation(n) {
    ...
    this.allNodes.forEach((t) => {
      if (!t.lot.placed)
        return;
      const { from_x: e, from_y: o, to_x: s, to_y: a } = t.lot;
      if (e !== void 0 && o !== void 0 && s !== void 0 && a !== void 0) {
        const c = (s - e) / this.allAnimationStep, l = (a - o) / this.allAnimationStep, r = Math.floor(e + this.currentAnimationStep * c), d = Math.floor(o + this.currentAnimationStep * l);
        (t.x !== r || t.y !== d) && (t.x = r, t.y = d);
      }
...
class Oe extends kt {
  ...
  analysisNodes4Didirectional(t, e, o, s, a) {
    u(`${a} level ${o} size: ${e.length}`), e.length > s.max_length && (s.max_length = e.length), o > s.max_deep && (s.max_deep = o);
    const c = {
      level: o,
      all_size: e.length,
      all_strength: 0
    ...
    e.forEach((d) => {
      d.lot || (d.lot = { childs: [] }), d.lot.eached = !0, d.lot.subling = c, d.lot.level = o, t.push(d);
    });
    let r = 0;
    e.forEach((d) => {
      let f = 0, h = a === -1 ? d.targetFrom : d.targetTo;
      o !== 0 && (h = d.targetNodes);
      let m = 0;
      h.forEach((y) => {
        y.lot || (y.lot = { eached: !1, childs: [] }), y.lot.eached || (y.lot.parent = d, _.isAllowShowNode(y) ? (y.lot.eached = !0, y.lot.index_of_parent = m++, d.lot.childs.push(y), l.push(y), f++) : d.lot.childs.push(y));
      }), d.lot.strength = f > 0 ? f : 1, c.all_strength += d.lot.strength, d.lot.strength_plus = c.all_strength, d.lot.index_of_level = r, d.lot.childs_size = f, r++;
    }), c.all_strength > s.max_strength && (s.max_strength = c.all_strength), l.length > 0 ? this.analysisNodes4Didirectional(t, l, o + a, s, a) : (t.forEach((d) => {
      d.lot.childs_size > 0 && (d.lot.strengthWithChilds = 0);
    }), t.forEach((d) => {
      d.lot.childs_size === 0 && (d.lot.strengthWithChilds = 1, _.conductStrengthToParents(d));
    }), _.analysisDataTree([t[0]], 0, a));
  }
  async placeNodes(t, e) {
    if (u("SeeksBidirectionalTreeLayouter:placeNodes"), e)
      u("layout by root:", e);
    else {
      console.error("root is null");
      return;
    }
    this.rootNode = e, this.allNodes = t, u("allNodes:", t.length), t.forEach((a) => {
    ...
    _.analysisNodes(o, [this.rootNode], 0, s), o = [], s = {
      ...
      max_length: 1,
      max_strength: 1
    }, this.analysisNodes4Didirectional(o, [this.rootNode], 0, s, 1), this.placeNodesPosition(this.rootNode, o, s), u("allNodes:", o.length), this.graphOptions.useAnimationWhenExpanded ? (u("Play layout animation....."), await this.animationLayout(), u("create rootNode coordinates:3", e.x, e.y)) : (this.allNodes.forEach((a) => {
      if (a.fixed === !0) {
        a.lot.placed = !0;
        return;
      }
  ...
  placeRelativePosition(t, e, o) {
    ...
    if (this.layoutOptions.from === "left" || this.layoutOptions.from === "right") {
      ...
      let d = Math.round((s.width - 10) / (o.max_strength + 2));
      d < l && (d = l), d > r && (d = r);
      let f = Math.round((s.height - 10) / (o.max_deep + 2));
      f < a && (f = a), f > c && (f = c), e.forEach((h) => {
        h.fixed !== !0 && h.lot.placed !== !0 && h !== t && (this.layoutOptions.from === "bottom" ? h.lot.y = t.lot.y - this.getLevelDistance(h, h.lot.subling.level, f) : h.lot.y = t.lot.y + this.getLevelDistance(h, h.lot.subling.level, f));
      }), e.forEach((h) => {
        h.fixed !== !0 && h.lot.level !== 0 && (this.layoutOptions.layoutExpansionDirection === "left" || this.layoutOptions.layoutExpansionDirection === "top" ? h.lot.x = t.lot.x - d * h.lot.strengthWithChilds_from : this.layoutOptions.layoutExpansionDirection === "right" || this.layoutOptions.layoutExpansionDirection === "bottom" ? h.lot.x = t.lot.x + d * h.lot.strengthWithChilds_from : h.lot.x = t.lot.x + d * (o.max_strength / -2 + h.lot.strengthWithChilds_from + h.lot.strengthWithChilds / 2));
      }), this.gatherNodes(e, "v", d);
    }
  }
  gatherNodes(t, e, o) {
    ...
    t.forEach((a) => {
      ...
      if (a.fixed !== !0 && a.lot.level !== 0) {
        ...
        if (a.lot.strengthWithChilds === 1 && a.lot.childs_size <= 1) {
          const r = this.getBloomingNearByParent(a, a.lot.parent, l, e);
          r && (e === "h" ? a.lot.y - r.lot.y > 0 ? (a.lot.y = r.lot.y + o * r.lot.movedNodeSizeAfter, r.lot.movedNodeSizeAfter++) : (a.lot.y = r.lot.y - o * r.lot.movedNodeSizeBefore, r.lot.movedNodeSizeBefore++) : a.lot.x - r.lot.x > 0 ? (a.lot.x = r.lot.x + o * r.lot.movedNodeSizeAfter, r.lot.movedNodeSizeAfter++) : (a.lot.x = r.lot.x - o * r.lot.movedNodeSizeBefore, r.lot.movedNodeSizeBefore++));
        }
      }
    });
  }
  getBloomingNearByParent(t, e, o, s) {
    let a = 9999, c;
    for (const l of o)
      if (l.lot.childs_size > 1 && l.lot.parent === e) {
        const r = s === "h" ? l.lot.y - e.lot.y : l.lot.x - e.lot.x;
...
const Jt = Oe, Vt = 0;
function Ee(i, n, t, e, o, s, a, c, l) {
  const r = o - i, d = s - n, f = Math.sqrt(r * r + d * d), h = l * d / f, m = -(l * r) / f, y = i + h, v = n + m, g = i - t / 2, b = i + t / 2, z = n - e / 2, S = n + e / 2;
  let B = [];
  if (r !== 0) {
    let D = (g - y) / r, C = v + D * d;
    C >= z && C <= S && B.push({ x: g, y: C });
    let N = (b - y) / r, T = v + N * d;
    T >= z && T <= S && B.push({ x: b, y: T });
  }
  if (d !== 0) {
    let D = (z - v) / d, C = y + D * r;
    C >= g && C <= b && B.push({ x: C, y: z });
    let N = (S - v) / d, T = y + N * r;
    T >= g && T <= b && B.push({ x: T, y: S });
  }
  let W = null, A = 1 / 0;
  return B.forEach((D) => {
    const C = Math.sqrt((D.x - o) ** 2 + (D.y - s) ** 2);
    C < A && (A = C, W = D);
  }), W;
}
const qt = {
  getRectPoint(i, n, t, e, o, s, a, c, l = !1, r = 1, d = 1) {
    l && (d = r - d - 1);
    const f = d - (r - 1) / 2, h = i + o / 2, m = n + s / 2, y = t + a / 2, v = e + c / 2;
    if (r > 1) {
      const C = 14 * f, N = Ee(
        h,
        m,
    ...
    const g = h < y ? 1 : -1, b = m < v ? 1 : -1;
    if (v === m)
      return { x: h + g * o / 2, y: m };
    const z = Math.abs((y - h) / (v - m)), S = o / s;
    let B = 0, W = 0;
    z < S ? (B = g * s / 2 * z + b * S, W = b * s / 2) : (B = g * o / 2, W = b * o / 2 / z + g * S);
    const A = h + B, D = m + W;
    return { x: A, y: D };
  },
  getRectPointBasic(i, n, t, e, o, s, a, c) {
    const l = i + o / 2, r = n + s / 2, d = t + a / 2, f = e + c / 2;
    let h = f === r ? 0 : (d - l) / (f - r);
    h === 0 && (h = (d - l) / (f - r + 1));
    const m = o / c;
    let y = 0, v = 0, g = "1";
    return -1 * m < h && h < m ? (g = "2", r < f ? (y = s / 2 * h, v = s / 2) : (y = -1 * s / 2 * h, v = -1 * s / 2)) : (l < d ? (y = 1 * o / 2, v = 1 * o / 2 / h) : (y = -1 * o / 2, v = -1 * o / 2 / h), g = "3"), { x: l + y, y: r + v, _case: g };
  },
  getRectJoinPoint(i, n, t, e, o, s, a, c) {
    const l = i + o / 2, r = n + s / 2, d = t + a / 2, f = e + c / 2, h = Math.round(Math.atan2(f - r, d - l) * 180 / 3.14) + 135;
    return h >= 0 && h < 90 ? { x: i + o / 2, y: n - 5 } : h >= 90 && h < 180 ? { x: i + o + 5, y: n + s / 2 } : h >= 180 && h < 270 ? { x: i + o / 2, y: n + s + 5 } : { x: i - 5, y: n + s / 2 };
  },
  getRectHJoinPoint(i, n, t, e, o, s, a) {
    const c = s / 2;
    return i + o < t ? { x: i + o + 5, y: n + c } : i + o < t + a ? { x: i - 5, y: n + c } : { x: i - 5, y: n + c };
  },
  getRectLeftJoinPoint(i, n, t, e, o, s, a) {
    const c = s / 2;
    return { x: i - 5, y: n + c };
  },
  getRectRightJoinPoint(i, n, t, e, o, s, a) {
    const c = s / 2;
    return { x: i + o + 5, y: n + c };
  },
  getRectTopJoinPoint(i, n, t, e, o, s, a) {
    return { x: i + o / 2, y: n - 5 };
  },
  getRectBottomJoinPoint(i, n, t, e, o, s, a) {
    return { x: i + o / 2, y: n + s + 5 };
  },
  getRectVJoinPoint(i, n, t, e, o, s, a, c) {
    const l = o / 2;
    return n + s < e ? { y: n + s + 5, x: i + l } : n + s < e + c ? { y: n - 5, x: i + l } : { y: n - 5, x: i + l };
  },
  getBorderPoint(i, n, t, e, o, s, a, c, l) {
    return l === 0 ? this.getCirclePoint(i, n, t, e, o, s, a, c) : this.getRectPoint(i, n, t, e, o, s, a, c);
  },
  getBorderPoint4MultiLine(i, n, t, e, o, s, a, c, l, r, d, f) {
    return l === 0 ? this.getCirclePoint4MultiLine(i, n, t, e, o, s, a, c, r, d, f) : this.getRectPoint(i, n, t, e, o, s, a, c, r, d, f);
  },
  getCirclePoint(i, n, t, e, o, s, a, c) {
    const l = t + a / 2, r = e + c / 2, d = i + o / 2, f = n + s / 2, h = l - d;
    if (h === 0)
      return { x: d, y: f - s / 2 * (r < f ? 1 : -1) };
    const y = (r - f) / h, v = Math.sqrt(1 / (1 / (o / 2) ** 2 + y ** 2 / (s / 2) ** 2)) * (l < d ? 1 : -1), g = y * v;
    return { x: d - v, y: f - g };
  },
  getCirclePoint4MultiLine(i, n, t, e, o, s, a, c, l, r, d, f = 0) {
    l && (d = r - d - 1);
    const h = t + a / 2, m = e + c / 2, y = i + o / 2, v = n + s / 2, g = h - y;
    if (g === 0)
      return { x: y, y: v - s / 2 * (m < v ? 1 : -1) };
    const z = (d - (r - 1) / 2) * 14, S = m - v, B = Math.sqrt(g ** 2 + S ** 2) * z / g, W = S / g, A = o / 2, D = s / 2, C = h < y ? 1 : -1, N = (-1 * A ** 2 * W * B + A * D * Math.sqrt(D ** 2 + W ** 2 * A ** 2 - B ** 2) / C) / (D ** 2 + A ** 2 * W ** 2), T = W * N + B;
    return f === 0 && (Number.isNaN(N) || Number.isNaN(T)) ? this.getCirclePoint4MultiLine(i, n, t, e, o, s, a, c, l, 1, 0, f + 1) : { x: y - N, y: v - T };
  },
  getCirclePointBasic(i, n, t, e, o, s, a, c, l) {
    const r = i + o / 2, d = n + s / 2, f = t + a / 2, h = e + c / 2, m = f - r, y = h - d, v = Math.sqrt(m * m + y * y), g = v - l, b = g * m / v * -1, z = g * y / v * -1;
    return { x: f + b, y: h + z };
  },
  getCirclePointPlus(i, n, t, e, o, s, a, c) {
    const l = i + o / 2, r = n + s / 2, d = t + a / 2, f = e + c / 2, h = d - l, m = f - r, y = Math.sqrt(h * h + m * m), v = (y - o / 2) * h / y * -1, g = (y - s / 2) * m / y * -1;
    return { x: d + v, y: f + g };
  },
  getOvalPoint(i, n, t, e, o) {
    return {
      x: i + t * Math.sin((Vt + e * (360 / o) + 0) * Math.PI / 180),
      y: n + t * Math.cos((Vt + e * (360 / o) + 0) * Math.PI / 180) * -1
    };
  },
  getAngleType(i, n) {
    if (i >= 0 && n >= 0)
  ...
  getTextAngle(i, n, t, e) {
    let o = Math.atan2(e - n, t - i) * 180 / Math.PI;
    return o < 0 && (o += 360), o > 90 && o <= 270 && (o += 180), o >= 360 && (o -= 360), Math.round(o);
  },
  getTreePointFromTop(i, n, t, e, o, s) {
    return i ? {
      x: i - 300 + Math.max(600 / ((o === 1 ? 2 : o) - 1), 80) * e,
      y: n + t
    } : {
  ...
  getTreePointFromRight(i, n, t, e, o, s) {
    return i ? {
      x: i - t,
      y: n - 200 + Math.max(400 / ((o === 1 ? 2 : o) - 1), 80) * e
    } : {
      x: (s.canvas_width - s.node_width) / 2 + 300,
      y: (s.canvas_height - s.node_height) / 2
    };
  },
  getTreePointFromBottom(i, n, t, e, o, s) {
    return i ? {
      x: i - 300 + Math.max(600 / ((o === 1 ? 2 : o) - 1), 80) * e,
      y: n - t
    } : {
  ...
  getTreePointFromLeft(i, n, t, e, o, s) {
    return i ? {
      x: i + t,
      y: n - 200 + Math.max(400 / ((o === 1 ? 2 : o) - 1), 80) * e
    } : {
...
class Ne extends kt {
  ...
  placeNodes(t, e) {
    ...
    if (this.allNodes = t, this.rootNode = e, this.layoutOptions.fixedRootNode) {
      if (!Number.isNaN(e.x) || e.x === void 0)
        e.lot.x = _.getLotXByNodeX(this.graphOptions, e), e.lot.y = _.getLotYByNodeY(this.graphOptions, e);
      else {
        const s = this.layoutOptions.centerOffset_x || 0, a = this.layoutOptions.centerOffset_y || 0;
        e.lot.x = 0 + s, e.lot.y = 0 + a;
      }
      const o = this.easyAnalysisNodes(e);
      this.easyPlaceRelativePosition(e, o), o.forEach((s) => {
  ...
  easyAnalysisNodes(t) {
    ...
    return _.analysisNodes4Didirectional(e, [t], 0, o, 0), e;
  }
  easyPlaceRelativePosition(t, e) {
    e.forEach((s) => {
      if (s.lot.subling.level === 1) {
        ...
        if (a) {
          const c = Z.getOvalPoint(t.lot.x, t.lot.y, a.level * 50, s.lot.strength_plus - s.lot.strength / 2, a.all_strength);
      ...
      const a = s.lot.subling;
      if (a && a.level > 1) {
        const c = s.lot.parent.lot.strength_plus - s.lot.parent.lot.strength, r = (s.lot.parent.lot.strength_plus - c) / (s.lot.parent.lot.childs.length + 1) * (s.lot.index_of_parent + 1), d = Z.getOvalPoint(t.lot.x, t.lot.y, (a.level - 1) * 40 + 50, c + r, s.lot.parent.lot.subling.all_strength);
  ...
  updateVisibleNodes(t) {
    this.visibleNodes = [], t && (this.allNodes = t), this.allNodes.forEach((e) => {
      _.isAllowShowNode(e) && (e.Fx = 0, e.Fy = 0, e.lot ? e.lot.placed = !0 : (u("node miss lot:", e.text), e.lot = {
        placed: !0,
        childs: []
  ...
  autoLayout(t, e) {
    this.layoutTimes = 0, this.updateVisibleNodes(), this.viewUpdate = e, this.doForceLayout(0);
  }
  doForceLayout(t) {
    ...
    if (t > 0) {
      if (this.prev10.length >= 10) {
        ...
        e = Math.round(1e3 / (o / 10));
      }
      this.prev10.push(t);
    }
    if (u("this.layoutTimes:", this.layoutTimes, "of", this.maxLayoutTimes, "Current refresh rate:", e, "Hz", this.requireLinks, this.allLinks.length), this.layoutTimes > this.maxLayoutTimes) {
    ...
    if (this.isMainLayouer && (this.graphOptions.autoLayouting = !0), this.layoutTimes++, this.visibleNodes.forEach((o) => {
      ...
      for (const o in this.visibleNodes) {
        ...
        if (!(this.justLayoutSingleNode && !s.singleNode) && !s.fixed && s.lot && s.lot.placed === !0)
          for (const a in this.visibleNodes) {
            const c = this.visibleNodes[a];
            c.lot && c.lot.placed === !0 && o !== a && this.addGravityByNode(s, c);
          }
      }
    if (this.byLine)
      if (this.allLinks && this.allLinks.length > 0) {
        ...
        for (const o of this.visibleNodes)
          o.lot && o.lot.parent && this.addElasticByLine(
            o.lot.parent,
            o
          );
    for (const o in this.visibleNodes)
  ...
  getX(t) {
    const e = (t.width || t.el.offsetWidth || 60) / 2;
    return t.x + e;
  }
  getY(t) {
    const e = (t.height || t.el.offsetHeight || 60) / 2;
    return t.y + e;
  }
  addElasticByLine(t, e, o = 1) {
    let s = Math.sqrt((this.getY(t) - this.getY(e)) ** 2 + (this.getX(t) - this.getX(e)) ** 2);
    s > this.maxVaildLineLength && (s = this.maxVaildLineLength);
    const a = s < this.minVaildLineLength ? 0 : (s - this.minVaildLineLength) * 0.1 * this.force_line_elastic * o, c = a, l = a, r = (this.getX(t) - this.getX(e)) / s, d = (this.getY(t) - this.getY(e)) / s;
    this.addFtoNode(t, r * c * -1, d * c * -1), this.addFtoNode(e, r * l, d * l);
  }
  addGravityByNode(t, e) {
    const o = Math.sqrt(
      (this.getY(t) - this.getY(e)) ** 2 + (this.getX(t) - this.getX(e)) ** 2
    );
    ...
    const a = (this.getX(t) - this.getX(e)) / o, c = (this.getY(t) - this.getY(e)) / o;
    this.addFtoNode(t, a * s, c * s), this.addFtoNode(e, a * s * -1, c * s * -1);
  }
  addFtoNode(t, e, o) {
    if (t.dragging || this.justLayoutSingleNode && !t.singleNode || Number.isNaN(e) || Number.isNaN(o))
      return;
    e = e / (t.lot.strength || 1), o = o / (t.lot.strength || 1), e > 50 && (e = 50), o > 50 && (o = 50), e < -50 && (e = -50), o < -50 && (o = -50);
    const s = t.force_weight || 1;
    this.lockX || (t.Fx += e * (1 / s)), this.lockY || (t.Fy += o * (1 / s));
  }
  applyToNodePosition(t) {
    if (t.fixed)
      return;
    let e = Math.round(t.Fx), o = Math.round(t.Fy);
    e > this.maxMoveSpeed && (e = this.maxMoveSpeed), o > this.maxMoveSpeed && (o = this.maxMoveSpeed), e < -this.maxMoveSpeed && (e = -this.maxMoveSpeed), o < -this.maxMoveSpeed && (o = -this.maxMoveSpeed), t.x = t.x + e, t.y = t.y + o, t.Fx = 0, t.Fy = 0;
  }
}
const _t = Ne;
class ze extends _t {
  ...
  async placeNodes(t, e) {
    if (u("SeeksCenterLayouter:placeNodes"), !e) {
      u("root is null:", e);
      return;
    }
    u("layout by root:", e), this.allNodes = t, this.rootNode = e, t.forEach((a) => {
    ...
    if (_.analysisNodes(o, [this.rootNode], 0, s), o = [], s = {
      ...
      max_length: 1,
      max_strength: 1
    }, _.analysisNodes4Didirectional(o, [this.rootNode], 0, s, 0), e.fixed)
      ...
      e.lot.x = 0 + a, e.lot.y = 0 + c;
    }
    u("root position:", e.lot.x, e.lot.y), this.placeRelativePosition(this.rootNode, o, s), this.graphOptions.useAnimationWhenExpanded ? (u("Play layout animation....."), await this.animationLayout()) : o.forEach((a) => {
      if (a.fixed === !0 || !_.isAllowShowNode(a))
        return;
      const c = a.offset_x || 0, l = a.offset_y || 0, r = -_.getNodeWidth(a, this.graphOptions) / 2, d = -_.getNodeHeight(a, this.graphOptions) / 2;
      a.x = a.lot.x + c + r, a.y = a.lot.y + l + d, a.lot.placed = !0;
    });
  }
  getLevelDistanceArr() {
    let t = [];
  ...
  placeRelativePosition(t, e, o) {
    const s = this.layoutOptions.distance_coefficient === void 0 ? 1 : this.layoutOptions.distance_coefficient, a = this.getLevelDistanceArr(), c = Math.min(this.graphOptions.viewSize.height, this.graphOptions.viewSize.width) * 0.4;
    let l = Math.min(Math.max(c, 150), 400) * s;
    u("analyticResult:", o, c, l, s, a);
    let r = 0;
    e.forEach((f) => {
      const h = f.lot.subling;
      if (h && h.level === 1) {
        r = Math.round(h.all_size * 60 / Math.PI / 2), r < l && (r = l);
        const m = this.getLevelR(a, h.level) || h.level * r, y = Z.getOvalPoint(t.lot.x, t.lot.y, m, f.lot.strength_plus - f.lot.strength / 2, h.all_strength);
        f.lot.x = y.x, f.lot.y = y.y;
      }
    });
    ...
    e.forEach((f) => {
      const h = f.lot.subling;
      if (h && h.level > 1) {
        const m = f.lot.parent.lot.strength_plus - f.lot.parent.lot.strength, v = (f.lot.parent.lot.strength_plus - m) / (f.lot.parent.lot.childs_size + 1) * (f.lot.index_of_parent + 1), g = this.getLevelR(a, h.level) || (h.level - 1) * d + r, b = Z.getOvalPoint(t.lot.x, t.lot.y, g, m + v, f.lot.parent.lot.subling.all_strength);
        f.lot.x = b.x, f.lot.y = b.y;
      }
    });
  }
}
  ...
  async placeNodes(n, t) {
    ...
    c < 200 && (c = 200), c > 800 && (c = 800), this.allNodes.forEach((l, r) => {
      ...
      if (l.fixed === !0 || !_.isAllowShowNode(l))
        return;
      const r = l.offset_x || 0, d = l.offset_y || 0, f = -_.getNodeWidth(l, this.graphOptions) / 2, h = -_.getNodeHeight(l, this.graphOptions) / 2;
      l.x = l.lot.x + r + f, l.y = l.lot.y + d + h, l.lot.placed = !0;
    });
  }
}
const Qt = Pe;
class Be extends kt {
  ...
  placeNodes(t, e) {
    ...
    u("allNodes:", t.length), this.__origin_nodes = t, this.rootNode = e, t.forEach((s) => {
...
class De extends kt {
  ...
  analysisNodes4Didirectional(t, e, o, s) {
    this.analysisBothWay(t, e, o, s);
    const a = {};
    t.forEach((r) => {
      const d = r.lot.level + "";
      a[d] || (a[d] = []), a[d].push(r), r.lot.subling = {
        level: r.lot.level,
        all_size: 0,
        all_strength: 0
      };
    }), t.forEach((r) => {
      const d = r.lot.level + "", f = a[d], h = f.length;
      r.lot.index_of_level = f.indexOf(r), r.lot.subling.all_size = h, r.lot.subling.all_strength += r.lot.strength || 1, r.lot.strength_plus = r.lot.subling.all_strength;
    }), t.forEach((r) => {
    ...
    const c = Object.keys(a).map((r) => Number.parseInt(r)).sort(), l = (r) => {
      ...
      let h = 0;
      f.forEach((m) => {
        m.lot.parent && h < m.lot.parent.lot.strengthWithChilds_from && (h = m.lot.parent.lot.strengthWithChilds_from), r === 0 ? h += 1 : m.lot.strengthWithChilds_from = h, u("levels:", r, h, m.text, m.lot.strengthWithChilds), h += m.lot.strengthWithChilds;
      });
    };
    [0].forEach(l), c.filter((r) => r > 0).forEach(l), c.filter((r) => r < 0).forEach(l);
  }
  analysisBothWay(t, e, o, s) {
    u(`level ${o} size: ${e.length}`), e.length > s.max_length && (s.max_length = e.length), o > s.max_deep && (s.max_deep = o);
    const a = {
      level: o,
      all_size: e.length,
      all_strength: 0
    ...
    e.forEach((l) => {
      l.lot || (l.lot = { childs: [] }), l.lot.eached = !0, l.lot.subling = a, l.lot.level = o, t.push(l);
    });
    let c = 0;
    e.forEach((l) => {
      let r = 0, d = 0, f = [];
      l.targetFrom.forEach((h) => {
        h.lot || (h.lot = { eached: !1, childs: [] }), h.lot.eached || (h.lot.parent = l, _.isAllowShowNode(h) ? (h.lot.eached = !0, h.lot.index_of_parent = d++, l.lot.childs.push(h), f.push(h), r++) : l.lot.childs.push(h));
      }), this.analysisBothWay(t, f, o - 1, s), f = [], l.targetTo.forEach((h) => {
        h.lot || (h.lot = { eached: !1, childs: [] }), h.lot.eached || (h.lot.parent = l, _.isAllowShowNode(h) ? (h.lot.eached = !0, h.lot.index_of_parent = d++, l.lot.childs.push(h), f.push(h), r++) : l.lot.childs.push(h));
      }), this.analysisBothWay(t, f, o + 1, s), l.lot.strength = r > 0 ? r : 1, a.all_strength += l.lot.strength, l.lot.strength_plus = a.all_strength, l.lot.index_of_level = c, l.lot.childs_size = r, c++;
  ...
  async placeNodes(t, e) {
    ...
    this.rootNode = e, this.allNodes = t, u("allNodes:", t.length), t.forEach((l) => {
    ...
    _.analysisNodes(o, [this.rootNode], 0, s), o = [], s = {
      ...
      max_length: 1,
      max_strength: 1
    }, this.analysisNodes4Didirectional(o, [this.rootNode], 0, s), this.placeNodesPosition(this.rootNode, o, s), u("allNodes:", o.length), this.graphOptions.useAnimationWhenExpanded ? (u("Play layout animation....."), await this.animationLayout(), u("create rootNode coordinates:3", e.x, e.y)) : (this.allNodes.forEach((l) => {
      if (l.fixed === !0) {
        l.lot.placed = !0;
        return;
      }
    ...
    const a = o.filter((l) => l.lot.level === 0), c = new _t({
      layoutName: "force",
      maxLayoutTimes: 100,
  ...
  placeRelativePosition(t, e, o) {
    ...
    if (this.layoutOptions.from === "left" || this.layoutOptions.from === "right") {
      ...
      f < a && (f = a), f > c && (f = c), e.forEach((h) => {
        ...
        h.fixed !== !0 && (h.lot.level === 0 ? h !== t && (h.lot.y = t.lot.y + f * h.lot.index_of_level) : h.lot.y = t.lot.y + f * (o.max_strength / -2 + h.lot.strengthWithChilds_from + h.lot.strengthWithChilds / 2));
      });
    } else {
      const a = X(this.layoutOptions.min_per_height) || 350, c = X(this.layoutOptions.max_per_height) || 400, l = X(this.layoutOptions.min_per_width) || 250, r = X(this.layoutOptions.max_per_width) || 500;
      let d = Math.round((s.width - 10) / (o.max_strength + 2));
      ...
      f < a && (f = a), f > c && (f = c), e.forEach((h) => {
        ...
        h.fixed !== !0 && h.lot.level !== 0 && (h.lot.x = t.lot.x + d * (o.max_strength / -2 + h.lot.strengthWithChilds_from + h.lot.strengthWithChilds / 2));
      });
    }
  }
  getLevelDistance(t, e, o) {
...
const Mt = (i, n) => {
  St(i);
  let t = null;
  if (i.layoutName === "tree" ? t = new Jt(i, n) : i.layoutName === "center" ? t = new Kt(i, n) : i.layoutName === "circle" ? t = new Qt(i, n) : i.layoutName === "force" ? t = new _t(i, n) : i.layoutName === "fixed" ? t = new te(i, n) : i.layoutName === "smart-tree" && (t = new De(i, n)), !t)
    throw new Error("unknown layout: " + i.layoutName);
  return n.isNeedShowAutoLayoutButton = i.allowAutoLayoutIfSupport !== !1 && t.autoLayout !== void 0, t;
}, St = (i) => {
  ...
  createLayout: Mt,
  appendDefaultOptions4Layout: St
...
const Ht = (i) => {
  ...
  const n = {
    ...
    creatingNodePlot: !1,
    showTemplateNode: !0,
    newNodeTemplate: Ct(JSON.parse(JSON.stringify(Wt))),
    creatingLinePlot: !1,
    newLineTemplate: {
  ...
  if (n.newLineTemplate = Lt(n.newLineTemplate), i.layout && i.layouts)
    throw new Error("Graph options cannot have both layout and layouts properties !");
  const t = i.debug === !0;
  t && u("RGOptions:user instance options:", i), window && (window.relationGraphDebug = t);
  ...
  return !i.layouts || !Array.isArray(i.layouts) || i.layouts.length === 0 ? i.layout ? o = [i.layout] : o = [{
    ...
    layoutName: "center",
    layoutDirection: "v"
  }] : o = i.layouts, u("final layouts:", o), n.layouts = o.map((s) => JSON.parse(JSON.stringify(s))), n.disableNodeClickEffect && (n.defaultFocusRootNode = !1), St(n.layouts[0]), Ot(n.layouts[0], n), n;
}, Ot = (i, n) => {
  ...
  const n = Ht(i);
  return u("RGOptions:new RGOptions:by:", i), u("RGOptions:new RGOptions:", n), n.instanceId || (n.instanceId = `RGIns-${$e++}`), n;
}, We = {
  newInstanceOptions: Et,
  createDefaultConfig: Ht,
  applyDefaultOptionsByLayout: Ot
...
class Ie {
  constructor(n, t) {
    ...
    this.listeners = t, this.options = Et(n), u("new RelationGraph:", this);
  }
  enableDebugLog(n) {
...
class Fe extends Re {
  ...
  setReactiveData(t, e) {
    this.graphData = t, this.allLineColors = e.allLineColors, e.options = this.options, this.reactiveData = e;
  }
  ...
  _setOptions(t) {
    const e = Et(t);
    this.reactiveData.options = e, this.options = this.reactiveData.options;
  }
  _initLayoutByLayoutOptions(t) {
    this.options.layoutClassName = t.layoutClassName, this.options.layoutLabel = t.label, this.options.layoutName = t.layoutName, this.options.layoutDirection = t.layoutDirection, this.layouter = Mt(t, this.options);
  }
  initLayouter() {
  ...
  async _setJsonData(t, e = !1) {
    await this.clearGraph(), u("set jsonData:", t), this.loadGraphJsonData(t);
  }
  async clearGraph() {
  ...
  generateNewNodeId(t = 1) {
    const e = "N" + (this.graphData.nodes.length + t);
    return this.getNodeById(e) ? this.generateNewNodeId(t + 1) : (u("generateNewNodeId:", t, e), e);
  }
  loadNodes(t) {
    t.forEach((e) => {
      let o = this.graphData.nodes.find((s) => s.id === e.id);
      o || (o = Ct(e), o && (o.seeks_id = this.seeksNodeIdIndex++, this.graphData.nodes.push(o)));
    });
  }
  loadLines(t) {
    t.forEach((e) => {
      let o = !1, s, a;
      if (typeof e.from == "object" ? s = e.from : s = this.graphData.nodes.find((y) => y.id === e.from), typeof e.to == "object" ? a = e.to : a = this.graphData.nodes.find((y) => y.id === e.to), !s) {
        console.error("Can not found from node:", e);
        return;
      }
      if (!a) {
        console.error("Can not found to node:", e);
        return;
      }
      const c = `${s.seeks_id}-${a.seeks_id}`, l = `${a.seeks_id}-${s.seeks_id}`, r = Lt(e);
      let d = this.graphData.links.find((y) => y.seeks_id === c), f = !1;
      d || (d = this.graphData.links.find((y) => y.seeks_id === l), d ? f = !0 : (o = !0, d = {
        seeks_id: c,
        fromNode: s,
        toNode: a,
        appended: !1,
      ...
      let h = r.arrow;
      r.isHideArrow || (h = this.getLineArrow(r.color)), s.targetNodes || (s.targetNodes = []), a.targetNodes || (a.targetNodes = []), r.forDisplayOnly || (s.targetNodes.includes(a) || s.targetNodes.push(a), a.targetNodes.includes(s) || a.targetNodes.push(s), s.targetTo.includes(a) || s.targetTo.push(a), a.targetFrom.includes(s) || a.targetFrom.push(s), d.forDisplayOnly = !1);
      let m = !1;
      for (let y = 0; y < d.relations.length; y++)
        if ((d.relations[y].id || r.id) && d.relations[y].id === r.id) {
          m = !0;
          break;
        }
      m === !1 && (r.id || (r.id = `${d.seeks_id}-${d.relations.length}`), r.isReverse = f, r.arrow = h, d.relations.push(r)), o && (this.graphData.links.push(d), d.appended = !1);
    });
  }
  flatNodeData(t, e, o, s) {
    it.flatNodeData(t, e, o, s);
  }
  loadGraphJsonData(t) {
    ...
    const e = t.nodes, o = [], s = [];
    this.flatNodeData(e, null, o, s), t.lines.forEach((a) => {
      s.push(a);
  ...
  getLineArrow(t, e = !1, o = !1) {
    ...
    if (t) {
      const a = ve(t);
      return this.allLineColors.map((c) => c.id).includes(a) || this.allLineColors.push({ id: a, color: t }), `${this.options.instanceId}-${s}arrow-${a}`;
    } else
  ...
  addElementLines(t) {
    u("addElementLines:", t), t.forEach((e) => {
      const o = document.getElementById(e.from), s = document.getElementById(e.to);
      if (!o) {
        console.error("Can not found from HTMLElement: #" + e.from);
        return;
      }
      if (!s) {
        console.error("Can not found toHTMLElement: #" + e.to);
        return;
      }
      const a = Lt(e);
      let c = a.arrow;
  ...
  removeELementLineById(t) {
    ...
    for (let e = 0; e < this.graphData.elementLines.length; e++)
      this.graphData.elementLines[e].relations[0].id === t && (this.graphData.elementLines.splice(e, 1), e--);
  }
  updateElementLines() {
  ...
  _updateElementLinePosition(t, e) {
    const o = t.getBoundingClientRect(), s = this.$canvasDom.getBoundingClientRect();
    e.x = (o.x - s.x) / (this.options.canvasZoom / 100), e.y = (o.y - s.y) / (this.options.canvasZoom / 100), e.el.offsetWidth = o.width / (this.options.canvasZoom / 100), e.el.offsetHeight = o.height / (this.options.canvasZoom / 100);
  }
  getElementPosition(t) {
    const o = document.getElementById(t).getBoundingClientRect(), s = this.$canvasDom.getBoundingClientRect(), a = (o.x - s.x) / (this.options.canvasZoom / 100), c = (o.y - s.y) / (this.options.canvasZoom / 100);
    return { x: a, y: c };
  }
  removeNodeById(t) {
    let e = 0;
    for (let s = 0; s < this.graphData.links.length; s++) {
      ...
      (a.fromNode.id === t || a.toNode.id === t) && (this.removeLink(a), s--, e++);
    }
    u("Removed link\uFF1A", t, e);
    let o = 0;
  ...
  getGroupByNode(t, e = []) {
    ...
    for (const o of t.targetNodes)
      e.includes(o) || this.getGroupByNode(o, e);
    return e;
  }
  _clearItem(t, e) {
  ...
  removeLine(t, e) {
    ...
    for (let o = 0; o < t.relations.length; o++)
      t.relations[o] === e && t.relations.splice(o, 1);
  ...
  setCanvasCenter(t, e) {
    ...
    this.setCanvasOffset(o - t + a.offset_x, s - e + a.offset_y);
  }
  setCanvasOffset(t, e) {
  ...
  getNodesCenter() {
    ...
    u("getStuffSize:", t);
    const e = t.minX + (t.width - 100) / 2, o = t.minY + (t.height - 100) / 2;
    return {
      x: e,
      y: o
    };
  ...
  querySearchAsync(t) {
    ...
    const e = [];
    return this.graphData.nodes.forEach((o) => {
      u("fetch:", o.text), o.text.includes(t) && e.push(o);
    }), u("fetched:", e.length), e;
  }
  printOptions() {
...
class Ge extends Fe {
  ...
  dataURLToBlob(n) {
    const t = n.split(","), e = t[0], o = e && e.match(/:(.*?);/)[1], s = atob(t[1]);
    let a = s.length;
  ...
  async createGraphCanvas(n = "png") {
    return new Promise((t, e) => {
      ...
      let d = 999999, f = 999999, h = 0, m = 0;
      const y = 200;
      this.loading("Generating..."), this.graphData.nodes.forEach((C) => {
        C.x < d && (d = C.x), C.x > h && (h = C.x + C.el.offsetWidth), C.y < f && (f = C.y), C.y > m && (m = C.y + C.el.offsetHeight);
      });
      const v = d - y, g = f - y;
      this.graphData.nodes.forEach((C) => {
        ...
        const N = C;
        N.style.left = -g + "px", N.style.top = -g + "px";
      }), this.updateElementLines(), this.$canvasDom.querySelectorAll(".rel-lines-svg-el-lines").forEach((C) => {
        const N = C;
        N.style.width = "4000px", N.style.height = "4000px";
      }), this.options.canvasOffset.x = y * -1, this.options.canvasOffset.y = y * -1;
      const S = h - d + 200 + y * 2, B = m - f + 100 + y * 2, W = window.devicePixelRatio;
      this.options.canvasSize.width = S * W, this.options.canvasSize.height = B * W, window.scrollTo(0, 0);
      const A = document.createElement("canvas");
      A.width = S * W, A.height = B * W, A.style.backgroundColor = getComputedStyle(r.parentElement, null).backgroundColor, u("canvas.style.backgroundColor:", A.style.backgroundColor), A.style.width = `${S * W}px`, A.style.height = `${B * W}px`, A.getContext("2d").scale(1, 1);
      const D = {
      ...
      setTimeout(() => {
        this.createImage(r, D, n, "", (C) => {
          this.options.canvasSize.width = s, this.options.canvasSize.height = a, this.options.canvasOffset.x = c, this.options.canvasOffset.y = l, this.options.canvasZoom = o, this.$canvasDom.querySelectorAll(".rel-canvas-slot").forEach((R) => {
            const Y = R;
            Y.style.left = "0px", Y.style.top = "0px";
          }), this.graphData.nodes.forEach((R) => {
            R.x = R.x + v, R.y = R.y + g;
          }), this.$canvasDom.querySelectorAll(".rel-lines-svg-el-lines").forEach((R) => {
            const Y = R;
  ...
  createImage(n, t, e, o, s) {
    u("createImage:", t), ye(n, t).then((a) => {
      s && s(a);
    });
  }
  async getImageBase64(n = "png") {
    const t = await this.createGraphCanvas(n), e = document.body.appendChild(t);
    e.style.display = "none";
    const o = e.toDataURL(`image/${n}`);
    return document.body.removeChild(e), o;
  }
  async downloadAsImage(n = "png", t) {
    ...
    const e = await this.createGraphCanvas(n);
    u("downloadImageAsFile:", n, t);
    let o = !0;
    this.listeners.onImageSaveAsFile && this.listeners.onImageSaveAsFile(
      e,
      n,
      t
    ) === !1 && (o = !1), o && await this.downloadImageAsFile(e, n, t);
  }
  async downloadImageAsFile(n, t, e) {
    const o = document.body.appendChild(n);
    o.style.display = "none";
    const s = this.dataURLToBlob(o.toDataURL(`image/${t}`));
    document.body.removeChild(o);
    const a = document.createElement("a");
    a.style.display = "none";
    try {
      window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveOrOpenBlob(s, `${e}.${t}`) : (a.setAttribute("href", URL.createObjectURL(s)), a.setAttribute("download", `${e}.${t}`), document.body.appendChild(a), a.click(), u("click ok!"), URL.revokeObjectURL(await s.text()), u("revokeObjectURL ok!"), document.body.removeChild(a), u("removeChild ok!"));
    } catch (c) {
...
class Ve extends Ge {
  ...
  createReturnValue(n, t) {
    return { path: n, textPosition: t };
  }
  createLinePath(n, t, e) {
    let o = n.fromNode;
    o || (o = {
      x: 0,
      y: 0,
    ...
    return e || (e = 0), this.createLinePathByTwoNode(o, s, t, e, a);
  }
  _getJunctionPoint(n, t) {
    return n === at.border ? Z.getBorderPoint4MultiLine(...t) : n === at.ltrb ? Z.getRectJoinPoint(...t) : n === at.tb ? Z.getRectVJoinPoint(...t) : n === at.lr ? Z.getRectHJoinPoint(...t) : n === at.left ? Z.getRectLeftJoinPoint(...t) : n === at.right ? Z.getRectRightJoinPoint(...t) : n === at.top ? Z.getRectTopJoinPoint(...t) : n === at.bottom ? Z.getRectBottomJoinPoint(...t) : Z.getBorderPoint4MultiLine(...t);
  }
  createLinePathByTwoNode(n, t, e, o = 0, s = 1) {
    const a = e.lineShape || this.options.defaultLineShape || 1, c = e.lineDirection || this.options.layoutDirection || "h";
    let l = n.x, r = n.y, d = t.x, f = t.y;
    const h = { x: 0, y: 0, rotate: 0 };
    if (Number.isNaN(l) || Number.isNaN(r))
      return u("error start node:", n.text, n.x, n.y), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L -10 -10", h);
    if (Number.isNaN(d) || Number.isNaN(f))
      return u("error end point:", t.text, t.x, t.y), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 10 -10", h);
    let m = n.el.offsetWidth || n.width || 60, y = n.el.offsetHeight || n.height || 60;
    if (Number.isNaN(m) || Number.isNaN(y))
      return h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L -10 10", h);
    let v = t.el.offsetWidth || t.width || 60, g = t.el.offsetHeight || t.height || 60;
    if (Number.isNaN(v) || Number.isNaN(g))
      return h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 10 10", h);
    e.isReverse && ([l, r, d, f, m, y, v, g] = [
      d,
      f,
      l,
      r,
    ...
    const b = [
      ...
      s,
      o
    ], S = this.options.defaultJunctionPoint || at.border, B = e.fromJunctionPoint || n.junctionPoint || S, W = e.toJunctionPoint || t.junctionPoint || S, A = this._getJunctionPoint(B, b), D = this._getJunctionPoint(W, z);
    if (!A || !D)
      return this.createReturnValue(
        "Unable to calculate the starting point and ending point of the line.",
        h
      );
    const C = A.x, N = A.y, T = D.x, R = D.y;
    if (n === t) {
      const ct = l + m / 2, M = r + y / 2, tt = Math.atan2(N - M, C - ct), F = Math.sin(tt + Math.PI) * 5, V = Math.cos(tt + Math.PI) * 5, et = { x: C - F, y: N - V }, It = { x: C + F, y: N + V }, ne = C - V * 5, ie = N - F * 5, se = C - V * 5, ae = N - F * 5, le = `M${et.x},${et.y} C${ne},${ie} ${se},${ae} ${It.x},${It.y}`;
      return h.x = C - V / (V + F) * 20, h.y = N + F / (V + F) * 20, h.rotate = 0, this.createReturnValue(le, h);
    }
    if (Number.isNaN(C) || Number.isNaN(N))
      return u("error start point:", n.text), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L -10 0", h);
    if (Number.isNaN(T) || Number.isNaN(R))
      return u("error end point:", t.text), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 10 0", h);
    const Y = l + m / 2, nt = r + y / 2, O = d + v / 2, E = f + g / 2, vt = this.createLinePathData(
      e,
      h,
      s,
      o,
    ...
    return this.createReturnValue(vt, h);
  }
  createLinePathData(n, t, e, o, s, a, c, l, r, d, f, h, m, y, v, g, b, z) {
    let S = m - c, B = y - l, W = m > c ? 1 : -1, A = y > l ? 1 : -1, D = s === "v" ? A : W, C = "";
    if (a === 4) {
      const N = c - r, T = l - d, R = m - v, Y = y - g;
      let nt = this.options.defaultPloyLineRadius || 0;
      const O = Math.min(nt, Math.abs(S)) * (c < m ? 1 : -1), E = Math.min(nt, Math.abs(B)) * (l < y ? 1 : -1), vt = Math.abs(N) >= f / 2 ? "h" : "v", ct = Math.abs(R) >= b / 2 ? "h" : "v", M = [];
      if (vt === "v") {
        const tt = n.polyLineStartDistance || Math.max(Math.min(30, Math.abs(y - l) / 2), 15), F = T > 0 ? tt : -tt;
        if (t.x = m, t.y = l + F + (T > 0 ? 20 : -5), M.push(`M ${c} ${l}`), M.push(`v${F - E}`), ct === "v")
          M.push(`c${0},${E},`), M.push(`${O},${E},`), M.push(`${O},${E}`), M.push(`h${m - c - O * 2}`), M.push(`c${O},${0},`), M.push(`${O},${E},`), M.push(`${O},${E}`), M.push(`v${y - l - F - E}`);
        else {
          M.push(`c${0},${E},`), M.push(`${O},${E},`), M.push(`${O},${E}`);
          const V = Math.min(30, Math.abs(m - c) / 2), et = R > 0 ? -V : V;
          M.push(`h${m - c + et - O}`), M.push(`c${O},${0},`), M.push(`${O},${E},`), M.push(`${O},${E}`), M.push(`v${y - l - F - E}`), M.push(`h${et - O}`);
        }
      } else {
        const tt = n.polyLineStartDistance || Math.max(Math.min(30, Math.abs(m - c) / 2), 15), F = N > 0 ? tt : -tt;
        if (t.x = c + F + (N > 0 ? 20 : -50), t.y = y - 5, M.push(`M ${c} ${l}`), M.push(`h${F - O}`), ct === "v") {
          const V = Math.min(30, Math.abs(y - l) / 2), et = Y > 0 ? -V : V;
          M.push(`c${O},${0},`), M.push(`${O},${E},`), M.push(`${O},${E}`), M.push(`v${y - l + et - E}`), M.push(`h${m - c - F - O}`), M.push(`c${0},${E},`), M.push(`${O},${E},`), M.push(`${O},${E}`), M.push(`v${et - E}`);
        } else
          M.push(`c${O},${0},`), M.push(`${O},${E},`), M.push(`${O},${E}`), M.push(`v${y - l - E * 2}`), M.push(`c${0},${E},`), M.push(`${O},${E},`), M.push(`${O},${E}`), M.push(`h${m - c - F - O}`);
      }
      C = M.join(" ");
    } else if (a === 2 || a === 3 || a === 5 || a === 6 || a === 7) {
      const N = c - r, T = l - d, R = m - v, Y = y - g, nt = 1 / (e + 1) * (o + 1);
      let O, E;
      if (a === 2)
        O = s === "v" ? { x: 0, y: D * 30 } : { x: D * 30, y: 0 }, E = s === "v" ? { x: S * nt, y: D * -10 } : { x: D * -10, y: B * nt };
      else if (a === 3)
        O = s === "v" ? { x: 0, y: B * nt } : { x: D * 30, y: 0 }, E = s === "v" ? { x: 0, y: 0 } : { x: D * -10, y: B * nt };
      else if (a === 5)
        O = s === "v" ? { x: 0, y: 0 } : { x: 0, y: 0 }, E = s === "v" ? { x: 0, y: B * nt } : { x: S * nt, y: 0 };
      else if (a === 6) {
        const ct = Math.min(200, Math.max(100, Math.abs(S / 2))), M = Math.min(200, Math.max(100, Math.abs(B / 2))), tt = N / (Math.abs(N) + Math.abs(T)) * ct, F = T / (Math.abs(N) + Math.abs(T)) * M;
        O = { x: tt, y: F };
        const V = R / (Math.abs(R) + Math.abs(Y)) * ct + S, et = Y / (Math.abs(R) + Math.abs(Y)) * M + B;
        E = { x: V, y: et };
      } else if (a === 7) {
        const tt = N / (Math.abs(N) + Math.abs(T)) * 30, F = T / (Math.abs(N) + Math.abs(T)) * 30;
        O = { x: tt, y: F };
        const V = R / (Math.abs(R) + Math.abs(Y)) * 30 + S, et = Y / (Math.abs(R) + Math.abs(Y)) * 30 + B;
        E = { x: V, y: et };
      }
      const vt = this.calcCurveCenter(
        { x: c, y: l },
        { x: c + O.x, y: l + O.y },
        { x: c + E.x, y: l + E.y },
        { x: c + S, y: l + B },
      ...
      t.x = vt.x, t.y = vt.y, C = `M${c},${l} c${O.x},${O.y} ${E.x},${E.y} ${S},${B}`;
    } else
      t.rotate = Z.getTextAngle(c, l, m, y), t.x = Math.round(c + (m - c) / 2), t.y = Math.round(l + (y - l) / 2), Number.isNaN(t.rotate) && (t.rotate = 0), C = `M ${c} ${l} L ${m} ${y}`;
    return C;
  }
  calcCurveCenter(n, t, e, o, s = 0.5) {
    const a = { x: (1 - s) * n.x + s * t.x, y: (1 - s) * n.y + s * t.y }, c = { x: (1 - s) * t.x + s * e.x, y: (1 - s) * t.y + s * e.y }, l = { x: (1 - s) * e.x + s * o.x, y: (1 - s) * e.y + s * o.y }, r = { x: (1 - s) * a.x + s * c.x, y: (1 - s) * a.y + s * c.y }, d = { x: (1 - s) * c.x + s * l.x, y: (1 - s) * c.y + s * l.y };
    return { x: (1 - s) * r.x + s * d.x, y: (1 - s) * r.y + s * d.y };
  }
  createCheckedLinePath() {
    ...
    if (!!n)
      try {
        ...
        if (!it.isAllowShowNode(e.fromNode)) {
          u("from hide:", n);
          return;
        }
        if (!it.isAllowShowNode(e.toNode)) {
          u("to hide:", n);
          return;
        }
        const o = e.relations.findIndex((c) => c.id === n);
        if (o === -1) {
          u("Can not find checkedLineId:", n);
          return;
        }
        const s = e.relations[o], { path: a } = this.createLinePath(
          e,
          s,
          o
        );
  ...
  createCheckedLineStrokeWidth() {
    ...
    try {
      ...
      if (!t)
        return this.options.defaultLineWidth + 8;
      const e = t.relations.findIndex((s) => s.id === n);
      if (e === -1)
        return this.options.defaultLineWidth + 8;
...
class Ye extends Ve {
  ...
  zoom(t, e) {
    ...
    const o = this.options.canvasZoom + t, s = this.showZoomCenter(e, t);
    this.options.canvasOffset.x += s.buff_x, this.options.canvasOffset.y += s.buff_y, this.options.canvasZoom = o, this.refreshNVAnalysisInfo(), this.listeners.onZoomEnd && this.listeners.onZoomEnd();
  }
  setZoom(t, e) {
  ...
  getCanvasCoordinateByClientCoordinate(t) {
    const e = this.options.canvasZoom / 100, { NMCanvasStart: o, NMZoomCenter: s } = this.analysisByZoom(e, t), a = {
      x: s.x - o.x,
      y: s.y - o.y
    };
    return {
  ...
  getClientCoordinateByCanvasCoordinate(t) {
    const e = this.options.canvasZoom / 100, { NMCanvasStart: o } = this.analysisByZoom(e), s = {
      x: t.x * e + o.x,
      y: t.y * e + o.y
    };
    return {
  ...
  analysisByZoom(t, e) {
    ...
    const a = this.options.canvasSize.width * t, c = this.options.canvasSize.height * t;
    o.NMCanvasCenter.x = this.options.canvasOffset.x + this.options.canvasSize.width / 2, o.NMCanvasCenter.y = this.options.canvasOffset.y + this.options.canvasSize.height / 2, o.NMCanvasStart.x = o.NMCanvasCenter.x - a / 2, o.NMCanvasStart.y = o.NMCanvasCenter.y - c / 2, o.NMCanvasEnd.x = o.NMCanvasCenter.x + a / 2, o.NMCanvasEnd.y = o.NMCanvasCenter.y + c / 2, o.NMZoomCenter.x = o.NMViewCenter.x, o.NMZoomCenter.y = o.NMViewCenter.y, e && (o.NMZoomCenter.x = e.x - o.NMViewPosition.x, o.NMZoomCenter.y = e.y - o.NMViewPosition.y);
    let l = o.NMViewCenter.x - o.NMCanvasCenter.x, r = o.NMViewCenter.y - o.NMCanvasCenter.y;
    return e && (l = o.NMZoomCenter.x - o.NMCanvasCenter.x, r = o.NMZoomCenter.y - o.NMCanvasCenter.y), o.NMViewBuff.x = l, o.NMViewBuff.y = r, o.NMCanvasSize.width = a, o.NMCanvasSize.height = c, o;
  }
  showZoomCenter(t, e) {
    if (!this.$dom)
      return { buff_x: 0, buff_y: 0 };
    const o = this.options.canvasZoom / 100, s = this.analysisByZoom(o, t), a = (this.options.canvasZoom + e) / 100, c = this.analysisByZoom(a, t), l = a / o, r = 0, d = 0, f = a / o, h = 0, m = 0;
    this.zoomCenter_of_newSize.x = l * s.NMViewBuff.x + d * s.NMViewBuff.y + h, this.zoomCenter_of_newSize.y = r * s.NMViewBuff.x + f * s.NMViewBuff.y + m;
    ...
    let g = s.NMCanvasStart.x - s.NMCanvasCenter.x, b = s.NMCanvasStart.y - s.NMCanvasCenter.y, z = l * g + d * b + h, S = r * g + f * b + m;
    return c.NMCanvasStart.x = y + s.NMCanvasCenter.x + z, c.NMCanvasStart.y = y + s.NMCanvasCenter.y + S, g = s.NMCanvasEnd.x - s.NMCanvasCenter.x, b = s.NMCanvasEnd.y - s.NMCanvasCenter.y, z = l * g + d * b + h, S = r * g + f * b + m, c.NMCanvasEnd.x = y + s.NMCanvasCenter.x + z, c.NMCanvasEnd.y = y + s.NMCanvasCenter.y + S, s.NMCanvasOffsetBuff.x = y, s.NMCanvasOffsetBuff.y = v, {
      buff_x: y,
      buff_y: v
    };
  }
...
class Xe extends Ye {
  ...
  async doLayout() {
    ...
    this.options.showMaskWhenLayouting && this.loading(), await Ft(200), this.options.showMaskWhenLayouting && this.clearLoading(), u("node size\uFF1A", this.graphData.nodes.length);
  ...
  async moveToCenter() {
    if (this.options.useAnimationWhenRefresh) {
      ...
      const e = this.options.viewSize.width / 2 - n.x + t.offset_x, o = this.options.viewSize.height / 2 - n.y + t.offset_y;
      await this.animateGoto(e, o, 500), this._dataUpdated();
    } else {
      const n = this.getNodesCenter();
  ...
  async placeOtherNodes() {
    ...
    this.graphData.nodes.forEach((o) => {
      n.includes(o) || (this.options.placeSingleNode && (!o.targetNodes || o.targetNodes.length === 0) && o.fixed !== !0 ? (o.x = Math.floor(Math.random() * 200) - 100, o.y = Math.floor(Math.random() * 200) - 100, o.lot || (o.lot = { childs: [] }), o.lot.placed = !0, o.singleNode = !0, e.push(o)) : t.push(o));
    }), this.options.placeSingleNode && this.options.layoutName !== "fixed" && this.placeSingleNodes(e), this.options.placeOtherGroup && this.options.layoutName !== "fixed" && (await this.placeOtherGroup(t, n), this._dataUpdated());
  }
  placeSingleNodes(n) {
    if (n.length > 0) {
      u("sigle nodes:", n.length);
      const t = new _t({ layoutName: "force" }, this.options);
      t.allNodes = this.graphData.nodes, t.fastStart = !0, t.justLayoutSingleNode = !0, t.maxLayoutTimes = 100, t.byLine = !1, t.autoLayout(!0);
    }
  }
  async placeOtherGroup(n, t) {
    if (n.length > 0) {
      u("[placeOtherGroup]notPlacedNodes nodes:", n.length);
      const e = JSON.parse(JSON.stringify(this.layouter.layoutOptions)), o = Mt(e, this.options);
      o.isMainLayouer = !1;
      const s = n[0], a = this.getStuffSize(t);
      ...
      if (o.layoutOptions.layoutName === "force") {
        const d = o;
        d.force_node_repulsion = 0.2, d.force_line_elastic = 1.5, c = 100;
      }
      s.x = a.maxX + c, s.y = 0, o.layoutOptions.fixedRootNode = !0;
      const l = [];
      this.findGroupNodes(s, l), u("[placeOtherGroup]thisGroupNodes:", n.length), this.layouter.requireLinks && this.layouter.setLinks(this.getLinks()), await o.placeNodes(l, s), t.push(...l);
      const r = [];
      n.forEach((d) => {
        t.includes(d) || r.push(d);
      }), await this.placeOtherGroup(r, t), this._dataUpdated();
    }
  }
  async zoomToFit(n) {
    const t = this.getStuffSize(), e = this.options.viewSize.width / t.width, o = this.options.viewSize.height / t.height, s = Math.min(e, o, 1);
    u("zoomToFit:", { stuffSize: t, zoomPercent: s, zoomPercentX: e, zoomPercentY: o, viewSize: this.options.viewSize }), this.options.useAnimationWhenRefresh ? (await this.animateToZoom(s * 100, 300), this._dataUpdated(), n && n()) : (this.setZoom(s * 100), this._dataUpdated(), n && n());
  }
  async animateGoto(n, t, e) {
    return new Promise((o, s) => {
      u("animateGoto:", n, t);
      const a = n - this.options.canvasOffset.x, c = t - this.options.canvasOffset.y, l = e, r = 5, d = Math.round(a / r), f = Math.round(c / r), h = l / r;
      this.animateStepAction(0, h, r, () => {
  ...
  async animateToZoom(n, t) {
    return new Promise((e, o) => {
      const s = n - this.options.canvasZoom, a = t, c = 5, l = Math.round(s / c), r = a / c;
      u("animateToZoom:", s, l), this.animateStepAction(0, r, c, () => {
        this.zoom(l), this._dataUpdated();
      }, () => {
        this.setZoom(n), this._dataUpdated(), e();
      });
    });
  }
  animateStepAction(n, t, e, o, s) {
    n < e ? (o(n, e), setTimeout(() => {
      this.animateStepAction(n + 1, t, e, o, s);
    }, t)) : s();
  }
  toggleAutoLayout() {
...
const Yt = (i) => {
  ...
  if (ut(i)) {
    const t = i.touches || i.targetTouches;
    if (!t)
      throw new Error("error targetTouches");
    n.clientX = t[0].clientX, n.clientY = t[0].clientY;
  } else
  ...
  startDrag(i, n, t, e) {
    e ? Pt = (o, s, a) => {
      const c = o - gt.x, l = s - gt.y;
      e(c, l, mt, gt, a);
    } : Pt = (o, s) => {
      yt.x = mt.x + (o - gt.x), yt.y = mt.y + (s - gt.y);
    }, Bt = t, yt = n, mt.x = yt.x, mt.y = yt.y, u("[canvas]onDragStart...", ut(i), i);
    try {
      const o = Yt(i);
      gt.x = o.clientX, gt.y = o.clientY, ut(i) ? (document.body.addEventListener("touchmove", q.onNodeMove), document.body.addEventListener("touchend", q.onNodeDragend), i.preventDefault()) : (document.body.addEventListener("mousemove", q.onNodeMove), document.body.addEventListener("mouseup", q.onNodeDragend));
    } catch (o) {
  ...
  onNodeMove(i) {
    const n = Yt(i);
    Pt(n.clientX, n.clientY, i);
  },
  onNodeDragend(i) {
    ut(i) ? (document.body.removeEventListener("touchmove", q.onNodeMove), document.body.removeEventListener("touchend", q.onNodeDragend)) : (document.body.removeEventListener("mousemove", q.onNodeMove), document.body.removeEventListener("mouseup", q.onNodeDragend)), u("[canvas]onDragend...", ut(i), i), Bt && Bt(
      yt.x - mt.x,
      yt.y - mt.y,
      i
    );
...
class je extends Xe {
  ...
  onNodeClick(t, e) {
    ...
    u("[node]node click", t.text, this.options.creatingLinePlot), !e.shiftKey && this.options.disableNodeClickEffect !== !0 && t.disableDefaultClickEffect !== !0 && (this.options.checkedLinkId = "", this.options.checkedLineId = "", this.setCheckedNode(t.id)), this.listeners.onNodeClick && this.listeners.onNodeClick(t, e), this.prevClickTime = Date.now();
  }
  onLineClick(t, e, o) {
    u("onLineClick:", "line:", t, "link:", e), this.options.disableLineClickEffect !== !0 && t.disableDefaultClickEffect !== !0 && (this.setCheckedNode(""), this.setCheckedLinkAndLine(e, t)), this.listeners.onLineClick && this.listeners.onLineClick(t, e, o);
  }
  ...
  async collapseNode(t, e) {
    u("onNodeCollapse:", t), this.options.useAnimationWhenExpanded && (await this.layouter.snapshotBeforeAnimation(), this.setChildsToPosition(t, t), await this.layouter.animationLayout(!1)), t.expanded = !1, u("relayout check:", this.options.reLayoutWhenExpandedOrCollapsed), this.options.reLayoutWhenExpandedOrCollapsed && (u("relayout..."), await this.layouter.snapshotBeforeAnimation(), await this.doLayout()), this.updateElementLines(), this._dataUpdated(), this.listeners.onNodeCollapse && this.listeners.onNodeCollapse(t, e);
  }
  onNodeDragEnd(t, e) {
    this.updateElementLines(), this.listeners.onNodeDragEnd && this.listeners.onNodeDragEnd(t, e);
  }
  onCanvasDragEnd(t) {
  ...
  onCanvasSelectionEnd(t, e) {
    this.listeners.onCanvasSelectionEnd && this.listeners.onCanvasSelectionEnd(t, e);
  }
  startCreatingNodePlot(t, e) {
    this.options.newNodeTemplate = Ct(JSON.parse(JSON.stringify(Wt))), this.options.creatingNodePlot = !0;
    const o = ut(t);
    ...
    e && e.templateText && (this.options.newNodeTemplate.text = e.templateText), e && e.templateStyleClass && (this.options.newNodeTemplate.styleClass = e.templateStyleClass), e && e.templateNode && Object.keys(e.templateNode).forEach((y) => {
      this.options.newNodeTemplate[y] = e.templateNode[y];
    }), e && e.templateMove && (s = e.templateMove), e && e.onCreateNode && (a = e.onCreateNode);
    const c = this.$dom.getBoundingClientRect();
    u("[CreatingNodePlot]startCreatingNodePlot:");
    const l = zt(t), r = l.clientX - c.x + 10, d = l.clientY - c.y + 10;
    o || s(r, d);
    const f = (y) => {
      const v = this.$dom.getBoundingClientRect();
      u("[CreatingNodePlot]objectTemplateMove");
      const g = y.clientX - v.x + 10, b = y.clientY - v.y + 10;
      s(g, b);
    }, h = (y) => {
      u("[CreatingNodePlot]user abort!"), this.$dom.removeEventListener("mousemove", f), this.$dom.removeEventListener("click", m), this.$dom.removeEventListener("contextmenu", h), this.options.creatingNodePlot = !1;
    }, m = (y) => {
      let v = !1;
      if (this.options.creatingNodePlot || (v = !0), this.$dom.removeEventListener("mousemove", f), this.$dom.removeEventListener("click", m), this.$dom.removeEventListener("contextmenu", h), this.options.creatingNodePlot = !1, v) {
        u("[CreatingNodePlot]action be abort!");
        return;
      }
      const g = zt(y), b = g.clientX - c.x + 10, z = g.clientY - c.y + 10;
      if (e && e.disableClickCreate && Math.abs(r - b) < 5 && Math.abs(d - z) < 5) {
    ...
    setTimeout(() => {
      this.$dom.addEventListener("click", m), this.$dom.addEventListener("contextmenu", h);
    }, 300), o || this.$dom.addEventListener("mousemove", f);
  }
  startCreatingLinePlot(t, e) {
    const o = ut(t);
    e && e.onCreateLine && (this.onCreateLineCallback = e.onCreateLine), e && e.template && Object.assign(this.options.newLineTemplate, e.template), this.options.newLinkTemplate.fromNode = null, e && e.fromNode && (this.options.newLinkTemplate.toNode.x = e.fromNode.x + 50, this.options.newLinkTemplate.toNode.y = e.fromNode.y + 50, this.options.newLinkTemplate.fromNode = e.fromNode, this.step1EventTime = Date.now()), this.options.creatingLinePlot = !0, this.options.newLinkTemplate.toNodeObject = null, u("[CreatingLinePlot]startCreatingLinePlot:", o), o || (u("[CreatingLinePlot]Listener move"), this.movingListener = this.onMovingWhenCreatingLinePlot.bind(this), this.$dom.addEventListener("mousemove", this.movingListener));
  }
  ...
  onMovingWhenCreatingLinePlot(t) {
    if (u("[CreatingLinePlot]mousemove"), this.options.newLinkTemplate.fromNode) {
      ...
      this.options.newLinkTemplate.toNode.x = e.x, this.options.newLinkTemplate.toNode.y = e.y, this._dataUpdated();
    }
  }
  onCanvasClickWhenCreatingLinePlot(t) {
    ...
    if (!this.options.newLinkTemplate.toNodeObject) {
      ...
      const e = zt(t), o = this.getCanvasCoordinateByClientCoordinate({ x: e.clientX, y: e.clientY });
  ...
  onCreateLine(t, e) {
    u("[CreatingLinePlot][fire-event]onCreateLine:", t, e), this.onCreateLineCallback && this.onCreateLineCallback(t, e, this.options.newLineTemplate);
  }
  isNode(t) {
    const e = Dt(t, "rel-node-peel", "rel-map");
    return e ? this.getNodeById(e.dataset.id) : void 0;
  }
  isLink(t) {
    const e = Dt(t, "rel-link-peel", "rel-map");
    return e ? this.getLinkById(e.dataset.id) : void 0;
  }
  onContextmenu(t) {
    let e = "canvas", o = this.isNode(t.target);
    o ? e = "node" : (o = this.isLink(t.target), o && (e = "link")), u("contextmenu:objectType", e, o), this.listeners.onContextmenu && this.listeners.onContextmenu(t, e, o);
  }
  fullscreen(t) {
    t === void 0 ? (this.options.fullscreen = !this.options.fullscreen, dt.toggle(this.$dom).then(() => {
      setTimeout(() => {
  ...
  async handleSelect(t) {
    ...
    const e = t.width || 50, o = t.height || 50, s = t.x * -1 + this.options.viewSize.width / 2 - e / 2, a = t.y * -1 + this.options.viewSize.height / 2 - o / 2;
    await this.animateGoto(s, a, 500), this.options.checkedNodeId = t.id, this.refreshNVAnalysisInfo();
  }
  onMouseWheel(t) {
    ...
    const s = -1;
    o > 0 ? this.zoom(5 * s, e) : this.zoom(-5 * s, e);
  }
  onLineDragStart(t, e) {
    u("onLineDragStart...");
    const o = { x: t.fromNode.x, y: t.fromNode.y }, s = { x: t.toNode.x, y: t.toNode.y }, a = (c, l, r, d, f) => {
      t.fromNode.x = o.x + c / (this.options.canvasZoom / 100), t.fromNode.y = o.y + l / (this.options.canvasZoom / 100), t.toNode.x = s.x + c / (this.options.canvasZoom / 100), t.toNode.y = s.y + l / (this.options.canvasZoom / 100), this._dataUpdated();
    };
    q.startDrag(e, { x: 0, y: 0 }, (...c) => {
  ...
  onCanvasDragStart(t) {
    if (u("[canvas]onCanvasDragStart..."), this.options.disableDragCanvas || t.shiftKey) {
    ...
    if (ut(t)) {
      let o, s = 1;
      e = (a, c, l, r, d) => {
        const f = d.touches || d.targetTouches, h = f[0];
        if (f && f.length > 1) {
          d.preventDefault();
          const m = f[1];
          o || (o = { x: m.clientX, y: m.clientY }, s = this.options.canvasZoom);
          const y = { x: h.clientX, y: h.clientY }, v = { x: m.clientX, y: m.clientY }, g = Math.hypot(o.x - r.x, o.y - r.y), z = Math.hypot(v.x - y.x, v.y - y.y) / g, S = s * z;
          this.setZoom(S), this._dataUpdated();
        } else {
          const m = h.clientX, y = h.clientY;
      ...
      e = (o, s, a, c, l) => {
        const r = a.x + o, d = a.y + s;
        this.setCanvasOffset(r, d), this._dataUpdated();
      };
    q.startDrag(t, this.options.canvasOffset, (...o) => {
  ...
  startCreateSelection(t) {
    let e = !1;
    const o = (s, a, c, l, r) => {
      if (!e && Math.abs(s) + Math.abs(a) > 6 && (e = !0, this.options.creatingSelection = !0, this.options.selectionView.x = l.x, this.options.selectionView.y = l.y), e) {
        const d = this.getBoundingClientRect();
        s < 0 ? (this.options.selectionView.x = l.x + s - d.x, this.options.selectionView.width = Math.abs(s)) : (this.options.selectionView.x = l.x - d.x, this.options.selectionView.width = s), a < 0 ? (this.options.selectionView.y = l.y + a - d.y, this.options.selectionView.height = Math.abs(a)) : (this.options.selectionView.y = l.y - d.y, this.options.selectionView.height = a);
      }
      this._dataUpdated();
    };
    q.startDrag(t, { x: 0, y: 0 }, (...s) => {
  ...
  onNodeDragStart(t, e) {
    if (this.options.disableDragNode || t.disableDrag)
      return;
    isNaN(t.x) && (t.x = 0), isNaN(t.y) && (t.y = 0), t.dragging = !0, this.listeners.onNodeDragStart && this.listeners.onNodeDragStart(t, e);
    const o = (s, a, c) => {
      t.dragging = !1, this.onNodeDraged(t, s, a, c), this._dataUpdated();
    };
    q.startDrag(e, t, o, (s, a, c) => {
      let l = s / (this.options.canvasZoom / 100) + c.x, r = a / (this.options.canvasZoom / 100) + c.y;
      if (this.listeners.onNodeDragging) {
        const d = this.listeners.onNodeDragging(t, l, r, e);
        d && (typeof d.x == "number" && (l = d.x), typeof d.y == "number" && (r = d.y));
      }
      this.setNodePosition(t, l, r), this.options.useHorizontalView ? (l = a / (this.options.canvasZoom / 100) + c.x, r = -s / (this.options.canvasZoom / 100) + c.y, this.setNodePosition(t, l, r)) : this.setNodePosition(t, l, r), this.updateElementLines(), this._dataUpdated();
    });
  }
  onNodeDraged(t, e, o, s) {
    if (e === 0 && o === 0) {
...
class Ze extends je {
  ...
  async setOptions(n, t = !1) {
    if (this.disableNextLayoutAnimation = !0, this._setOptions(n), t === !0) {
  ...
  async switchLayout(n, t = !0, e = !1) {
    this.listeners.beforeChangeLayout && this.listeners.beforeChangeLayout(n) === !1 && (t = !1);
    const o = this.layouter ? this.layouter.allNodes : [], s = this.layouter && this.layouter.rootNode;
    u("[change layout]switchLayout"), this.stopAutoLayout(), Ot(n, this.options), this._initLayoutByLayoutOptions(n), this.layouter.allNodes = o, this.layouter.rootNode = s, t ? await this.refresh() : (e || (this.disableNextLayoutAnimation = !0), await this.doLayout());
  }
  async setJsonData(n, t = !1) {
    await this._setJsonData(n);
    const e = n.rootId;
    if (e && (this.graphData.rootNode = this.graphData.nodes.find((o) => o.id === e)), !this.graphData.rootNode && this.graphData.nodes.length > 0 && (this.graphData.rootNode = this.graphData.nodes[0]), this.graphData.rootNode)
    ...
    t && (u("resetViewSize:", t), this.resetViewSize()), this.disableNextLayoutAnimation = !0, await this.doLayout();
  }
  async appendJsonData(n, t = !0) {
    u("appendData:", n), this.loadGraphJsonData(n), t && (this.disableNextLayoutAnimation = !0, await this.doLayout());
  }
}
class ee extends Ze {
  constructor(n, t) {
...
const Je = /* @__PURE__ */ J({
  ...
  setup(i) {
    return (n, t) => (L(), k("div", {
      class: j([["c-expand-positon-" + i.expandHolderPosition], "c-btn-open-close"])
    }, [
      w("span", {
        class: j(i.expandButtonClass),
        style: U({ "background-color": i.color }),
        onClick: t[0] || (t[0] = rt(
          (...e) => i.expandOrCollapseNode && i.expandOrCollapseNode(...e),
          ["stop"]
        )),
        onTouchend: t[1] || (t[1] = rt(
          (...e) => i.expandOrCollapseNode && i.expandOrCollapseNode(...e),
          ["stop"]
        ))
      }, null, 38)
...
}), qe = ["data-id"], Ke = ["innerHTML"], Qe = ["innerHTML"], to = ["innerHTML"], oe = /* @__PURE__ */ J({
  __name: "RGNode",
  props: {
    nodeProps: null
  },
  setup(i) {
    const n = i, t = pt(), e = H(st), o = H(Q), s = P(() => o.options), a = P(() => {
      ...
      if (!!g)
        return g + "px";
    }), r = P(() => n.nodeProps.expandHolderPosition && n.nodeProps.expandHolderPosition !== "hide" || s.value.defaultExpandHolderPosition && s.value.defaultExpandHolderPosition !== "hide" && n.nodeProps.lot.childs && n.nodeProps.lot.childs.length > 0), d = P(() => n.nodeProps.expanded === !1 ? "c-expanded" : "c-collapsed"), f = (g) => {
      e == null || e.value.expandOrCollapseNode(n.nodeProps, g);
    }, h = () => {
      t.value.offsetWidth === 0 && t.value.offsetHeight === 0 || (n.nodeProps.el.offsetWidth !== t.value.offsetWidth || n.nodeProps.el.offsetHeight !== t.value.offsetHeight) && (e == null || e.value.updateNodeOffsetSize(
        n.nodeProps,
        t.value.offsetWidth,
        t.value.offsetHeight
      ));
    }, m = (g) => {
      e == null || e.value.onNodeDragStart(n.nodeProps, g);
    }, y = (g) => {
      e == null || e.value.onNodeClick(n.nodeProps, g);
    }, v = (g) => it.isAllowShowNode(g);
    return wt(() => {
      h();
    }), he(() => {
      h();
      ...
      class: j(["rel-node-peel", [i.nodeProps.selected && "rel-node-selected", i.nodeProps.dragging && "rel-node-dragging", i.nodeProps.id === p(s).checkedNodeId && "rel-node-peel-checked", i.nodeProps.className]]),
      "data-id": i.nodeProps.id
    }, [
      p(r) ? G(g.$slots, "node-expand-holder", {
        key: 0,
        nodeProps: i.nodeProps,
        expandButtonClass: p(d),
      ...
      i.nodeProps.html ? (L(), k("div", {
        ...
        onClick: b[0] || (b[0] = (z) => y(z)),
        onMousedown: b[1] || (b[1] = rt((z) => m(z), ["left", "stop"])),
        onTouchstart: b[2] || (b[2] = rt((z) => m(z), ["stop"]))
      }, null, 40, Ke)) : (L(), k("div", {
        key: 2,
        class: j([["rel-node-shape-" + (i.nodeProps.nodeShape === void 0 ? p(s).defaultNodeShape : i.nodeProps.nodeShape), "rel-node-type-" + i.nodeProps.type, i.nodeProps.id === p(s).checkedNodeId ? "rel-node-checked" : "", i.nodeProps.flashing ? "rel-node-flashing" : "", i.nodeProps.styleClass, i.nodeProps.innerHTML ? "rel-diy-node" : ""], "rel-node"]),
        style: U({ "background-color": i.nodeProps.color === void 0 ? p(s).defaultNodeColor : i.nodeProps.color, color: i.nodeProps.fontColor === void 0 ? p(s).defaultNodeFontColor : i.nodeProps.fontColor, border: p(a), width: p(c), height: p(l) }),
        onClick: b[3] || (b[3] = (z) => y(z)),
        onMousedown: b[4] || (b[4] = rt((z) => m(z), ["left", "stop"])),
        onTouchstart: b[5] || (b[5] = rt((z) => m(z), ["stop"]))
      }, [
        p(s).hideNodeContentByZoom === !0 && p(s).canvasZoom < 40 ? $("", !0) : G(g.$slots, "node", {
          key: 0,
          node: i.nodeProps
        }, () => [
          i.nodeProps.innerHTML ? (L(), k("div", {
            ...
            key: 0,
            style: U({ color: i.nodeProps.fontColor || p(s).defaultNodeFontColor }),
            class: "c-node-text"
          }, [
            w("span", {
...
}), eo = ["xlink:href"], oo = ["transform"], no = ["xlink:href", "startOffset", "text-anchor"], io = /* @__PURE__ */ J({
  ...
  setup(i) {
    const n = i, t = H(st), e = H(Q), o = P(() => e.options), s = P(() => n.relation.id === (t == null ? void 0 : t.value.options.checkedLineId)), a = P(() => {
      const f = n.relation.textOffset_x || o.value.defaultLineTextOffset_x || 0, h = n.relation.textOffset_y || o.value.defaultLineTextOffset_y || -8;
      return `translate(${f},${h})`;
    }), c = P(() => "#" + o.value.instanceId + "-" + n.link.seeks_id + "-" + n.relationIndex), l = P(() => n.relation.lineShape === 4 || o.value.defaultLineShape === 4 ? "start" : "middle"), r = P(() => {
      if (n.relation.lineShape === 4 || o.value.defaultLineShape === 4)
        if (o.value.layoutDirection === "v") {
          const f = n.link.fromNode.x, h = n.link.toNode.x;
          return Math.abs(h - f) + 43;
        } else {
          const f = n.link.fromNode.y, h = n.link.toNode.y;
          return Math.abs(h - f) + 43;
        }
      return "50%";
    }), d = (f, h) => {
      t == null || t.value.onLineClick(f, n.link, h);
    };
    return (f, h) => (L(), k("g", null, [
      w("use", {
        "xlink:href": p(c),
        class: j(["c-rg-line", [
        ...
        onTouchstart: h[0] || (h[0] = (m) => d(i.relation, m)),
        onClick: h[1] || (h[1] = (m) => d(i.relation, m))
      }, null, 42, eo),
      w("g", { transform: p(a) }, [
        w("text", {
          class: j(["c-rg-line-text", { "c-rg-line-text-checked": p(s) }]),
          style: U({
          ...
          onTouchstart: h[2] || (h[2] = (m) => d(i.relation, m)),
          onClick: h[3] || (h[3] = (m) => d(i.relation, m))
        }, [
          w("textPath", {
            "xlink:href": p(c),
            startOffset: p(r),
            ...
            method: "align",
            spacing: "auto"
          }, xt(i.relation.text), 9, no)
        ], 38)
      ], 8, oo)
    ]));
  }
}), so = ["d", "stroke", "marker-start", "marker-end"], ao = ["transform"], lo = ["x", "y"], At = /* @__PURE__ */ J({
  __name: "RGLineSmart",
  props: {
    link: null,
    relation: null,
  ...
  setup(i) {
    const n = i, t = H(st), e = H(Q), o = P(() => e.options), s = P(() => n.relation.id === o.value.checkedLineId), a = P(() => n.relation.showStartArrow && (t == null ? void 0 : t.value.getArrow(n.relation, n.link, !0))), c = P(() => n.relation.showEndArrow && (t == null ? void 0 : t.value.getArrow(n.relation, n.link, !1))), l = P(() => {
      try {
        const { path: d, textPosition: f } = t == null ? void 0 : t.value.createLinePath(
          n.link,
          n.relation,
          n.relationIndex
        );
        let h = {};
        try {
          h = t == null ? void 0 : t.value.getTextTransform(
            n.relation,
            f.x,
            f.y,
            f.rotate
      ...
      t == null || t.value.onLineClick(d, n.link, f);
    };
    return (d, f) => (L(), k("g", null, [
      w("path", {
        d: p(l).path,
        class: j(["c-rg-line", [
          i.relation.styleClass,
        ...
        "marker-end": p(c),
        fill: "none",
        onTouchstart: f[0] || (f[0] = (h) => r(i.relation, h)),
        onClick: f[1] || (f[1] = (h) => r(i.relation, h))
      }, null, 46, so),
      p(o).defaultShowLineLabel && p(o).canvasZoom > 40 ? (L(), k("g", {
        ...
        (L(), k("text", {
          ...
          "text-anchor": "middle",
          class: j(["c-rg-line-text", { "c-rg-line-text-checked": p(s) }]),
          onTouchstart: f[2] || (f[2] = (h) => r(i.relation, h)),
          onClick: f[3] || (f[3] = (h) => r(i.relation, h))
        }, xt(i.relation.text), 47, lo))
      ], 8, ao)) : $("", !0)
    ]));
  }
  ...
  setup(i) {
    H(st);
    const n = H(Q), t = P(() => n.options), e = (o) => it.isAllowShowNode(o);
    return (o, s) => i.linkProps.isHide !== !0 && e(i.linkProps.fromNode) && e(i.linkProps.toNode) ? (L(), k("g", {
      key: 0,
      class: j([[p(t).checkedLinkId == i.linkProps.seeks_id ? "c-rg-link-checked" : ""], "rel-link-peel"]),
      ref: "seeksRGLink",
      transform: "translate(0,0)",
      "data-id": i.linkProps.seeks_id
    }, [
      (L(!0), k(ot, null, ht(i.linkProps.relations, (a, c) => G(o.$slots, "line", {
        line: a,
        relationIndex: c
      }, () => [
        (p(t).lineUseTextPath || a.useTextPath) && a.isHide === !1 ? (L(), lt(io, {
          key: "l-" + a.id,
          link: i.linkProps,
          relation: a,
          "relation-index": c
        }, null, 8, ["link", "relation", "relation-index"])) : a.isHide === !1 ? (L(), lt(At, {
          key: "l-" + a.id,
          link: i.linkProps,
          relation: a,
          "relation-index": c
        }, null, 8, ["link", "relation", "relation-index"])) : $("", !0)
      ])), 256))
    ], 10, ro)) : $("", !0);
  }
  ...
  setup(i) {
    const n = i, t = H(st), e = H(Q), o = P(() => e.options), s = P(() => n.relation.id === o.value.checkedLineId), a = P(() => {
      const { path: l, textPosition: r } = t == null ? void 0 : t.value.createLinePath(
        n.link,
        n.relation,
        n.relationIndex
      );
      return l;
    }), c = P(() => t == null ? void 0 : t.value);
    return (l, r) => (L(), k("path", {
      id: p(o).instanceId + "-" + i.link.seeks_id + "-" + i.relationIndex,
      d: p(a),
      stroke: i.relation.color ? i.relation.color : p(o).defaultLineColor,
      style: U({ opacity: i.relation.opacity, "stroke-width": (i.relation.lineWidth ? i.relation.lineWidth : p(o).defaultLineWidth) + "px" }),
      "marker-start": i.relation.showStartArrow && p(c).getArrow(i.relation, i.link, !0),
      "marker-end": i.relation.showEndArrow && p(c).getArrow(i.relation, i.link, !1),
      class: j(["c-rg-line-path", i.relation.styleClass, p(s) ? "c-rg-line-checked" : ""]),
      fill: "none"
    }, null, 14, ho));
  }
  ...
  setup(i) {
    const n = H(st), t = H(Q);
    P(() => t.options);
    const e = P(() => n == null ? void 0 : n.value.createCheckedLinePath()), o = P(() => n == null ? void 0 : n.value.createCheckedLineStrokeWidth());
...
], -1), go = ["id", "markerWidth", "markerHeight", "refX", "refY"], vo = ["d"], _o = ["id", "markerWidth", "markerHeight", "refX", "refY"], xo = ["d"], Lo = ["id", "markerWidth", "markerHeight", "refX", "refY"], wo = ["d"], Co = ["id", "markerWidth", "markerHeight", "refX", "refY"], ko = ["d"], bo = ["id", "markerWidth", "markerHeight", "refX", "refY"], Mo = ["fill", "d"], So = ["id", "markerWidth", "markerHeight", "refX", "refY"], Oo = ["fill", "d"], Eo = { class: "rel-nodediv rel-nodediv-for-webkit" }, No = { class: "rel-linediv rel-linediv-el-lines" }, zo = {
  class: "rel-lines-svg rel-lines-svg-el-lines",
  xmlns: "http://www.w3.org/2000/svg"
}, Po = /* @__PURE__ */ J({
  __name: "RGGraph",
  setup(i) {
    const n = pt(), t = H(Zt), e = H(Q), o = P(() => e.options), s = P(() => e.allLineColors), a = () => {
    ...
    return wt(() => {
      ...
      w("div", {
        ...
        (L(), k("svg", {
          class: "rel-lines-svg",
          style: U({ width: p(o).canvasSize.width + "px", height: p(o).canvasSize.height + "px" }),
          xmlns: "http://www.w3.org/2000/svg"
        }, [
          w("defs", null, [
            mo,
            w("marker", {
              ...
              w("path", {
                style: U({ fill: p(o).defaultLineColor }),
            ...
            w("marker", {
              ...
              w("path", {
                style: U({ fill: p(o).checkedLineColor }),
                d: p(o).defaultLineMarker.data
              }, null, 12, wo)
            ], 8, Lo),
            w("marker", {
            ...
            (L(!0), k(ot, null, ht(p(s), (r) => (L(), k("marker", {
            ...
            (L(!0), k(ot, null, ht(p(t).links, (r) => (L(), k(ot, null, [
              (L(!0), k(ot, null, ht(r.relations, (d, f) => (L(), k(ot, null, [
                p(o).lineUseTextPath || d.useTextPath ? (L(), lt(fo, {
                  key: d.id,
                  link: r,
                  relation: d,
                  "relation-index": f
          ...
          ft(po),
          (L(!0), k(ot, null, ht(p(t).links, (r) => (L(), lt(co, {
            key: r.seeks_id,
            "link-props": r
          }, {
            line: K(({ line: d }) => [
          ...
          p(o).creatingLinePlot && p(o).newLinkTemplate.fromNode ? (L(), lt(At, {
            key: "s-line-template",
            link: p(o).newLinkTemplate,
            relation: p(o).newLineTemplate,
            "relation-index": 0
          }, null, 8, ["link", "relation"])) : $("", !0)
        ], 4))
      ], 512),
      w("div", Eo, [
        (L(!0), k(ot, null, ht(p(t).nodes, (r) => (L(), lt(oe, {
          key: r.seeks_id,
          "node-props": r
        }, {
          node: K(({ node: d }) => [
            G(c.$slots, "node", { node: d })
          ]),
          "node-expand-holder": K(({ nodeProps: d, expandHolderPosition: f, expandButtonClass: h, color: m, expandOrCollapseNode: y }) => [
      ...
      w("div", No, [
        (L(), k("svg", zo, [
          (L(!0), k(ot, null, ht(p(t).elementLines, (r) => (L(), k(ot, null, [
            r.relations[0].isHide === !1 ? (L(), lt(At, {
...
}), Bo = { class: "rel-canvas-slot rel-canvas-slot-behind" }, Do = { class: "rel-canvas-slot rel-canvas-slot-above" }, Ao = /* @__PURE__ */ J({
  __name: "RGCanvas",
  setup(i) {
    const n = pt(), t = H(st), e = H(Q), o = P(() => e.options), s = (r) => {
      t == null || t.value.onMouseWheel(r);
    }, a = (r) => {
      t == null || t.value.onCanvasDragStart(r);
    }, c = (r) => {
      t == null || t.value.onContextmenu(r);
    }, l = P(() => ({
    ...
    return wt(() => {
      u("[RGCanvas mounted]"), t == null || t.value.setCanvasDom(n.value);
    }), (r, d) => (L(), k("div", {
      style: U({ width: "100%", height: "100%", "background-color": p(o).backgroundColor || void 0, "background-image": p(o).backgroundImage ? "url(" + p(o).backgroundImage + ")" : void 0 }),
      class: j([[p(o).layoutClassName, p(o).backgroundImageNoRepeat ? "rel-map-background-norepeat" : ""], "rel-map"]),
      onContextmenu: d[0] || (d[0] = rt((f) => c(f), ["prevent"])),
      onMousedown: d[1] || (d[1] = rt((f) => a(f), ["left", "stop"])),
      onTouchstart: d[2] || (d[2] = rt((f) => a(f), ["stop"])),
      onWheel: s
    }, [
      w("div", {
        ...
        ft(Po, null, {
          ...
          line: K(({ line: f, link: h }) => [
            G(r.$slots, "line", {
              line: f,
              link: h
            })
          ]),
          "node-expand-holder": K(({ nodeProps: f, expandHolderPosition: h, expandButtonClass: m, color: y, expandOrCollapseNode: v }) => [
...
}), To = { class: "c-debug-tools-row" }, $o = /* @__PURE__ */ J({
  __name: "GraphDebugPanel",
  setup(i) {
    const n = H(st), t = H(Q), e = P(() => t.options), o = pt(!1), s = () => {
      o.value = !o.value;
    }, a = () => {
      ...
      n == null || n.value.enableDebugLog(!e.value.debug), u("debugLog:", n == null ? void 0 : n.value.options.debug);
    };
    return (r, d) => (L(), k("div", null, [
      w("div", {
        class: j([[], "c-setting-panel-button"]),
        onClick: s
      }, " Debug "),
      o.value ? (L(), k("div", {
        key: 0,
        class: j([[], "c-setting-panel"])
      }, [
        w("div", { class: "c-debug-tools-row" }, [
          w("button", { onClick: a }, "print options in console")
        ]),
        w("div", { class: "c-debug-tools-row" }, [
          w("button", { onClick: c }, "print json data in console")
        ]),
        w("div", To, [
          Ut("debug log status: " + xt(p(e).debug), 1),
          w("button", { onClick: l }, xt(p(e).debug ? "disable" : "enable") + " debug log", 1)
        ])
      ])) : $("", !0)
    ]));
  }
  ...
  setup(i) {
    return pt(100), pt(0), (n, t) => (L(), k("div", Wo, null, 512));
  }
}), Io = /* @__PURE__ */ w("svg", {
  class: "rg-icon",
  "aria-hidden": "true"
}, [
  /* @__PURE__ */ w("use", { "xlink:href": "#icon-resize-" })
], -1), Ro = [
  Io
], Fo = /* @__PURE__ */ w("svg", {
  class: "rg-icon",
  ...
  /* @__PURE__ */ w("use", { "xlink:href": "#icon-fangda" })
], -1), Go = [
  Fo
], Vo = /* @__PURE__ */ w("svg", {
  class: "rg-icon",
  ...
  /* @__PURE__ */ w("use", { "xlink:href": "#icon-suoxiao" })
], -1), Yo = [
  Vo
], Xo = ["title"], Uo = {
  key: 0,
  class: "rg-icon",
  "aria-hidden": "true"
}, jo = /* @__PURE__ */ w("use", { "xlink:href": "#icon-zidong" }, null, -1), Zo = [
  jo
], Jo = {
  key: 1,
  class: "c-loading-icon rg-icon",
  "aria-hidden": "true"
}, qo = /* @__PURE__ */ w("use", { "xlink:href": "#icon-lianjiezhong" }, null, -1), Ko = [
  qo
], Qo = /* @__PURE__ */ w("svg", {
  class: "rg-icon",
  "aria-hidden": "true"
}, [
  /* @__PURE__ */ w("use", { "xlink:href": "#icon-ico_reset" })
], -1), tn = [
  Qo
], en = /* @__PURE__ */ w("svg", {
  class: "rg-icon",
  ...
  /* @__PURE__ */ w("use", { "xlink:href": "#icon-tupian" })
], -1), on = [
  en
], nn = /* @__PURE__ */ w("div", { style: { clear: "both" } }, null, -1), sn = /* @__PURE__ */ J({
  __name: "GraphMiniToolBar",
  setup(i) {
    const n = H(st), t = H(Q), e = P(() => t.options);
    wt(() => {
    });
    const o = () => {
      ...
      const d = n == null ? void 0 : n.value;
      await d.setZoom(100), await d.moveToCenter(), await d.zoomToFit();
    }, l = (d) => {
      n == null || n.value.zoom(d);
    }, r = () => {
      n == null || n.value.fullscreen();
    };
    return (d, f) => (L(), k("div", {
      class: j(["rel-toolbar", ["rel-toolbar-h-" + p(e).toolBarPositionH, "rel-toolbar-v-" + p(e).toolBarPositionV, "rel-toolbar-" + p(e).toolBarDirection]])
    }, [
      p(e).allowShowFullscreenMenu ? (L(), k("div", {
        key: 0,
        title: "\u5168\u5C4F/\u9000\u51FA\u5168\u5C4F",
        class: "c-mb-button",
      ...
      p(e).allowShowZoomMenu ? (L(), k("div", {
        key: 1,
        title: "\u653E\u5927",
        class: "c-mb-button",
        onClick: f[1] || (f[1] = (h) => l(20))
      }, Go)) : $("", !0),
      p(e).allowShowZoomMenu ? (L(), k("div", {
        key: 2,
        class: "c-current-zoom",
        onDblclick: c
      }, xt(p(e).canvasZoom) + "%", 33)) : $("", !0),
      p(e).allowShowZoomMenu ? (L(), k("div", {
        key: 3,
        title: "\u7F29\u5C0F",
        class: "c-mb-button",
        style: { "margin-top": "0px" },
        onClick: f[2] || (f[2] = (h) => l(-20))
      }, Yo)) : $("", !0),
      p(e).allowAutoLayoutIfSupport && p(e).isNeedShowAutoLayoutButton ? (L(), k("div", {
        key: 4,
        title: p(e).autoLayouting ? "\u70B9\u51FB\u505C\u6B62\u81EA\u52A8\u5E03\u5C40" : "\u70B9\u51FB\u5F00\u59CB\u81EA\u52A8\u8C03\u6574\u5E03\u5C40",
        class: j([{ "c-mb-button-on": p(e).autoLayouting }, "c-mb-button"]),
        onClick: s
      }, [
        p(e).autoLayouting ? (L(), k("svg", Jo, Ko)) : (L(), k("svg", Uo, Zo))
      ], 10, Xo)) : $("", !0),
      p(e).allowShowRefreshButton ? (L(), k("div", {
        key: 5,
        title: "\u5237\u65B0",
        class: "c-mb-button",
        onClick: o
      }, tn)) : $("", !0),
      p(e).allowShowDownloadButton ? (L(), k("div", {
        key: 6,
        title: "\u4E0B\u8F7D\u56FE\u7247",
        class: "c-mb-button",
        onClick: a
  ...
  key: 0,
  class: "rel-operate"
}, ln = { style: { position: "relative" } }, rn = /* @__PURE__ */ J({
  __name: "GraphOperateStuff",
  setup(i) {
    const n = H(Q), t = P(() => n.options);
    return (e, o) => p(t) && (p(t).creatingNodePlot || p(t).creatingSelection) ? (L(), k("div", an, [
      w("div", ln, [
        p(t).creatingNodePlot && p(t).showTemplateNode ? (L(), lt(oe, {
          key: 0,
          "node-props": p(t).newNodeTemplate
        }, {
          node: K(() => [
            G(e.$slots, "node-template", {
              node: p(t).newNodeTemplate
            })
          ]),
          _: 3
        }, 8, ["node-props"])) : $("", !0),
        p(t).creatingSelection ? (L(), k("div", {
          key: 1,
          class: "rel-selection",
          style: U({
            left: p(t).selectionView.x + "px",
            top: p(t).selectionView.y + "px",
            width: p(t).selectionView.width + "px",
            height: p(t).selectionView.height + "px"
          })
        }, null, 4)) : $("", !0)
      ])
    ])) : $("", !0);
  }
}), cn = /* @__PURE__ */ w("div", { class: "rel-graph-loading-message" }, [
  /* @__PURE__ */ w("svg", {
    class: "c-graph-loading-icon",
    "aria-hidden": "true"
  }, [
    /* @__PURE__ */ w("use", { "xlink:href": "#icon-lianjiezhong" })
  ]),
  /* @__PURE__ */ Ut(" Loading... ")
], -1), hn = [
  cn
  ...
  __name: "GraphLoading",
  setup(i) {
    const n = H(st), t = H(Q), e = P(() => t.options), o = (s) => {
      n == null || n.value.clickGraphMask(s);
    };
    return (s, a) => (L(), k("div", {
      class: j(["rel-graph-loading", { "rel-graph-loading-hide": !p(e).graphLoading }]),
      onClick: o
    }, hn, 2));
  }
}), bt = /* @__PURE__ */ J({
  ...
  setup(i, { expose: n }) {
    ...
    Nt(st, o), Nt(Zt, s), Nt(Q, a), u("---------------------------graph mounted---------------------------"), wt(() => {
      _e("vue3"), u("---------------------------graph mounted---------------------------");
      const l = t.relationGraphCore ? new t.relationGraphCore(t.options, Gt(t)) : new ee(t.options, Gt(t));
      l.setReactiveDataVue3(s, a), l.setDom(e.value), l.ready(), o.value = l, dt && dt.on && dt.on("change", c);
    }), Xt(() => {
      dt && dt.off && dt.off("change", c);
    });
    const c = () => {
      o.value.fullscreen(dt.isFullscreen);
    };
    return n({
      onFullscreen() {
        c();
      ...
      async setJsonData(l, r, d) {
        arguments.length === 2 && typeof r == "function" && (d = r, r = !0), await o.value.setJsonData(l, !0), await o.value.refresh(!1), d && d(o.value);
      },
      async appendJsonData(l, r, d) {
        arguments.length === 2 && typeof r == "function" && (d = r, r = !0), await o.value.appendJsonData(l, !0), d && d(o.value);
      },
      setLayouter(l) {
      ...
      o.value && a.options ? (L(), k(ot, { key: 0 }, [
        a.options.showDebugPanel ? (L(), lt($o, { key: 0 })) : $("", !0),
        ...
        ft(Ao, null, {
          node: K(({ node: d }) => [
            G(l.$slots, "node", { node: d })
          ]),
          line: K(({ line: d, link: f }) => [
            G(l.$slots, "line", {
              line: d,
              link: f
            })
        ...
        ft(rn, null, {
          "node-template": K(({ node: d }) => [
            G(l.$slots, "node-template", { node: d })
          ]),
          _: 3
        }),
        ft(dn)
...
const gn = ee, vn = {
  BaseLayouter: kt,
  BidirectionalTreeLayouter: Jt,
  CenterLayouter: Kt,
  CircleLayouter: Qt,
  FixedLayouter: te,
  ForceLayouter: _t
}, _n = Te, xn = He, Ln = be, wn = we, Cn = qt, kn = Me, bn = Ue;
bt.install = (i) => {
  i.component("RelationGraph", bt), i.component("SeeksRelationGraph", bt);
};
const Mn = bt, Sn = jt;
export {
  mn as INSTALLED_KEY,
  ...
  bn as RGEffectUtils,
  Cn as RGGraphMath,
  _n as RGLayouterUtils,
  Ln as RGLinkUtils,
  wn as RGNodeUtils,
  kn as RGNodesAnalyticUtils,
  xn as RGOptionsUtils,
  Mn as RelationGraph,
  gn as RelationGraphCore,
  bt as default,
  Zt as graphDataKey,
  st as graphInstanceKey,
  Q as graphKey,
  Sn as version
};
